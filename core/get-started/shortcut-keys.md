...
In Microsoft Dynamics 365 for Finance and Operations stehen die folgenden Tastenkombinationen zur Verfügung. 
...
| Zum Standardaktionsbereich wechseln                  | STRG+F6                          |
| Öffnen einer Registerkarte im Aktionsbereich oder einem Menü           | Eingabe oder Leertaste oder ALT+NACH-UNTEN-TASTE |
...
| Öffnen des Bereichs "Filter" (oder Wechseln des Fokus zwischen dem Bereich "Filter" und dem Hauptformular, wenn der Bereich "Filter" bereits offen ist) | STRG+F3       |
...
| Öffnen der Navigationsliste auf Formularen "Details" (oder wechseln Sie den Fokus zwischen der Navigationsliste und dem Hauptformular, wenn es bereits offen ist) | STRG+F8           |
...
| Zur Positionsansicht wechseln                                | STRG+UMSCHALT+L                                 |
...
| Zur nächsten/vorherigen Zeile ohne Auswahl wechseln (Hinweis: Diese Verknüpfung gilt nur für Szenarien mit Mehrfachauswahl.) | STRG+NACH-OBEN-TASTE / STRG+NACH-UNTEN-TASTE |
| Auswählen/Auswahl aufheben von aktueller Zeile (Hinweis: Diese Verknüpfung gilt nur für Szenarien mit Mehrfachauswahl.)                    | STRG+LEERTASTE / STRG+KLICK         |
| Die nächste/vorherige Zeile zum ausgewählten Satz hinzufügen (Hinweis: Diese Verknüpfung gilt nur für Szenarien mit Mehrfachauswahl.)   | UMSCHALT+LEERTASTE                     |
| Einen Bereich von Zeilen zum ausgewählten Satz hinzufügen (Hinweis: Diese Verknüpfung gilt nur für Szenarien mit Mehrfachauswahl.)         | UMSCHALT+KLICK                     |
| Zur nächsten/vorherigen Seite mit Daten wechseln                                                                          | BILD-AUF / BILD-AB             |
| Eine neue Zeile unten im Raster erstellen                                                                    | NACH-UNTEN-TASTE (von der letzten Zeile)  |
| Alle Zeilen aktivieren bzw. deaktivieren                                                                                      | STRG+UMSCHALT+M                    |
...
| Zwischen den Modi "Gültige anzeigen" und "Alle anzeigen" umschalten.                                                                        | Alt+W                            |
