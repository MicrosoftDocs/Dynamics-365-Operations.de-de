...
![konfigurierte-und-FilterArbeitsbereiche( [] . /media/configure-and-filter-workspaces.png)]". /media/configure-and-filter-workspaces.png)   
...
![konfigurierte-meinArbeitsbereich( [] . /media/configure-my-workspace.png)]". /media/configure-my-workspace.png)
...
![ArbeitsbereichFilter( [] . /media/workspace-filter.png)]". /media/workspace-filter.png) 

Wenn Sie den Filter mit einem Klick öffnen, werden mehrere Optionen dargestellt. 

![Arbeitsbereich-Filter-erweitert ([]. /media/workspace-filter-expanded.png)]". /media/workspace-filter-expanded.png) 
...
![Arbeitsbereich-AbschnittFilter( [] . /media/workspace-section-filters.png)]". /media/workspace-section-filters.png) 
