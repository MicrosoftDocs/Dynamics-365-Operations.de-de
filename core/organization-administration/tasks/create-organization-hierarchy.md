...
5. Suchen Sie in der Liste den gewünschten Datensatz, und wählen Sie ihn aus.
    * Wählen Sie einen Zweck aus, der Ihrer Organisationshierarchie zugewiesen werden soll.  
6. Klicken Sie auf Hinzufügen.
7. Markieren Sie in der Liste die ausgewählte Zeile.
    * Suchen Sie die Hierarchie, die Sie soeben erstellt haben.  
...
1. Suchen Sie in der Liste den gewünschten Datensatz, und wählen Sie ihn aus.
    * Wählen Sie Ihre Hierarchie aus.  
