...
description: In diesem Artikel wird erläutert, wie Sie Zahlenfolgen für Leasing-IDs erstellen. Außerdem wird erläutert, wie Sie eindeutige IDs erstellen, die bei der Indexneubewertung verwendet werden.
author: moaamer
ms.date: 07/16/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8845315"
---
# <a name="assign-number-sequences"></a>Nummernkreise zuweisen

[!include [banner](../includes/banner.md)]

In diesem Artikel wird erläutert, wie Sie Zahlenfolgen für Leasing-IDs erstellen. Außerdem wird erläutert, wie Sie eindeutige IDs erstellen, die bei der Indexneubewertung verwendet werden.
