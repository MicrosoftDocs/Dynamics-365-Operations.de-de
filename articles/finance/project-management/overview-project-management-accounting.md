---
title: Projektmanagement- und Abrechnungsübersicht
...
ms.locfileid: "2770358"
---
# <a name="project-management-and-accounting-overview"></a>Projektmanagement- und Abrechnungsübersicht
...
Weitere Informationen finden Sie unter [Übersicht Projektstrukturpläne](work-breakdown-structures.md).
...
Sie können sechs Projekttypen in Finance erstellen. Jeder Typ wird unterschiedlich für Umsatzerkennung Kosten und eingerichtet. Der gewählte Projekttyp hängt vom Zweck des Projekts ab. Die folgende Tabelle beschreibt die typische Verwendung eines Projekttyps.
...
- *<strong><em>Verbrauchter Artikel/keine Verknüpfung mit Auftrag</em></strong>* – Ermöglicht die Verknüpfung des Projekts mit einem Artikelbedarf. Mithilfe dieser Methode lassen sich tatsächliche Projektkosten anzeigen, wenn die Produktion den Status <strong>Gestartet</strong> besitzt oder als fertig gemeldet wird. Die Kosten werden in Form von mehreren Projektartikelbuchungen für Rohmaterialen und Stunden gebucht, die für die Produktion verbraucht wurden. Sie können auch die Ebene der Stücklistenhierarchie definieren, auf der die Projekte in der Produktion nachverfolgt werden.
...
Finance verringert nicht automatisch die geplanten Vorkalkulationen. Daher wird empfohlen, dass Sie ein ursprüngliches Planzahlenmodell im Festpreisprojekt aufbewahren, um eine Basislinie einzurichten, mit der das Projekt verglichen wird, wenn es abgeschlossen ist. 
...
:::row:::
    :::column:::
        #### <a name="cash-flow-page"></a>Seite "Cashflow"
        - Zufluss flüssiger Mittel 
        - Abfluss flüssiger Mittel
        - Cashflows (netto)
    :::column-end:::
    :::column:::
        #### <a name="project-statements-page"></a>Seite "Projektaufstellungen"
        - Umsatzerlös
        - Gesamtkosten
        - Bruttogewinn
    :::column-end:::
