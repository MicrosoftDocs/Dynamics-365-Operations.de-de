...
description: Dieser Artikel enthält Referenzinformationen zu den verschiedenen Zahlungsbuchungen, für die die Quellenbesteuerung (TDS) berechnet wird.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8906317"
---
# <a name="tds-calculation-on-payments-and-promissory-notes"></a>TDS-Berechnung zu Zahlungen und Solawechseln

[!include [banner](../includes/banner.md)]

Dieser Artikel enthält Referenzinformationen zu den verschiedenen Zahlungsbuchungen, für die die Quellenbesteuerung (TDS) berechnet wird.
