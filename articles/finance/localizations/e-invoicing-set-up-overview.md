...
Informationen zu den Aktionen in den Verarbeitungs-Pipelines, aus denen der Prozess besteht, den Sie in den Funktionen zur Globalisierung erstellen, finden Sie unter **[KOMPLETT!: Aktionen zur Dokumentenverarbeitung]**.
