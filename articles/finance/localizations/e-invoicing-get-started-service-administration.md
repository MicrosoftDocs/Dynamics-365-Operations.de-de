...
- Sie müssen über ein LCS-Projekt verfügen, das Version 10.0.17 oder höher von Microsoft Dynamics 365 Finance oder Dynamics 365 Supply Chain Management umfasst. Darüber hinaus müssen diese Apps in einer der folgenden Azure-Regionen bereitgestellt werden:
...
6. Geben Sie in das Feld **AAD-Mandanten-ID** die Mandanten-ID Ihres Azure-Abonnementkontos ein. Der angegebene Azure Active Directory-Mandant (Azure AD) sollte derselbe Mandant sein, der für RCS verwendet wird.
7. Lesen Sie die allgemeinen Geschäftsbedingungen, und aktivieren Sie dann das Kontrollkästchen.
8. Wählen Sie **Installieren**. Die Installation kann mehreren Minuten dauern.
...
2. Wählen Sie im Arbeitsbereich **Globalisierungsfunktionen** im Abschnitt **Zugehörige Einstellungen** die Option **Elektronische Berichterstellungsparameter** aus.
3. Geben Sie auf der Registerkarte **Elektronische Rechnungsstellung** im Feld **Dienstendpunkt-URI** den entsprechenden Dienstendpunkt für Ihre Azure-Region ein, wie in folgender Tabelle dargestellt.
...
4. Vergewissern Sie sich, dass das Feld **Anwendungs-ID** auf **0cdb527f-a8d1-4bf8-9436-b352c68682b2** festgelegt ist. Dieser Wert ist ein fester Wert.
...
3. Wählen Sie auf der Seite **Umgebungseinrichtungen** im Aktivitätsbereich **Service-Umgebungen** aus wählen Sie dann **Key Vault-Parameter** aus.
...
1. Wählen Sie im Aktivitätsbereich auf der Seite **Umgebungseinrichtungen** im Aktivitätsbereich **Service-Umgebung** aus und wählen Sie dann **Key Vault-Parameter** aus.
...
1. Wählen Sie auf der Seite **Umgebungseinrichtungen** im Aktivitätsbereich **Verbundene Anwendungen** aus.
...
2. Geben Sie auf der Registerkarte **Elektronische Rechnungsstellung** im Feld **Endpunkt-URL** den entsprechenden Dienstendpunkt für Ihre Azure-Geografie ein, wie in der folgenden Tabelle dargestellt.
...
### <a name="enable-flighting-keys-for-finance-or-supply-chain-management-version-10017"></a>Flighting-Schlüssel für das Finance oder Supply Chain Management 10.0.17 aktivieren
