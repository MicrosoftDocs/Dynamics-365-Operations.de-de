...
description: In diesem Thema wird erklärt, wie Sie eine Verbindung konfigurieren, damit die Elektronische Rechnungsstellung auf eine Microsoft SharePoint-Seite zugreifen kann.
author: dkalyuzh
ms.date: 12/15/2021
ms.topic: article
ms.prod: ''
