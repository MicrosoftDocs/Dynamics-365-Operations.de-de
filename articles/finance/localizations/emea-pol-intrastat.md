...
description: Dieses Thema enthält Informationen zur Intrastat-Meldung in Polen.
author: andosip
ms.date: 11/09/2021
ms.topic: article
...
16. Wählen Sie **OK** und prüfen Sie den erzeugten Bericht im XML-Format. Die folgende Tabelle zeigt die Werte in dem Beispielbericht.
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Informationen über das Dokument</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Informationen über das Unternehmen</strong></p>
    </td>
    </tr>
    <tr>
    <td width="191">
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Informationen über die Ware</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p style="text-align: center;"><strong>Kontaktinformationen</strong></p>
    </td>
    </tr>
    <tr>
    <td>
