...
description: Dieser Artikel bietet einen Überblick über die Funktionen des Regulatory Configuration Service (RCS) und erläutert den Zugriff auf den Dienst.
author: kfend
ms.date: 06/04/2021
ms.topic: overview
ms.prod: ''
...
> [!NOTE] 
> RCS ist derzeit nicht für die Government Community Cloud (GCC) verfügbar.
