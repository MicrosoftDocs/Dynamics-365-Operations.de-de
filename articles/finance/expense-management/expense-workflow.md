...
---
# <a name="expense-management-workflow"></a>Spesenverwaltungsworkflow

[!include [banner](../includes/banner.md)]

Mithilfe des Workflowsystems können Sie einen Prüfprozess für Spesenabrechnungen in „Ausgabenverwaltung“ einrichten. Sie können einen Workflow einrichten, um zu bestimmen, wer Spesenabrechnungen unter den folgenden Kriterien genehmigt werden:
