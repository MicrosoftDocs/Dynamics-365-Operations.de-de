---
title: Arbeit mit Funktionen der elektronischen Nachrichten
description: In diesem Thema erfahren Sie, wie Sie mit der Funktionalität für elektronische Nachrichten (EN) arbeiten.
author: liza-golub
ms.date: 07/07/2021
ms.topic: article
ms.prod: ''
