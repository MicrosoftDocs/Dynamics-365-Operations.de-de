...
description: Dieser Artikel beinhaltet detaillierte Informationen zum Importformat, das beim Konsolidieren von Finanzdaten mehrerer juristischer Personen verwendet wird.
author: jinniew
ms.date: 10/09/2020
ms.topic: article
ms.prod: ''
...
Dieser Artikel beinhaltet detaillierte Informationen zum Importformat, das beim Konsolidieren von Finanzdaten mehrerer juristischer Personen verwendet wird. Das Importformat muss als Textdatei (.txt) gespeichert werden.
