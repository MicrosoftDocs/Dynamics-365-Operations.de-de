...
1. Gehen Sie zu **Navigationsbereich > Module > Steuern > Indirekte Steuern > Umsatzsteuer > Umsatzsteuer > Umsatzsteuerkennzeichen**.
2. Klicken Sie auf **Neu**.
3. Geben Sie im Feld **Umsatzsteuerkennzeichen** einen Wert ein.
4. Geben Sie im Feld **Beschreibung** einen Wert ein.
5. Schaltet die Erweiterung des Abschnitts **Setup** um.
6. Klicken Sie auf **Hinzufügen**.
7. Markieren Sie in der Liste die ausgewählte Zeile.
8. Klicken Sie im Feld **Verkaufssteuerkennzeichen** auf die Dropdown-Schaltfläche, um die Suche zu öffnen.
9. Klicken Sie in der Liste auf den Link in der ausgewählten Zeile.
10. Klicken Sie auf **Speichern**.
11. Schließen Sie die Seite.
12. Gehen Sie zu **Steuern > Indirekte Steuern > Umsatzsteuer > Artikel Umsatzsteuerkennzeichen**.
13. Klicken Sie auf **Neu**.
14. Geben Sie im Feld **Position Umsatzsteuerkennzeichen** einen Wert ein.
15. Geben Sie im Feld **Beschreibung** einen Wert ein.
16. Klicken Sie auf **Hinzufügen**.
17. Markieren Sie in der Liste die ausgewählte Zeile.
18. Klicken Sie im Feld **Verkaufssteuerkennzeichen** auf die Dropdown-Schaltfläche, um die Suche zu öffnen.
