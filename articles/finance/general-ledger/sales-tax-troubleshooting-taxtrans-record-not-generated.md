...
description: Dieser Artikel enthält Informationen zur Fehlerbehebung, die helfen können, wenn ein TaxTrans-Datensatz nicht generiert wird.
author: qire
ms.date: 04/13/2021
ms.topic: article
ms.prod: ''
...
[![Seite „Gebuchte Mehrwertsteuer“, die keine Positionen enthält.](./media/taxtrans-is-not-generated-Picture1.png)](./media/taxtrans-is-not-generated-Picture1.png)
