...
description: In diesem Thema werden die Unterschiede zwischen dem Rückbuchen, Löschen, Stornieren und Ablehnen einer Zahlung beschrieben. Desweiteren werden die zwei Methoden zur Rückbuchung eines Kreditorenschecks erläutert.
author: abruer
ms.date: 08/22/2017
ms.topic: article
ms.prod: ''
