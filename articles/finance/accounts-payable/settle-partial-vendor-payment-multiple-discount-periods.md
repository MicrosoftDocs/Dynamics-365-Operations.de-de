...
description: Dieses Thema führt Sie durch ein Szenario, in dem mehrere Teilzahlungen an einen Kreditoren vorgenommen werden, der mehrere Skonti anbietet.
author: abruer
ms.date: 08/22/2017
ms.topic: article
ms.prod: ''
...
Dieses Thema führt Sie durch ein Szenario, in dem mehrere Teilzahlungen an einen Kreditoren vorgenommen werden, der mehrere Skonti anbietet. 
