...
description: In diesem Artikel wird erläutert, wie Organisationen, die Lieferanten nach einem wiederkehrenden Zeitplan bezahlen, den Prozess der Generierung von Lieferantenzahlungsvorschlägen automatisieren können.
author: kweekley
ms.date: 04/08/2020
ms.topic: article
ms.prod: ''
...
> [!NOTE]
> Die Funktion **Automatisierung von Kreditorzahlungsvorschlägen** muss in der Funktionsverwaltung aktiviert werden, um diese Funktion nutzen zu können. 
