...
[![Auftragspositionen für Installationsservice und Supportplan](./media/13_rev-rec-scenarios.png)](./media/13_rev-rec-scenarios.png)
...
[![Seite „Umsatzerlöspreiszuteilung“](./media/14_rev-rec-scenarios.png)](./media/14_rev-rec-scenarios.png)
...
Der Umsatzerkennungszeitplan wird ebenfalls erstellt, aber es wird noch kein Umsatzerlös erkannt.

[![Seite „Umsatzerkennungszeitplan“](./media/16_rev-rec-scenarios.png)](./media/16_rev-rec-scenarios.png)
