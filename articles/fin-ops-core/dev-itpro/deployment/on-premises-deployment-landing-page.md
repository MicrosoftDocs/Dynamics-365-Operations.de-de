---
title: Startseite bei lokaler Bereitstellung
description: Dieser Artikel liefert Informationen und Links zu Inhalten über lokale Bereitstellungen.
author: sericks007
ms.date: 07/01/2021
ms.topic: article
...
Sie können Dynamics 365 Finance + Operations (on-premises) bereitstellen. Wenn Sie eine lokale Bereitstellungsform auswählen, unterscheiden sich die Systemanforderungen, die Hardwareauslegung und die Funktionalität von einer Cloud-Bereitstellung. Dieser Artikel bietet Links zu Inhalten mit Informationen speziell zu lokalen Bereitstellungen.
...
- [Von Microsoft Dynamics 365 Finance + Operations (on-premises) unterstützte Software](onprem-compatibility.md)
