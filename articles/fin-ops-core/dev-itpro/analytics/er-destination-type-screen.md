---
title: Bildschirm-E-Mail-ER-Zieltyp
description: Dieses Thema enthält Informationen zum Konfigurieren eines Bildschirmziels für jede Ordner- oder Datei-Komponente eines ER-Formats (Electronic Reporting), das zum Generieren ausgehender Dokumente konfiguriert ist.
author: NickSelin
manager: AnnBe
ms.date: 01/23/2020
ms.topic: article
...
Sie können ein Bildschirmziel für jede Ordner- oder Datei-Komponente eines ER-Formats (Electronic Reporting) konfigurieren, das zum Generieren ausgehender Dokumente konfiguriert ist. Basierend auf der Einstellung des Ziels wird die Vorschau eines generierten Dokuments auf einer separaten Browser-Registerkarte geöffnet.
