...
description: In diesem Artikel werden Informationen zur Verwendung der LISTOFFIELDS-Funktion bei der elektronischen Berichterstellung (EB) bereitgestellt.
author: kfend
ms.date: 12/12/2019
ms.prod: ''
ms.technology: ''
