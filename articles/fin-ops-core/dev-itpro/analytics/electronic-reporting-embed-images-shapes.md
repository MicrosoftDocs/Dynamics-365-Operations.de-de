...
description: In diesem Artikel wird erläutert, wie Sie mithilfe des elektronischen Berichterstellungstools (EB) Geschäftsdokumente mit eingebetteten Bildern und Formen generieren.
author: NickSelin
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
