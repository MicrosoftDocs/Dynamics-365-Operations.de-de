...
description: Dieser Artikel enthält Informationen zu den primitiven Datentypen, die in Formeln für die elektronische Berichterstellung (EB) unterstützt werden.
author: NickSelin
ms.date: 06/02/2021
...
Dieser Artikel enthält Informationen zu den primitiven Datentypen, die in Ausdrücken für die [elektronische Berichterstellung (EB)](general-electronic-reporting.md) unterstützt werden. Hier ist eine Liste der Typen der primitiven Daten:
