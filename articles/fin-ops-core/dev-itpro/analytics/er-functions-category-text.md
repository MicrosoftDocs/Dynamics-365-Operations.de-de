...
description: Dieser Artikel enthält Informationen zu den Textfunktionen, die in der elektronischen Berichterstellung (EB) unterstützt werden.
author: NickSelin
ms.date: 02/28/2022
ms.prod: ''
ms.technology: ''
...
ms.locfileid: "8885542"
---
# <a name="list-of-er-functions-of-the-text-category"></a>Liste der EB-Funktionen in der Textkategorie

[!include [banner](../includes/banner.md)]

Mithilfe der Textfunktionen für die elektronische Berichterstellung (EB) können Informationen aus den Datenquellen des Datentyps *String* zum Durchführen von Operationen an diesen verwendet werden. Dieser Artikel enthält eine Zusammenfassung dieser Funktionen.
