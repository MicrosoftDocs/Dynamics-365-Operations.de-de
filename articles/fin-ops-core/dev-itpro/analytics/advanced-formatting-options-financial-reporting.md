...
description: In diesem Artikel werden erweiterte Formatierungsfunktionen beschrieben, einschließlich Filter, Einschränkungen, nicht druckbare Zeilen und bedingte Anweisungen in Berechnungen.
author: panolte
ms.date: 04/26/2019
ms.topic: article
ms.prod: ''
