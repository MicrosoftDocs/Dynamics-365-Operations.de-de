...
description: In diesem Artikel wird beschrieben, wie Sie eine neue EB-Konfiguration (elektronische Berichterstellung) erstellen, die ein Datenmodell für Dokumente zur elektronischen Zahlung enthält.
author: NickSelin
ms.date: 08/29/2018
