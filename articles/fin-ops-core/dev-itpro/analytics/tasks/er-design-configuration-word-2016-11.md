---
title: EB-Konfigurationen mit Excel-Vorlagen erneut zur Erstellung von Berichten im Word-Format verwenden
description: In diesem Artikel wird beschrieben, wie Berichtsformate, die zum Generieren von Berichten als Excel-Arbeitsmappen entwickelt wurden, so konfiguriert werden können, dass Berichte als Word-Dokumente generiert werden.
author: NickSelin
ms.date: 04/23/2021
