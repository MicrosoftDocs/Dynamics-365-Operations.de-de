...
In diesem Thema wird beschrieben, was im Microsoft Power BI-Inhalt **Lagerortleistung** enthalten ist. Es erläutert, wie Sie auf die Power BI-Berichte zugreifen und enthält Informationen zum Datenmodell und zu den Entitäten, die verwendet werden, um den Inhalt zu erstellen.
