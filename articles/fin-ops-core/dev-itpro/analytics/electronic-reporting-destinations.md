...
> [!NOTE]
> Ein SMTP-Server (Simple Mail Transfer Protocol) muss konfiguriert und verfügbar sein. Sie können Ihren SMTP-Server unter **Systemadministration** &gt; **Einrichtung** &gt; **E-Mail** &gt; **E-Mail-Parameter** angeben.
...
> [!NOTE]
> Sie können einen Dokumenttyp für das Einzelvorgangsarchiv unter **Organisationsverwaltung** &gt; **Arbeitsbereiche** &gt; **Elektronische Berichterstattung** &gt; **Elektronische Berichterstattungsparameter**auswählen.
