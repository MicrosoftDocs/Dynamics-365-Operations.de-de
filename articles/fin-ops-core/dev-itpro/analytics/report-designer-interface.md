...
| Bericht anzeigen                       | Öffnen Sie die neueste Version des generierten Berichts. Dieser Befehl ist aus einer Berichtsdefinition verfügbar, wenn mindestens einen Bericht generiert wurde. |
...
| Berichtseinheit einfügen                  | Fügen Sie eine leere Zeile in die Berichtsbaumstruktur-Definition ein. Dieser Befehl ist in einer Berichtsbaumstruktur-Definition verfügbar. |
...
Das Menü **Gehe zu** ist für alle Benutzer verfügbar und enthält die folgenden Befehle.

> [!NOTE]
> Diese Befehle haben keine sichtbaren Auswirkungen, wenn der Navigationsbereich nicht sichtbar ist.
...
| Befehl | Beschreibung                                                              |
|---------|--------------------------------------------------------------------------|
| Hilfe    | Öffnen der Hilfe-Themen-Seite für die Finanzberichterstellung. |
|         |                                                                          |
