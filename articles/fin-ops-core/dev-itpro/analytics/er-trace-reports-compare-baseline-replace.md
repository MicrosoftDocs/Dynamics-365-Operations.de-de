...
description: Dieser Artikel beschreibt die Verbesserungen der Funktion ER Baseline in Microsoft Dynamics 365 Finance Version 10.0.3 (Juni 2019).
author: kfend
ms.date: 06/19/2019
ms.topic: article
ms.prod: ''
...
In diesem Artikel werden die ersten Verbesserungen beschrieben, die an der Grundfunktion des Frameworks der elektronischen Berichtererstellung (EB) erfolgt sind. Diese Verbesserungen sind in Microsoft Dynamics 365 Finance Version 10.0.3 (Juni 2019) und später verfügbar.
