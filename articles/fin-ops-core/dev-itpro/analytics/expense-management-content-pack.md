...
description: In diesem Artikel wird beschrieben, was im Power BI-Inhaltspaket zur Ausgabenverwaltung enthalten ist.
author: panolte
ms.date: 03/18/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8878312"
---
# <a name="expense-management-power-bi-content"></a>Power BI-Inhalt der Ausgabenverwaltung

[!include [banner](../includes/banner.md)]

In diesem Artikel wird beschrieben, was im Power BI-Inhalt zur Ausgabenverwaltung enthalten ist. 
