...
description: In diesem Artikel wird erläutert, wie Sie ein EB-Format (elektronische Berichterstellung) konfigurieren, um Berichte als Microsoft Word-Dateien zu generieren, in denen Inhaltssteuerelemente unterdrückt sind.
author: kfend
ms.date: 02/11/2021
...
- eine Entwurfsversion des EB-Formats **Beispiel-Arbeitsblattbericht**, das als **Ausführbar** gekennzeichnet ist
