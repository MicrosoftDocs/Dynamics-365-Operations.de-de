...
description: In diesem Artikel werden Informationen zur Verwendung von VALUEIN bei der elektronischen Berichterstellung (EB) bereitgestellt.
author: kfend
ms.date: 12/14/2021
ms.prod: ''
ms.technology: ''
