## <a name="customers-v3-to-accounts"></a>Debitoren V3 zu Konten

Diese Vorlage synchronisiert Daten zwischen Finance and Operations-Apps und Common Data Service.

Quellfilter: ((PartyType == "Organisation"))

Umgekehrter Quellfilter: customertypecode eq 3
...
nichts | >> | address1_addresstypecode | 2
nichts | >> | customertypecode | 3
PARTYTYPE | << | nichts | Organisation
