...
In den folgenden Tabellen sind die Entitäten in der Reihenfolge aufgeführt, in der Sie sie aktivieren müssen. Wenn Sie eine Karte für die anfängliche Synchronisierung aktivieren, erkennt Dual-Write automatisch andere Karten, die aktiviert werden müssen. Sie können die Seite **Duales Schreiben** in Finance and Operations Apps zum Auswählen oder Abbrechen der Auswahl von Entitäten während der ersten Synchronisierung nutzen.

In der neuesten Version von Duales Schreiben können Sie nur einige Entitäten aktivieren, und die Abhängigkeiten werden für Sie behandelt.
