---
title: Konfigurieren von Workflow-Eigenschaften
description: Dieser Artikel erläutert, wie Sie die verschiedenen Eigenschaften eines Workflows konfigurieren können.
author: ChrisGarty
ms.date: 07/07/2020
ms.topic: article
ms.prod: ''
...
---
# <a name="configure-workflow-properties"></a>Konfigurieren von Workflow-Eigenschaften
