...
7. Sie können Registerkarten wie die Anhangregisterkarte anzeigen oder ausblenden:
    ...
    1. Im Aktivitätsbereich wählen Sie **Abschnitte anzeigen** aus, um das Dropdown-Dialogfeld zu öffnen.
...
18. Wählen Sie **Messung hinzufügen** aus, um das Dropdown-Dialogfeld zu öffnen.
...
30. Wählen Sie die Registerkarte **Bewertungen** aus.  
    ...
    - Über das **Bewertungsdetails**-Inforegister können Mitarbeiter sich selbst und der Manager den Mitarbeiter bewerten. Wenn Gewichtungen verwendet werden, wird der Gewichtungswert der Bewertungen automatisch berechnet.  
    - Um diesen Bereich anzuzeigen, aktivieren Sie die Parametereinstellungen für das Anzeigen von Mitarbeiterbewertungen.  
