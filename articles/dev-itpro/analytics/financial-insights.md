...
**Finanzinformationen** verwendet Microsoft Power BI, um Finanzleistungskennzahlen (KPIs), Diagramme und Finanzaufstellungen zusammenzuführen. Power BI ist in Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition, eingebettet.
...
| Finanzeinblicke des derzeitigen Unternehmens anzeigen | •   Buchhalter •    Buchhaltungsleiter •    Supervisor Buchhaltung • Wirtschaftsprüfer •   Budget-Manager •    Leitender Geschäftsführer •   Leiter Finanzabteilung •   Financial Controller  |   • Diese Berechtigungen bieten Zugriff auf Finanzinformationen. • Standardmäßig wird das aktive Unternehmen als Filter verwendet. Sie können nicht andere juristische Personen hinzufügen.            |
...
Benutzer können den Bericht filtern, indem sie den Bereich **Filter** links verwenden. Dieser Bereich ist der gleiche Bereich, der durch Power BI Desktop verfügbar ist.
Es gibt verschiedene Ebenen der Filterung, von denen einige möglicherweise nicht verfügbar sind, abhängig davon, was Sie auf einer Seite (Registerkarte) ausgewählt haben oder ob Sie die Drillthroughfunktionen verwenden:
...
## <a name="what-is-coming-in-future-releases"></a>Was für Neuerungen wird es in zukünftigen Versionen geben?
Die neuen Arbeitsbereiche und Finanzaufstellungen, die Power BI verwenden, werden weiterhin verbessert werden. Hier sind einige der neuen Funktionen, die für zukünftige Versionen erwogen werden:

 - Die Möglichkeit, visuelle Elemente zu kopieren, zu bearbeiten, zu löschen und zu erstellen, sogar die Finanzaufstellungen.                                                  
 - Zusätzliche Standardberichte                                                                                                            
    - Unterstützung für zusätzliche Daten für untergeordnete Sachkonten                                                                                            
 - Unterstützung für eine Berichtswährung                                                                                                      
 - Hinzufügen benutzerdefinierter Berechnungen für Zeilen und Spalten                                                                                          
 - Die Fähigkeit, die Finanzaufstellungen nach Microsoft Excel zu exportieren                                                                     
   - Verwalten des Formats der Finanzaufstellung während des Exports.                                                                          
   - Analysieren von Daten in Excel mithilfe der Erstellung einer Pivottabelle, die die Informationen im visuellen Element verwendet.                                              
 - Gebietsschema-Unterstützung                                                                                                                        
 - Die Fähigkeit, Berichterstellungshierarchien zu definieren, damit Sie Hauptkontohierarchien oder eine Organisationshierarchie definieren können, die in Finanzaufstellungen für Entwurf, Filterung und Sicherheit verwendet werden können.                                                                    
 - Unterstützung für den Druck

Über die neuen Funktionen wird mittels der Roadmapwebsite informiert, sobald mit der Arbeit begonnen wurde: https://roadmap.dynamics.com/.
