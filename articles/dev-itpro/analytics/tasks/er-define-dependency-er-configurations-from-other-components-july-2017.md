...
Dieses Verfahren zeigt, wie eine Konfiguration für die elektronische Berichterstellung (ER) entworfen wird, und definiert die Abhängigkeit von anderen Softwarekomponenten, damit Sie sicherstellen können, dass die Konfiguration für eine bestimmten Version von Microsoft Dynamics 365 for Finance and Operations ordnungsgemäß heruntergeladen wurde. In diesem Beispiel erstellen Sie die erforderlichen ER-Konfigurationen für das Beispielunternehmen Litware, Inc. 
