...
9. In der Struktur erweitern Sie **Format \rroot: XML-Element Stammverzeichnis (Stamm)**.
10. Wählen Sie in der Strukturdarstellung **\root: XML Element(root)\dokument: XML Element 1.* (dokument)**.
11. Klicken Sie auf **Binden**.
12. Erweitern Sie in der Struktur**format\root: XML Element(root)\dokument: XML Element 1..* (dokument)**.
13. Wählen Sie in der Strukturdarstellung **\root: XML Element(root)\dokument: XML Element 1.* (dokument)\id**.
