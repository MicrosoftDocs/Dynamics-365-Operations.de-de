...
---
# <a name="run-format-to-use-document-management-files-in-format-outputs"></a>Format zum Verwenden von Dokumentverwaltungsdateien in Formatausgaben ausführen 
