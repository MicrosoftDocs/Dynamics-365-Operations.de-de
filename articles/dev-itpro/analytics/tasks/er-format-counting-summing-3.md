...
---
# <a name="use-computations-to-make-the-output-for-counting-and-summing"></a>Verwenden von Berechnungen zum Erstellen der Ausgabe für das Zählen und Summieren 
