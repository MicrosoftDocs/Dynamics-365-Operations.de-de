...
---
# <a name="extend-data-model-to-use-document-management-files-in-format-outputs"></a>Datenmodell zur Verwendung der Dokumentverwaltungsdateien in Formatausgaben erweitern
