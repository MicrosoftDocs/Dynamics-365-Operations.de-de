...
Mit den neuen ER-Funktionen können Sie Ausgangswerteinstellungen für das ausgewählte ER-Format aus der aktuellen Finance and Operations-Umgebung exportieren und als XML-Dateien speichern. 
...
Exportierte Ausgangswerteinstellungen können in eine andere Finance and Operations-Umgebung importiert werden. Die Umgebung muss zuerst als ER-Format importiert werden. Sie können anschließend die Ausgangswerteinstellungen importieren.
