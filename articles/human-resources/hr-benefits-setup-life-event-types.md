...
| **Gerichtlich angeordnete Unterstützung** | Arbeitskraft > Profil > Persönliche Informationen > Persönliche Kontakte > Abhängige > Gerichtlich angeordnete Unterstützung (QMSCO/QDRO) und Gültig bis | Beim Erstellen eines persönlichen Kontakts wird ein Lebensereignis erstellt, wenn **Gerichtlich angeordnete Unterstützung** **Ja** ist. Das Aktualisieren von **Gerichtlich angeordnete Unterstützung** oder **Gerichtlich angeordnetes Verfallsdatum** löst ebenfalls ein Lebensereignis aus. |
