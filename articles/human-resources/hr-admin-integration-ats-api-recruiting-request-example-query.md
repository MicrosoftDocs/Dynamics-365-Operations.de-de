---
title: Beispielabfrage für den Personalbeschaffungsantrag
description: Dieses Thema enthält eine Beispielabfrage für die Entität Personalbeschaffungsantrag in Dynamics 365 Human Resources.
author: jaredha
manager: tfehr
ms.date: 02/05/2021
ms.topic: article
...
ms.locfileid: "5125929"
---
# <a name="example-query-for-recruiting-request"></a><span data-ttu-id="c886b-103">Beispielabfrage für den Personalbeschaffungsantrag</span><span class="sxs-lookup"><span data-stu-id="c886b-103">Example query for Recruiting request</span></span>

<span data-ttu-id="c886b-104">Dieses Thema enthält eine Beispielabfrage für die Entität Personalbeschaffungsantrag in Dynamics 365 Human Resources.</span><span class="sxs-lookup"><span data-stu-id="c886b-104">This topic provides an example query for the Recruiting request entity in Dynamics 365 Human Resources.</span></span>

<span data-ttu-id="c886b-105">Die folgende Abfrage zeigt, wie Sie die Abfrageoption $expand in einer GET-Operation verwenden können, um einen angegebenen Personalbeschaffungsantragsdatensatz und alle zugehörigen Positionen, erforderlichen Qualifikationen und Ausbildungsanforderungen für die angegebene Anforderung abzurufen.</span><span class="sxs-lookup"><span data-stu-id="c886b-105">The following query shows how you can use the $expand query option in a GET operation to retrieve a specified recruiting request record and all associated positions, required skills, and educational requirements for the specified request.</span></span> <span data-ttu-id="c886b-106">Die Beispielantwort zeigt einen Personalbeschaffungsantrag für zwei Positionen sowie die erforderlichen Qualifikationen und Ausbildung für die angeforderten Positionen.</span><span class="sxs-lookup"><span data-stu-id="c886b-106">The example response shows a recruiting request for two positions, and the required skills and education for the requested positions.</span></span>

<span data-ttu-id="c886b-107">**Anforderung**</span><span class="sxs-lookup"><span data-stu-id="c886b-107">**Request**</span></span>
...
<span data-ttu-id="c886b-108">**Antwort**</span><span class="sxs-lookup"><span data-stu-id="c886b-108">**Response**</span></span>
...
## <a name="see-also"></a><span data-ttu-id="c886b-109">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="c886b-109">See also</span></span>

[<span data-ttu-id="c886b-110">Einführung der API zur Integration des Bewerber-Tracking-Systems</span><span class="sxs-lookup"><span data-stu-id="c886b-110">Applicant Tracking System integration API introduction</span></span>](hr-admin-integration-ats-api-introduction.md)<br>