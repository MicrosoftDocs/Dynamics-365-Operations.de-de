...
## <a name="cant-remove-activities-from-performance-review-form-403542"></a>Aktivitäten können nicht aus dem Leistungsüberprüfungsformular entfernt werden (403542)

Sie können nun ausgewählte Aktivitäten mit der Taste **Entfernen** löschen auf dem Formular **Leistungsbeurteilung**.
