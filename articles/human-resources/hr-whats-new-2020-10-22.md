...
| 514743 | Fehler im **E-Mail-Parameter** Formular bei Verwendung von Microsoft Exchange. | Die Meldung Dateien oder Assembly konnten nicht geladen werden ...wird auf der Seite **E-Mail-Parameter** angezeigt, wenn der E-Mail-Anbieter auf **Austausch** eingestellt war. Dieser Fix ermöglicht auch, dass die Seite **E-Mail-Parameter** zum Laden und Speichern verwendet wird wie erwartet. |
