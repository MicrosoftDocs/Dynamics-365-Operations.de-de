...
description: Dieser Artikel beschreibt Masseneinstellungsprojekte, die es dem Personalverwaltungsspezialisten erlauben, mehrere Positionen zu erstellen und effektiv mehrere Arbeitskräfte für diese Positionen einzustellen.
author: twheeloc
ms.date: 10/28/2021
ms.topic: article
ms.prod: ''
