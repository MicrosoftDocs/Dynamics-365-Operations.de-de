...
---
# <a name="create-plan-types"></a>Plantypen einrichten
...
3. Geben Sie Werte für die folgenden Felder an:
   ...
   | Code des Plantyps | Wählen Sie einen Plantypcode aus der Dropdown-Liste mit Werten aus. In der Liste der Plantypcodes werden alle Plantypen angezeigt, die in der aktuellen Version unterstützt werden. |
