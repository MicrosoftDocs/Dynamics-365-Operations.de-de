...
ms.locfileid: "8690665"
---
# <a name="manage-items-that-are-lent-to-workers"></a>Artikel verwalten, die an Arbeitskräfte ausgeliehen werden
...
Dies sind einige Beispiele von Artikeln, die Unternehmen an Arbeitskräfte verleihen können:
...
Mitarbeiter können über den Arbeitsbereich **Mitarbeiter-Self-Service** die Datensätze der verliehenen Artikel anzeigen. Sie können die vorhandenen Datensätze auch bearbeiten oder neue Ausleihartikel eingeben, wenn sie weitere physikalische Artikel eingegangen sind. Ein Workflow kann so eingerichtet werden, dass Änderungen für die neuen oder vorhandenen Ausleihartikeln durch einen Genehmigungsprozess weitergeleitet werden. 
...
##  <a name="account-for-lost-or-misplaced-loan-items"></a>Konto für verlorene oder verlegte Ausleihartikel
