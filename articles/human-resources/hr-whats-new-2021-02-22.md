...
Weitere Informationen über den Service-Update-Prozess finden Sie unter [Update-Prozess](https://docs.microsoft.com/dynamics365/human-resources/hr-admin-setup-update-process).
