...
description: Dieser Artikel beschreibt, wie das Benefits Management Informationen verfolgt, die auf den Formularen 1095-B und 1095-C für das Affordable Care Act (ACA) Arbeitgebermandat gemeldet werden.
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
