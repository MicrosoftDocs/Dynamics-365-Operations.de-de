...
#### [Plattformupdate 15 (März 2018)](get-started/whats-new-platform-update-15.md)
#### [Versionen und Lebenszyklusrichtlinie](../dev-itpro/migration-upgrade/versions-update-policy.md?toc=/fin-and-ops/toc.json)
...
#### [Plattformupdate 12 (November 2017)](get-started/whats-new-platform-update-12.md)
...
#### [Überprüfungen, Standards und nicht zugeordneter Felder](../dev-itpro/data-entities/validations-defaults-unmapped-fields.md?toc=/fin-and-ops/toc.json)
...
#### [Steuerdienste ERS-Integration](../financials/localizations/emea-fiscal-service-integration.md)
...
##### [Parameter für juristische Entitäten](../financials/localizations/latam-bra-legal-entity-parameters.md)
...
##### [Installieren des Dokumentweiterleitungsagenten, um Netzwerkdruckergeräte zu aktivieren](../dev-itpro/analytics/install-document-routing-agent.md?toc=/fin-and-ops/toc.json)
##### [Netzwerkdruckergeräte in on-premises-Umgebungen installieren](../dev-itpro/analytics/install-network-printer-onprem.md?toc=/fin-and-ops/toc.json)
...
#### [Ändern eines Formats, indem eine Microsoft Excel-Vorlage für elektronische Berichterstellung erneut angewendet wird](../dev-itpro/analytics/tasks/er-modify-format-by-reapplying-microsoft-excel-template-july-2017.md?toc=/fin-and-ops/toc.json)
...
##### [Entwerfen von Datenmodell zum Verwenden von Finanzdimensionen als Datenquelle für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-1.md?toc=/fin-and-ops/toc.json)
##### [Zuordnen von Modellen zum Verwenden von Finanzdimensionen als Datenquelle für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-2.md?toc=/fin-and-ops/toc.json)
##### [Entwerfen eines Berichts zum Verwenden von Finanzdimensionen als Datenquelle für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-3.md?toc=/fin-and-ops/toc.json)
##### [Ausführen eines Berichts, der Finanzdimensionen als Datenquelle für elektronische Berichterstellung verwendet](../dev-itpro/analytics/tasks/er-financial-dimensions-data-source-4.md?toc=/fin-and-ops/toc.json)
##### [Erstellen des Formats zur Zählung und Summierung für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-format-counting-summing-1.md?toc=/fin-and-ops/toc.json)
##### [Konfigurieren von Berechnungen zum Zählen und Summieren für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-format-counting-summing-2.md?toc=/fin-and-ops/toc.json)
##### [Verwenden von Berechnungen zum Erstellen der Ausgabe für das Zählen und Summieren für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-format-counting-summing-3.md?toc=/fin-and-ops/toc.json)
##### [Ausführen des Formats zum Zählen und Summieren für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-format-counting-summing-4.md?toc=/fin-and-ops/toc.json)
##### [Entwerfen eines Formats zum Verwenden horizontal erweiterbarer Bereiche zum dynamischen Hinzufügen von Spalten in Excel-Berichten für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-horizontal-1.md?toc=/fin-and-ops/toc.json)
##### [Ausführen eines Formats, das horizontal erweiterbarer Bereiche zum dynamischen Hinzufügen von Spalten in Excel-Berichten für elektronische Berichterstellung verwendet](../dev-itpro/analytics/tasks/er-horizontal-2.md?toc=/fin-and-ops/toc.json)
##### [Vorbereiten des Datenmodells zur Verwendung von Dokumentverwaltungsdateien in Formatausgaben für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-document-management-files-1.md?toc=/fin-and-ops/toc.json)
##### [Erweitern des Datenmodells zur Verwendung von Dokumentverwaltungsdateien in Formatausgaben für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-document-management-files-2.md?toc=/fin-and-ops/toc.json)
##### [Erstellen von Format zur Verwendung von Dokumentverwaltungsdateien in Formatausgaben für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-document-management-files-3.md?toc=/fin-and-ops/toc.json)
##### [Ausführen von Format zur Verwendung von Dokumentverwaltungsdateien in Formatausgaben für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-document-management-files-4.md?toc=/fin-and-ops/toc.json)
##### [Ändern und ausführen von Format zur Verwendung von Dokumentverwaltungsdateien in Formatausgaben für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-document-management-files-5.md?toc=/fin-and-ops/toc.json)
##### [Entwerfen von Konfigurationen zum Erstellen von Berichten in Microsoft Office-Formaten mit eingebetteten Bildern für elektronische Berichterstellung (ER) (Teil 1) ](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-july-2017.md?toc=/fin-and-ops/toc.json)
##### [Überprüfen von Konfigurationen zum Erstellen von Berichten in Microsoft Office-Formaten mit eingebetteten Bildern für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-2-review-configurations.md?toc=/fin-and-ops/toc.json)
##### [Generieren von Berichten in Microsoft Office-Formaten mit eingebetteten Bildern für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-make-reports-ms-office-formats-embedded-images-part-3-generate-reports.md?toc=/fin-and-ops/toc.json)
...
##### [Importieren von Konfigurationen zum Generieren von Dokumenten mit Anwendungsdatenupdate für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-1-import-configurations.md?toc=/fin-and-ops/toc.json)
##### [Generieren von Dokumenten mit Anwendungsdatenupdate für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-2-generate-documents.md?toc=/fin-and-ops/toc.json)
##### [Ändern von Modell und Zuordnung zum Generieren von Dokumenten mit Anwendungsdatenupdate für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-3-modify-model-mapping.md?toc=/fin-and-ops/toc.json)
##### [Ändern von Format zum Generieren von Dokumenten mit Anwendungsdatenupdate für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-4-modify-format.md?toc=/fin-and-ops/toc.json)
##### [Generieren von Dokumenten mit Anwendungsdatenupdate für elektronische Berichterstellung](../dev-itpro/analytics/tasks/er-generate-documents-application-data-update-part-5-generate-documents-application-data-update.md?toc=/fin-and-ops/toc.json)
...
### Verwaltungs-Tools für Poweruser
