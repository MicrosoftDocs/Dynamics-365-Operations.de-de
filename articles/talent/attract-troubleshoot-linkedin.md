...
---
# <a name="troubleshoot-integration-with-linkedin"></a>Probleme mit der Integration mit LinkedIn

[!include [banner](../includes/banner.md)]

Verwenden Sie die folgenden Informationen, um Probleme zu beheben, die Sie möglicherweise haben, wenn Sie versuchen, Stellen auf LinkedIn von Microsoft Dynamics 365 for Talent Attract zu veröffentlichen.

## <a name="you-cant-sign-in-to-linkedin-from-attract"></a>Sie können sich von Attract nicht bei LinkedIn anmelden

Wenn Sie Schwierigkeiten bei der Anmeldung zu LinkedIn von Attract haben, versuchen Sie diese Schritte:

1. Überprüfen Sie, dass die LinkedIn Anmeldeinformationen, die Sie in Attract eingegeben haben, gültig und korrekt sind.
2. Wenn die Anmeldeinformationen gültig sind und korrekt sind, kontaktieren Sie den [LinkedIn Support](https://www.linkedin.com/help/linkedin).
3. Wenn das Problem weiterhin besteht, kontaktieren Sie den [Microsoft Support](./talent-support.md).

## <a name="job-posts-from-attract-dont-appear-on-linkedin"></a>Stellen von Attract werden nicht auf LinkedIn veröffentlicht
