...
---
# <a name="enable-broadbean-integration"></a>Broadbean-Integration aktivieren
...
3. Broadbean kontaktieren und die Informationen in den Feldern **Benutzername**, **Client-ID** und **Verschlüsselungs-Token** eingeben.
