...
-   [Konfigurieren und filtern Sie Arbeitsbereiche](../fin-and-ops/get-started/configure-filter-workspaces.md) - Dieses Thema zeigt, wie Sie die Darstellung und die Handhabung von Arbeitsbereichen ändern können.

-   [Seiten mithilfe des Symbols „In neuem Fenster öffnen” nebeneinander anzeigen](../fin-and-ops/get-started/display-pages-side-by-side.md) - In bestimmten Fällen ist es effizient, mehrere parallele Seiten anzuzeigen, die es beim Vergleichen erleichtern, schnell Aufgaben abzuschließen. In diesem Thema wird erläutert, wie parallele Bildseiten angezeigt werden. 
