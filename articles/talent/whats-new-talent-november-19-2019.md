...
### <a name="platform-update-31-for-finance-and-operations-apps"></a>Platform update 31 für Finance and Operations-Apps

Weitere Informationen finden Sie unter [Vorschau der Funktionen in Platform update 31 für Finance and Operations Apps (Januar 2020)](https://docs.microsoft.com/dynamics365/fin-ops-core/dev-itpro/get-started/whats-new-platform-update-31).
