...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-core-hr-august-2018"></a>Neuerungen und Änderungen in Dynamics 365 Talent: Core HR (August 2018)
...
Diese Funktion bietet Ihnen die Möglichkeit, auch den Zeitraum anzugeben, in dem nach dem Ablaufen von Datensätzen gesucht wird.
...
Dokumentvorlagen sind über Core HR aktiviert. Dieses Funktion ermöglicht es Ihnen, Buchstaben und Berichte auf Grundlage von Word-Vorlagen zu erstellen.

Zusätzliche Informationen zu dieser Funktion verfügbar unter [Office-Integrationslernprogramm](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/office-integration/office-integration-tutorial?toc=/dynamics365/unified-operations/talent/toc.json).
