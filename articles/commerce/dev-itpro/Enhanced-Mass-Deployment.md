...
| --Install | Ein Parameter, der angibt, ob die von diesem Installationsprogramm bereitgestellte Komponente installiert werden soll. Dieser Parameter ist nicht erforderlich. |
