...
description: In diesem Artikel wird beschrieben, wie Sie die erweiterte Anmeldefunktionalität der Point of Sale (POS)-Anwendung Microsoft Dynamics 365 Commerce festlegen und verwenden können.
author: boycezhu
ms.date: 03/18/2022
ms.topic: article
ms.prod: ''
...
In diesem Artikel wird beschrieben, wie Sie die erweiterte Anmeldefunktionalität der Point of Sale (POS)-Anwendung Microsoft Dynamics 365 Commerce festlegen und verwenden können.
