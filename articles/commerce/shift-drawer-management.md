...
Damit geteilte Schichten in einem Shop verwendet werden können, muss die Kassenlade als „Schichtkassenlade“ unter **Retail und Commerce \> Kanaleinrichtung \> POS-Einrichtung \> POS-Profile \> Hardwareprofile \> Kassenladen** konfiguriert werden. Darüber hinaus müssen Benutzer eine oder beide der freigegebenen Schichtberechtigungen haben (geteilte Schicht verwalten und geteilte Schicht nutzen zulassen).
...
Gehen Sie zu **Retail und Commerce \> Kanäle \> Shops \> Alle Shops \> Auszug/Abschluss** und legen Sie für jeden Shop das Feld **Auszugsmethode** und das Feld **Abschlussmethode** auf **Schicht** fest.
