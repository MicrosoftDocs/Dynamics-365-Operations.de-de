...
description: In diesem Artikel wird erläutert, wie Benutzer laufende Transaktionen aussetzen und sie später oder in einem anderen Register mit Dynamics 365 Commerce wiederaufnehmen können.
author: jblucher
ms.date: 11/27/2018
ms.topic: article
ms.prod: ''
