...
description: Dieser Artikel behandelt die Kostenkonfiguration für die Funktion zur verteilten Auftragsverwaltung (DOM) in Dynamics 365 Commerce.
author: josaw1
ms.date: 12/05/2018
ms.topic: index-page
ms.prod: ''
