...
---
# <a name="sync-product-ratings-in-dynamics-365-retail"></a>Synchronisieren von Produktbewertungen in Dynamics 365 Retail

[!include [banner](includes/preview-banner.md)]
[!include [banner](includes/banner.md)]

In diesem Thema wird das Synchronisieren von Produktbewertungen in Microsoft Dynamics 365 Retail beschrieben.

## <a name="overview"></a>Übersicht

Um Produktbewertungen in Mehrkanal-Lösungen, z. B. am Point of Sale (POS) und in Callcentern, zu verwenden, müssen die Produktbewertungen aus dem Dienst Bewertungen und Überprüfungen in die Retail Kanaldatenbank importiert werden. Wenn Produktbewertungen in Mehrkanal-Lösungen zur Verfügung gestellt werden, können sie Kunden indirekt bei ihren Interaktionen mit Vertriebspartnern unterstützen.

In diesem Thema werden folgende Aufgaben beschrieben:

1. Konfigurieren eines Retail-Batchauftrags zum Importieren von Produktbewertungen
...
## <a name="configure-a-retail-batch-job-to-import-product-ratings"></a>Konfigurieren eines Retail-Batchauftrags zum Importieren von Produktbewertungen

> [!IMPORTANT]
> Vor dem Start sicherstellen, dass Version 10.0.6 oder höher von Retail installiert ist

### <a name="initialize-the-retail-scheduler"></a>Retail Steuerprogramm initialisieren

Um das Retail Steuerprogramm zu initialisieren, führen Sie die folgenden Schritte aus:

1. Navigieren Sie zu **Retail \> Headquarters-Einstellungen \> Retail Steuerprogramm \> Retail Steuerprogramm initialisieren**. Suchen Sie alternativ nach „Retail Steuerprogramm initialisieren“.
1. Stellen Sie im Dialogfeld **Retail Steuerprogramm** sicher, dass die Option **Vorhandene Konfiguration löschen** auf **Nein** festgelegt ist, und wählen Sie dann **OK** aus.
...
1. Navigieren Sie zu **Retail \> Headquarters-Einstellungen \> Retail Steuerprogramm \> Steuerprogrammunteraufträge**. Suchen Sie alternativ nach „Steuerprogrammunteraufträge“.
1. Finden oder suchen Sie in der Unterauftragsliste den Unterauftrag **RetailProductRating**.

Die folgende Abbildung zeigt ein Beispiel der Seite Unterauftragsdetails in Retail.

![Details des Unterauftrags RetailProductRating](media/rnr-hq-ratings-sub-job.png)

> [!NOTE]
> Wenn Sie den Unterordner **RetailProductRating** nicht finden, haben Sie vielleicht den Auftrag **Synchronisieren von Produktbewertungen** und den Auftrag **1040 CDX** ausgeführt, bevor Sie das Retail Steuerprogramm initialisiert haben. Befolgen Sie in diesem Fall die Schritte, um den Auftrag **Vollständige Datensynchronisierung** auszuführen.
>
> 1. Navigieren Sie zu **Retail \> Headquarters-Einstellungen \> Retail Steuerprogramm \> Kanaldatenbank**. Suchen Sie alternativ nach „Kanaldatenbank“.
...
Führen Sie die folgenden Schritte aus, um Produktbewertungen aus dem Bewertungs- und Überprüfungsdienst in Retail zu importieren.

1. Navigieren Sie zu **Retail \> Headquarters-Einstellungen \> Retail Steuerprogramm \> Produktbewertungsauftrag synchronisieren**. Suchen Sie alternativ nach „Produktbewertungsauftrag synchronisieren“.
...
Die folgende Abbildung zeigt ein Beispiel der Batchauftragskonfiguration in Retail.
...
1. Navigieren Sie zu **Retail \> Systemadministrator \> Abfragen \> Batchaufträge** oder bei Verwendung einer Retail-Lagermengeneinheit zu **Retail \> Abfragen und Berichte \> Batchaufträge**. Suchen Sie alternativ nach „Batchaufträge“.
...
Die folgende Abbildung zeigt ein Beispiel für die Batchauftragsdetails in Retail, wenn die Ausführung des Batchauftrags in zweistündigen Intervallen geplant ist.
...
1. Gehen Sie zu **Retail \> Retail-Setup \> Parameter \> Retail-Parameter**. Suchen Sie alternativ nach „Retail-Parameter“.
...
1. Klicken Sie auf **Retail \> Retail IT \> Distributions-Zeitplan**. Suchen Sie alternativ nach „Vertriebsplan“.
...
Die folgende Abbildung zeigt ein Beispiel für die Konfiguration der Retail-Parameter zum Aktivieren der Produktbewertungen am POS.
