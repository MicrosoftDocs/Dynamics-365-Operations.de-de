...
description: Die Artikel dieses Abschnitts enthalten Informationen zum Verarbeiten von Bestellungen für Callcenter mit Dynamics 365 Commerce.
author: josaw1
ms.date: 02/04/2022
ms.topic: article
ms.prod: ''
...
Bevor Vertrieb korrekt durch einen Callcenterkanal verarbeitet werden kann, müssen korrekte [Zahlungsmethoden](/dynamics365/unified-operations/retail/work-with-payments) und Lieferarten für den Kanal definiert werden.
...
> [!NOTE]
> Wenn die Funktion **Omni-Channel Commerce Auftragszahlungen** aktiviert ist, wird die Schaltfläche Call Center **Auftragsabwicklung aktivieren** in der Zentralverwaltung auf der **Allgemein** Inforegister Ihres Channels unter **Einzelhandel und Commerce \> Channels \> Call Center** ausgeblendet.
