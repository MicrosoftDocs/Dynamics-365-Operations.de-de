...
4. Suchen Sie die Erweiterungskonfigurationsdatei für die Erweiterungen der Hardware station. Die Datei hat den Namen **HardwareStation.Extension.config**.
    ...
    - **Gemeinsame Hardwarestation:** Die Datei befindet sich unter dem Standort der IIS-Hardwarestation.
    - **Dedizierte Hardwarestation auf Modern POS:** Die Datei befindet sich unter dem Speicherort des Modern POS Client Brokers.
...
4. Suchen Sie die Erweiterungskonfigurationsdatei für CRT:
    ...
    - **Lokal CRT auf Modern POS:** Die Datei heißt **CommerceRuntime.MPOSOffline.Ext.config** und befindet sich im Ordner **bin\\ext** unter dem lokalenCRTClient Broker Speicherort.
...
3. Nehmen Sie die folgenden Änderungen in der Paketanpassungs-Konfigurationsdatei **Anpassungs-Einstellungen** im Ordner **BuildTools** vor:
    ...
    - Entfernen Sie die folgende Zeile, um die frühere Hardware-Stationserweiterung von bereitzustellenden Paketen auszuschließen.
    ...
    - Fügen Sie die folgenden Zeilen hinzu, um die aktuelle Beispiel-Hardware-Stationserweiterung in die bereitstellbaren Pakete aufzunehmen.
