...
description: In diesem Artikel wird der Wartungszeitplan in Anlagenverwaltung erläutert.
...
1. Klicken Sie auf **Anlagenverwaltung** > **Wartungszeitplan** > **Alle Wartungszeitpläne** oder **Wartungszeitplanpositionen öffnen** oder **Wartungszeitplanpools öffnen**.
