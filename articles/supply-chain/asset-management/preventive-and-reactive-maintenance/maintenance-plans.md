---
title: Wartungspläne
description: In diesem Artikel werden Wartungspläne in Anlagenverwaltung erläutert.
...
- Eine neuen Art von Wartungsplanintervall mit der Bezeichnung *Wiederholt für aggregierten Wert (nur Zähler)*. Diese Intervallart löst jedes Mal eine Wartung aus, wenn ein aggregierter Zähler ein Vielfaches eines bestimmten Werts erreicht. Beispielsweise kann die Wartung alle 10.000 Stunden ausgelöst werden. Weitere Informationen finden Sie im Abschnitt [Übersicht der Intervallarten](#interval-types) weiter oben in diesem Artikel.
