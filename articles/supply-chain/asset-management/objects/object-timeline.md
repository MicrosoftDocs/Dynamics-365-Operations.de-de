...
- Wann ein Einzelvorgangstyp zuletzt für eine Anlage verwendet wurde
- Wenn eine bestimmte Arbeitskraft eine Bemerkung für einen Arbeitsauftragseinzelvorgang eingegeben hat

Die Zeitachse wird immer dann aktualisiert, wenn die Seite geöffnet wird. Sie enthält die folgenden Informationen:

- Änderungen, die für die Anlage vorgenommen wurden: Anlagenstandort, Anlagenkennung und Herstellergarantie
- Übergeordnete Anlage
- Anlagenstückliste (BOM)
- Anlagenlebenszyklusstatus-Protokoll
