...
| Vertrieb und Marketing | Aktualisierungshistorie für Auftrag bereinigen | Mit dieser Funktion können Sie temporäre historische Aufzeichnungen im Zusammenhang mit Bestellaktualisierungen bereinigen. Es fügt eine neue Schaltfläche namens **Bereinigen Sie den Verlauf der Verkaufsaktualisierungen** zum Aktivitätsbereich der Detail- und Listenseiten für Kundenaufträge hinzu. |
