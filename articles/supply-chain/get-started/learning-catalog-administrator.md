...
| Inhalt | Beschreibung  | Formate | Länge    |
|---------|--------------|--------|-----------|
| [Dynamics AX 2012 auf Finance and Operations Apps aktualisieren](/learn/paths/upgrade-ax-2012-finance-operations/) | Lernen Sie die wichtigsten Elemente und bewährte Methoden für ein erfolgreiches Upgrade Ihrer Dynamik AX 2012 Lösung auf Finance and Operations Apps kennen. +Von den ersten Schritten zum Erkennen der wichtigsten Architekturunterschiede über den Einstieg in den Aktualisierungsprozess und die Tools zum Aktualisieren von Code und Daten bis hin zu den besten Möglichkeiten, Ihre Integrationen, Analysen und Berichte auf der Grundlage der neuesten Funktionen neu zu gestalten. | Kostenloser Online-Lernpfad in der eigenen Geschwindigkeit | 7 Stunden |
