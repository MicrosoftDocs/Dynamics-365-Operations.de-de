...
description: Dieser Artikel beschreibt, wie Sie Qualitätsprüfungsaufträge in Microsoft Dynamics 365 Supply Chain Management verwenden können, um automatisch Qualitätsprüfungsaufträge zu generieren, die mit Ihren Verkaufs-, Einkaufs- und Produktionsprozessen zusammenhängen.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8887514"
---
# <a name="quality-associations"></a>Qualitätszuordnungen

[!include [banner](../includes/banner.md)]

Dieser Artikel beschreibt, wie Sie Qualitätsprüfungsaufträge in Microsoft Dynamics 365 Supply Chain Management verwenden können, um automatisch Qualitätsprüfungsaufträge zu generieren, die mit Ihren Verkaufs-, Einkaufs- und Produktionsprozessen zusammenhängen.
