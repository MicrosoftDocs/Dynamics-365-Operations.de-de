...
Um die Elemente, die einer Qualitätsgruppe zugeordnet sind, oder die Qualitätsgruppen, die einem Element zugeordnet sind, einzurichten, zu bearbeiten und anzuzeigen, gehen Sie zu **Lagerverwaltung \> Einstellungen \> Qualitätsgruppen**. Nachdem Sie die Testanforderungen auf der Seite **Testgruppen** definiert haben, können die Regeln für die automatische Generierung von Qualitätsprüfungsaufträgen definieren. Um den Prozess zu vereinfachen, definieren Sie keine Regeln für einzelne Elemente. Stattdessen können Sie die Regeln für eine Qualitätsgruppe auf der Seite **Qualitätszuordnungen** definieren.
...
1. Gehen Sie zu **Lagerverwaltung \> Einstellungen \> Qualitätskontrolle \> Element-Qualitätsgruppen**.
1. Wählen Sie im Aktivitätsbereich **Neu** aus, um eine Zeile zum Raster hinzuzufügen. Legen Sie für die neue Zeile die folgenden Felder fest:
