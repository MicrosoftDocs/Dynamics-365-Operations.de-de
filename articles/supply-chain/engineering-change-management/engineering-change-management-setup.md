...
description: Dieser Artikel beschreibt, wie Sie allgemeine Werte festlegen, die für Parameter in verschiedenen Teilen der Verwaltung für technische Änderung verwendet werden.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
