...
description: In diesem Artikel wird beschrieben, wie Sie Rückvergütungsverwaltungsgruppen festlegen. Rückvergütungsverwaltungsgruppen können bei Rückvergütungsberechnungen verwendet und an einen Masterdatensatz angehängt werden.
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
