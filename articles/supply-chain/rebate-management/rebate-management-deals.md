...
1. Stellen Sie die folgenden Felder für die neue Deal-Position ein:
    ...
    - **Einheitentyp**: Wählen Sie den Einheitentyp aus, der für die Dealposition gilt (*Lagereinheit* oder *Artikelgewichtseinheit*). Beachten Sie, dass dieses Feld bei älteren Datensätzen möglicherweise leer ist. In diesem Fall wird der Wert *Lagereinheit* vorausgesetzt.
