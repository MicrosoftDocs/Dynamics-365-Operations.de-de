...
## <a name="turn-on-the-inventory-value-report-storage-feature"></a>Aktivieren Sie die Funktion für Lagerwert-Berichtsspeicher

Der Standard-**Lagerwert** bericht ist standardmäßig aktiviert. Wenn Sie jedoch erweiterte **Lagerwert-Berichtsspeicher**-Berichte generieren können, müssen Sie die Funktion in Ihrem System aktivieren. Administratoren können mit den Einstellungen [Funktionsverwaltung](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) den Status der Funktion überprüfen und ggf. aktivieren. Im Arbeitsbereich **Funktionsverwaltung** ist die Funktion wie folgt aufgeführt:

- **Modul:** *Kostenverwaltung*
- **Funktionsname:** *Lagerwert-Berichtsspeicher*
