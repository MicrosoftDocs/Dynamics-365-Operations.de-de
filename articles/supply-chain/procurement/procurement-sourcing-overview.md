...
---
# <a name="procurement-and-sourcing-overview"></a>Beschaffung – Übersicht

[!include [banner](../includes/banner.md)]

Dieser Artikel enthält eine Übersicht von den Funktionen, die im Beschaffungsmodul verfügbar sind.
...
'''''''' *Ausgabenlimits* können verwendet werden, um die Ausgaben für Materialanforderungen einzuschränken, und der *Einkaufsworkflow* fügt die Option des Benötigens einer Genehmigung hinzu, bevor Sie bestellen. Es ist auch möglich, die Budgetmittelzuteilung anzugeben, falls erforderlich.  
...
' Der Produktempfang kann in einen automatischen Verbrauch für einen bestimmten Zweck resultieren. Hierzu zählen der implizite Verbrauch mit Direktlieferung, der Verbrauch in Richtung eines Projekts oder die Berechnung des Produkts als Anlage.  
...
Fakturierte Bestellungen werden die Verbindlichkeiten im Kreditorenkonto innerhalb der Kreditoren erfassen, von wo aus die *K*reditoren*zahlung* verarbeitet werden kann.
