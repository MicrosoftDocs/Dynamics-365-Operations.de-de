...
Wenn Ihr System die in diesem Thema beschriebene Funktion noch nicht enthält, gehen Sie zu [Funktionsverwaltung](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) und aktivieren Sie die Funktion *Lieferanten zulassen, sich für Beschaffungskategorien durch Zusammenarbeit mit Lieferanten zu bewerben*.

Nachdem die Funktion eingeschaltet ist, können Sie immer noch manuell Beschaffungskategorien zu Lieferantenkonten hinzufügen. Informationen finden Sie unter [Kreditoren für bestimmte Beschaffungskategorien genehmigen](tasks/approve-vendors-specific-procurement-categories.md).
