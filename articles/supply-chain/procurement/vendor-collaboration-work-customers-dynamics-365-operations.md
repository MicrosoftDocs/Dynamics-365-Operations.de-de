...
description: "In diesem Thema wird beschrieben, wie Sie Kreditorenzusammenarbeit in Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition, verwenden können, um mit Bestellungen zu arbeiten und Lieferungsbestand zu überwachen."
author: mkirknel
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
In diesem Thema wird beschrieben, wie Sie Kreditorenzusammenarbeit verwenden können, um mit Debitoren in Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition, zu arbeiten. Kreditoren können eine Serie von Geschäftsprozesse aus den folgenden Arbeitsbereichen ausführen:
...
- **Alle bestätigten Bestellungen** – Diese Seite enthält alle Bestellungen, die bestätigt wurden. Die Bestellungen auf dieser Seite umfassen Bestellungen, bei denen Produkte und Dienstleistungen empfangen wurden. Sie können diese Liste verwenden, um Bestellungen zu überwachen, für die Sie Rechnungen übermitteln können.
...
Mithilfe des Arbeitsbereichs **Kreditorenangebotsabgabe** können Sie die Angebotsanforderungen anzeigen, bei denen Ihr Unternehmen eingeladen wurde, darauf zu antworten. Sie können auch auf die Angebotsanforderungen antworten. 

Der Arbeitsbereich zeigt auch alle Angebotsanforderungen an, die Sie verloren oder gewonnen haben. Wenn das System für den öffentlichen Sektor konfiguriert ist, zeigt der Arbeitsbereich darüber hinaus die Angebotsanforderungen an, die öffentlich verfügbar sind.
...
**Hinweis:** Diese Funktionalität ist nur verfügbar, wenn die Konfiguration für den öffentlichen Sektor aktiviert ist.
