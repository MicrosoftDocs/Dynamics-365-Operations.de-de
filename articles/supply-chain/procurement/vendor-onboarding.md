...
description: In diesem Artikel wird der Prozess beschrieben, durch den neue Kreditoren aufgenommen werden. Es werden die Aktivitäten erklärt, die während des Prozesses von verschiedenen Rollen erforderlich sind.
...
Eine kurze Demonstration des Onboarding-Prozesses für Kreditor sehen Sie in diesem kurzen YouTube Video [Wie Sie einen neuen Kreditor in Finanzen und Betrieb einbinden](https://www.youtube.com/watch?v=0KUc3AGaTKk).
