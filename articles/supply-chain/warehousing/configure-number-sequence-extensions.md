...
description: Dieser Artikel bietet einen Überblick über die Funktionen, die Nummernkreiserweiterungen für Kennzeichen-IDs, Wellenetikett-IDs, Container-IDs und Frachtbrief-IDs.
author: Mirzaab
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''
