...
- <span data-ttu-id="0b306-124">Stornieren Sie Etikette (z. B. in Szenarien von Entnahme mit unzureichender Menge) und drucken Sie sie erneut.</span><span class="sxs-lookup"><span data-stu-id="0b306-124">Void labels (for example, in short pick scenarios), and reprint them.</span></span>
...
- <span data-ttu-id="0b306-137">**Module:** *Lagerortverwaltung*</span><span class="sxs-lookup"><span data-stu-id="0b306-137">**Module:** *Warehouse management*</span></span>
...
<span data-ttu-id="0b306-150">Mit Wellenvorlagen können Sie bestimmte Instanzen von Wellenmethoden mit einer entsprechenden Wellenetikettenvorlage verknüpfen.</span><span class="sxs-lookup"><span data-stu-id="0b306-150">Wave templates let you link specific instances of wave methods to a corresponding wave label template.</span></span>
...
1. <span data-ttu-id="0b306-166">Fügen Sie eine Zeile mit den folgenden Einstellungen hinzu:</span><span class="sxs-lookup"><span data-stu-id="0b306-166">Add a row that has the following settings:</span></span>
...
1. <span data-ttu-id="0b306-180">Fügen Sie im Abfrage-Editor-Dialogfeld auf der Registerkarte **Bereich** eine Zeile mit den folgenden Einstellungen ein:</span><span class="sxs-lookup"><span data-stu-id="0b306-180">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>
    ...
    <span data-ttu-id="0b306-185">Diese Abfrage stellt sicher, dass nur Arbeitspositionen vom Entnahmetyp auf dem Etikett gedruckt werden und nicht Arbeitspositionen vom Einlagerungstyp.</span><span class="sxs-lookup"><span data-stu-id="0b306-185">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>
...
<span data-ttu-id="0b306-200">Wellenetikettentypen werden verwendet, um Wellenetikettenvorlagen mit einer Einheit in Einheitsnummernkreisgruppen-Positionen zu verknüpfen.</span><span class="sxs-lookup"><span data-stu-id="0b306-200">Wave label types are used to link wave label templates to a unit on unit sequence group lines.</span></span>
...
1. <span data-ttu-id="0b306-218">Im Inforegister **Allgemein** legen Sie das Feld **Wellenetikettentyp** auf *Karton* fest.</span><span class="sxs-lookup"><span data-stu-id="0b306-218">On the **General** FastTab, set the **Wave label type** field to *Carton*.</span></span>
...
1. <span data-ttu-id="0b306-233">Fügen Sie im Abfrage-Editor-Dialogfeld auf der Registerkarte **Sortieren** eine Zeile mit den folgenden Einstellungen ein:</span><span class="sxs-lookup"><span data-stu-id="0b306-233">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="0b306-234">**Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-234">**Table:** *Work lines*</span></span>
...
### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="0b306-249">Einen Auftrag erstellen und ihn für den Lagerort freigeben</span><span class="sxs-lookup"><span data-stu-id="0b306-249">Create a sales order and release it to the warehouse</span></span>
...
## <a name="scenario-2-wave-label-printing-for-containerization-without-wave-label-records"></a><span data-ttu-id="0b306-285">Szenario 2: Wellenetikettendruck zur Containerisierung (ohne Wellenetikettendatensätze)</span><span class="sxs-lookup"><span data-stu-id="0b306-285">Scenario 2: Wave label printing for containerization (without wave label records)</span></span>
...
<span data-ttu-id="0b306-296">Dieses Szenario zeigt den End-to-End-Flow.</span><span class="sxs-lookup"><span data-stu-id="0b306-296">This scenario shows the end-to-end flow.</span></span>
...
### <a name="create-a-wave-label-layout"></a><span data-ttu-id="0b306-311">Ein Wellenetikettenlayout erstellen</span><span class="sxs-lookup"><span data-stu-id="0b306-311">Create a wave label layout</span></span>
...
1. <span data-ttu-id="0b306-320">Fügen Sie eine Zeile mit den folgenden Einstellungen hinzu:</span><span class="sxs-lookup"><span data-stu-id="0b306-320">Add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="0b306-328">**Zeilen pro Seite:** *5*</span><span class="sxs-lookup"><span data-stu-id="0b306-328">**Rows per page:** *5*</span></span>
        ...
        <span data-ttu-id="0b306-329">Dieses Feld definiert die Anzahl der Zeilen, die auf jedes Etikett gedruckt werden können.</span><span class="sxs-lookup"><span data-stu-id="0b306-329">This field defines the number of rows that can be printed on each label.</span></span>
...
1. <span data-ttu-id="0b306-354">Wechseln Sie zu **Lagerortverwaltung \> Setup \> Dokumentrouting \> Wellenetikettenvorlagen**.</span><span class="sxs-lookup"><span data-stu-id="0b306-354">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
...
1. <span data-ttu-id="0b306-365">Optional: Wenn Sie ein kundenspezifisches Etikettendesign einrichten, müssen Sie eine Abfrage erstellen, um das Kundenkonto zu finden.</span><span class="sxs-lookup"><span data-stu-id="0b306-365">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="0b306-366">Im Inforegister **Details zur Wellenetikettenvorlage** wählen Sie **Abfrage bearbeiten** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-366">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="0b306-367">Fügen Sie dann im Abfrage-Editor-Dialogfeld auf der Registerkarte **Bereich** eine Zeile mit den folgenden Einstellungen ein:</span><span class="sxs-lookup"><span data-stu-id="0b306-367">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>
    ...
    <span data-ttu-id="0b306-372">Wenn Sie fertig sind, wählen Sie **OK** aus, um das Dialogfeld des Abfrage-Editors zu schließen.</span><span class="sxs-lookup"><span data-stu-id="0b306-372">When you've finished, select **OK** to close the query editor dialog box.</span></span>
...
1. <span data-ttu-id="0b306-382">Fünf Auftragspositionen hinzufügen:</span><span class="sxs-lookup"><span data-stu-id="0b306-382">Add five sales order lines:</span></span>
    ...
    - <span data-ttu-id="0b306-389">Auftragsposition 3:</span><span class="sxs-lookup"><span data-stu-id="0b306-389">Sales order line 3:</span></span>
...
<span data-ttu-id="0b306-422">Dieses Szenario zeigt den End-to-End-Flow.</span><span class="sxs-lookup"><span data-stu-id="0b306-422">This scenario shows the end-to-end flow.</span></span>
...
1. <span data-ttu-id="0b306-427">Bestätigen Sie, dass **waveLabelPrinting** in der Liste ist.</span><span class="sxs-lookup"><span data-stu-id="0b306-427">Confirm that **waveLabelPrinting** is in the list.</span></span> <span data-ttu-id="0b306-428">Wenn nicht, wählen Sie im Aktionsbereich **Methoden erneut generieren** aus, um es hinzuzufügen.</span><span class="sxs-lookup"><span data-stu-id="0b306-428">If it isn't, select **Regenerate methods** on the Action Pane to add it.</span></span>
1. <span data-ttu-id="0b306-429">Für die Methode **waveLabelPrinting** aktivieren Sie das Kontrollkästchen **Methode wiederholbar machen**.</span><span class="sxs-lookup"><span data-stu-id="0b306-429">For the **waveLabelPrinting** method, select the **Make method repeatable** check box.</span></span>

### <a name="set-up-a-wave-template"></a><span data-ttu-id="0b306-430">Richten Sie eine Wellenvorlage ein</span><span class="sxs-lookup"><span data-stu-id="0b306-430">Set up a wave template</span></span>

1. <span data-ttu-id="0b306-431">Wechseln Sie zu **Lagerortverwaltung \> Einstellungen \> Wellen \> Wellenvorlagen**.</span><span class="sxs-lookup"><span data-stu-id="0b306-431">Go to **Warehouse management \> Setup \> Waves \> Wave templates**.</span></span>
2. <span data-ttu-id="0b306-432">Wählen Sie eine Vorlage aus, wie beispielsweise **62 Lieferungsstandard**.</span><span class="sxs-lookup"><span data-stu-id="0b306-432">Select a template, such as **62 Shipping Default**.</span></span>
3. <span data-ttu-id="0b306-433">Im Inforegister **Methoden** verschieben Sie die Methode **Wellenetikettendruck** zur Spalte **Ausgewählte Methoden**.</span><span class="sxs-lookup"><span data-stu-id="0b306-433">On the **Methods** FastTab, move the **Wave label printing** method to the **Selected methods** column.</span></span>
4. <span data-ttu-id="0b306-434">In der Spalte **Ausgewählte Methoden** weisen Sie einen Wert **Wellenschrittcode**, wie z. B. *Karton*, der Methode **Wellenetikettendruck** zu.</span><span class="sxs-lookup"><span data-stu-id="0b306-434">In the **Selected methods** column, assign a **Wave step code** value, such as *Carton*, to the **Wave label printing** method.</span></span> <span data-ttu-id="0b306-435">Weitere Informationen über Wellenschrittcodes finden Sie unter [Wellenschrittcodes](wave-step-codes.md).</span><span class="sxs-lookup"><span data-stu-id="0b306-435">For more information about wave step codes, see [Wave step codes](wave-step-codes.md).</span></span>
5. <span data-ttu-id="0b306-436">Verschieben Sie die Methode **Wellenetikettendruck** ein zweites Mal zur Spalte **Ausgewählte Methoden**.</span><span class="sxs-lookup"><span data-stu-id="0b306-436">Move the **Wave label printing** method to the **Selected methods** column a second time.</span></span>
6. <span data-ttu-id="0b306-437">In der Spalte **Ausgewählte Methoden** weisen Sie einen anderen **Wellenschrittcode**-Wert, wie z. B. *Palette*, der zweiten **Wellenetikettendruck**-Methode zu.</span><span class="sxs-lookup"><span data-stu-id="0b306-437">In the **Selected methods** column, assign a different **Wave step code** value, such as *Pallet*, to the second **Wave label printing** method.</span></span> <span data-ttu-id="0b306-438">Weitere Informationen über Wellenschrittcodes finden Sie unter [Wellenschrittcodes](wave-step-codes.md).</span><span class="sxs-lookup"><span data-stu-id="0b306-438">For more information about wave step codes, see [Wave step codes](wave-step-codes.md).</span></span>

### <a name="create-three-wave-label-layouts"></a><span data-ttu-id="0b306-439">Drei Wellenetikettenlayouts erstellen</span><span class="sxs-lookup"><span data-stu-id="0b306-439">Create three wave label layouts</span></span>

1. <span data-ttu-id="0b306-440">Wechseln Sie zu **Lagerortverwaltung \> Setup \> Dokumentrouting \> Wellenetikettenlayouts**.</span><span class="sxs-lookup"><span data-stu-id="0b306-440">Go to **Warehouse management \> Setup \> Document routing \> Wave label layouts**.</span></span>
1. <span data-ttu-id="0b306-441">Erstellen Sie einen Datensatz mit den folgenden Einstellungen:</span><span class="sxs-lookup"><span data-stu-id="0b306-441">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="0b306-442">**Etikettenlayout-ID:** *Karton*</span><span class="sxs-lookup"><span data-stu-id="0b306-442">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="0b306-443">**Beschreibung:** *Karton (SSCC)*</span><span class="sxs-lookup"><span data-stu-id="0b306-443">**Description:** *Carton (SSCC)*</span></span>

1. <span data-ttu-id="0b306-444">Wählen Sie im Aktionsbereich **Speichern** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-444">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="0b306-445">Wählen Sie im Aktionsbereich **Einstellungen für Wellenetikettzeile** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-445">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="0b306-446">Die Seite **Einstellungen für Wellenetikettzeile** wird angezeigt.</span><span class="sxs-lookup"><span data-stu-id="0b306-446">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="0b306-447">Hier können Sie den dynamischen Teil des Etiketts konfigurieren.</span><span class="sxs-lookup"><span data-stu-id="0b306-447">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="0b306-448">Fügen Sie eine Zeile mit den folgenden Einstellungen hinzu:</span><span class="sxs-lookup"><span data-stu-id="0b306-448">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="0b306-449">**Zeilen-ID:** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="0b306-449">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="0b306-450">**Zeilentabellenname:** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="0b306-450">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="0b306-451">**Zeilenstartposition:** *0*</span><span class="sxs-lookup"><span data-stu-id="0b306-451">**Row start position:** *0*</span></span>

        <span data-ttu-id="0b306-452">Dieses Feld definiert die vertikale Position, an der die Zeile im Etikett beginnt.</span><span class="sxs-lookup"><span data-stu-id="0b306-452">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="0b306-453">**Zeilenhöhe:** *0*</span><span class="sxs-lookup"><span data-stu-id="0b306-453">**Row height:** *0*</span></span>

        <span data-ttu-id="0b306-454">Dieses Feld definiert die Höhe jeder Zeile (in Punkten) gemäß dem ZPL-Standard.</span><span class="sxs-lookup"><span data-stu-id="0b306-454">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="0b306-455">Die Zeilenhöhe ist positiv für horizontale Etikette und negativ für vertikale Etikette.</span><span class="sxs-lookup"><span data-stu-id="0b306-455">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="0b306-456">Da es in diesem Beispiel nur eine Zeile gibt, können Sie den Wert auf *0* (Null) festlegen.</span><span class="sxs-lookup"><span data-stu-id="0b306-456">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="0b306-457">**Zeilen pro Seite:** *1*</span><span class="sxs-lookup"><span data-stu-id="0b306-457">**Rows per page:** *1*</span></span>

        <span data-ttu-id="0b306-458">Dieses Feld definiert die Anzahl der Zeilen, die auf jedes Etikett gedruckt werden können.</span><span class="sxs-lookup"><span data-stu-id="0b306-458">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="0b306-459">Durch dieses Setup wird für jeden Datensatz in der Wellenetikettentabelle ein separates ZPL-Etikett gedruckt.</span><span class="sxs-lookup"><span data-stu-id="0b306-459">This setup will cause a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="0b306-460">Schließen Sie die Seite.</span><span class="sxs-lookup"><span data-stu-id="0b306-460">Close the page.</span></span>
1. <span data-ttu-id="0b306-461">Wählen Sie im Aktionsbereich **Abfrage bearbeiten** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-461">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="0b306-462">Fügen Sie im Abfrage-Editor-Dialogfeld auf der Registerkarte **Bereich** eine Zeile mit den folgenden Einstellungen ein:</span><span class="sxs-lookup"><span data-stu-id="0b306-462">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="0b306-463">**Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-463">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="0b306-464">**Abgeleitete Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-464">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="0b306-465">**Feld:** *Arbeitstyp*</span><span class="sxs-lookup"><span data-stu-id="0b306-465">**Field:** *Work type*</span></span>
    - <span data-ttu-id="0b306-466">**Kriterien:** *Entnahme*</span><span class="sxs-lookup"><span data-stu-id="0b306-466">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="0b306-467">Diese Abfrage stellt sicher, dass nur Arbeitspositionen vom Entnahmetyp auf dem Etikett gedruckt werden und nicht Arbeitspositionen vom Einlagerungstyp.</span><span class="sxs-lookup"><span data-stu-id="0b306-467">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="0b306-468">Wenn Sie die Frachtbrief-ID ausdrucken möchten, wählen Sie auf der Registerkarte **Verknüpfungen** die Tabelle **Arbeitspositionen** aus, und verknüpften Sie die Tabelle **Lieferungen** damit.</span><span class="sxs-lookup"><span data-stu-id="0b306-468">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span> 
1. <span data-ttu-id="0b306-469">Schließen Sie das Abfrage-Editor-Dialogfeld.</span><span class="sxs-lookup"><span data-stu-id="0b306-469">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="0b306-470">Das Inforegister **Druckertextlayout** besteht aus drei Abschnitten, in denen Sie Druckercode schreiben können: **Kopfzeilenabschnitt**, **Textabschnitt** und **Fußzeilenabschnitt**.</span><span class="sxs-lookup"><span data-stu-id="0b306-470">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="0b306-471">Im Abschnitt **Kopfzeilenabschnitt** im Feld **Etikettenkopfzeile** geben Sie Code für die erforderliche Kopfzeile ein.</span><span class="sxs-lookup"><span data-stu-id="0b306-471">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="0b306-472">Wenn Sie beispielsweise Zebra-Drucker verwenden, können Sie den folgenden Code verwenden.</span><span class="sxs-lookup"><span data-stu-id="0b306-472">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="0b306-473">Im Abschnitt **Textabschnitt** im Feld **Etikettentext** geben Sie ZPL-Code für den erforderlichen Text ein.</span><span class="sxs-lookup"><span data-stu-id="0b306-473">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="0b306-474">Hier ist ein Beispiel.</span><span class="sxs-lookup"><span data-stu-id="0b306-474">Here is an example.</span></span>
...
1. <span data-ttu-id="0b306-475">Im Abschnitt **Textabschnitt** im Feld **Etikettenfußzeile** geben Sie ZPL-Code für die erforderlichen Fußzeile ein.</span><span class="sxs-lookup"><span data-stu-id="0b306-475">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="0b306-476">Hier ist ein Beispiel.</span><span class="sxs-lookup"><span data-stu-id="0b306-476">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="0b306-477">Durch dieses Setup wird eine Kopie jedes Etiketts gedruckt.</span><span class="sxs-lookup"><span data-stu-id="0b306-477">This setup will print one copy of each label.</span></span> <span data-ttu-id="0b306-478">Wenn Sie mehr Kopien benötigen (z. B. eine Kopie für jede Seite der Palette), legen Sie den **n**-Wert für den Abschnitt **\^PQn** in der Fußzeile auf die erforderliche Anzahl von Kopien fest.</span><span class="sxs-lookup"><span data-stu-id="0b306-478">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="0b306-479">Um vier Kopien jedes Etiketts zu drucken, geben Sie beispielsweise **\^PQ4** an.</span><span class="sxs-lookup"><span data-stu-id="0b306-479">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="0b306-480">Das erste Etikett kann jetzt verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="0b306-480">The first label is now ready to use.</span></span>
1. <span data-ttu-id="0b306-481">Erstellen Sie einen zweiten Layoutdatensatz mit den folgenden Einstellungen:</span><span class="sxs-lookup"><span data-stu-id="0b306-481">Create a second layout record that has the following settings:</span></span>

    - <span data-ttu-id="0b306-482">**Etikettenlayout-ID:** *Palette*</span><span class="sxs-lookup"><span data-stu-id="0b306-482">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="0b306-483">**Beschreibung:** *Palette*</span><span class="sxs-lookup"><span data-stu-id="0b306-483">**Description:** *Pallet*</span></span>

1. <span data-ttu-id="0b306-484">Wählen Sie im Aktionsbereich **Speichern** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-484">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="0b306-485">Wählen Sie im Aktionsbereich **Einstellungen für Wellenetikettzeile** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-485">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="0b306-486">Die Seite **Einstellungen für Wellenetikettzeile** wird angezeigt.</span><span class="sxs-lookup"><span data-stu-id="0b306-486">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="0b306-487">Hier können Sie den dynamischen Teil des Etiketts konfigurieren.</span><span class="sxs-lookup"><span data-stu-id="0b306-487">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="0b306-488">Fügen Sie eine Zeile mit den folgenden Einstellungen hinzu:</span><span class="sxs-lookup"><span data-stu-id="0b306-488">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="0b306-489">**Zeilen-ID:** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="0b306-489">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="0b306-490">**Zeilentabellenname:** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="0b306-490">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="0b306-491">**Zeilenstartposition:** *0*</span><span class="sxs-lookup"><span data-stu-id="0b306-491">**Row start position:** *0*</span></span>

        <span data-ttu-id="0b306-492">Dieses Feld definiert die vertikale Position, an der die Zeile im Etikett beginnt.</span><span class="sxs-lookup"><span data-stu-id="0b306-492">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="0b306-493">**Zeilenhöhe:** *0*</span><span class="sxs-lookup"><span data-stu-id="0b306-493">**Row height:** *0*</span></span>

        <span data-ttu-id="0b306-494">Dieses Feld definiert die Höhe jeder Zeile (in Punkten) gemäß dem ZPL-Standard.</span><span class="sxs-lookup"><span data-stu-id="0b306-494">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="0b306-495">Die Zeilenhöhe ist positiv für horizontale Etikette und negativ für vertikale Etikette.</span><span class="sxs-lookup"><span data-stu-id="0b306-495">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="0b306-496">Da es in diesem Beispiel nur eine Zeile gibt, können Sie den Wert auf *0* (Null) festlegen.</span><span class="sxs-lookup"><span data-stu-id="0b306-496">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="0b306-497">**Zeilen pro Seite:** *1*</span><span class="sxs-lookup"><span data-stu-id="0b306-497">**Rows per page:** *1*</span></span>

        <span data-ttu-id="0b306-498">Dieses Feld definiert die Anzahl der Zeilen, die auf jedes Etikett gedruckt werden können.</span><span class="sxs-lookup"><span data-stu-id="0b306-498">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="0b306-499">Durch dieses Setup wird für jeden Datensatz in der Wellenetikettentabelle ein separates ZPL-Etikett gedruckt.</span><span class="sxs-lookup"><span data-stu-id="0b306-499">This setup causes a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="0b306-500">Schließen Sie die Seite.</span><span class="sxs-lookup"><span data-stu-id="0b306-500">Close the page.</span></span>
1. <span data-ttu-id="0b306-501">Wählen Sie im Aktionsbereich **Abfrage bearbeiten** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-501">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="0b306-502">Fügen Sie im Abfrage-Editor-Dialogfeld auf der Registerkarte **Bereich** eine Zeile mit den folgenden Einstellungen ein:</span><span class="sxs-lookup"><span data-stu-id="0b306-502">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="0b306-503">**Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-503">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="0b306-504">**Abgeleitete Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-504">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="0b306-505">**Feld:** *Arbeitstyp*</span><span class="sxs-lookup"><span data-stu-id="0b306-505">**Field:** *Work type*</span></span>
    - <span data-ttu-id="0b306-506">**Kriterien:** *Entnahme*</span><span class="sxs-lookup"><span data-stu-id="0b306-506">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="0b306-507">Diese Abfrage stellt sicher, dass nur Arbeitspositionen vom Entnahmetyp auf dem Etikett gedruckt werden und nicht Arbeitspositionen vom Einlagerungstyp.</span><span class="sxs-lookup"><span data-stu-id="0b306-507">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="0b306-508">Wenn Sie die Frachtbrief-ID ausdrucken möchten, wählen Sie auf der Registerkarte **Verknüpfungen** die Tabelle **Arbeitspositionen** aus, und verknüpften Sie die Tabelle **Lieferungen** damit.</span><span class="sxs-lookup"><span data-stu-id="0b306-508">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span>
1. <span data-ttu-id="0b306-509">Schließen Sie das Abfrage-Editor-Dialogfeld.</span><span class="sxs-lookup"><span data-stu-id="0b306-509">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="0b306-510">Das Inforegister **Druckertextlayout** besteht aus drei Abschnitten, in denen Sie Druckercode schreiben können: **Kopfzeilenabschnitt**, **Textabschnitt** und **Fußzeilenabschnitt**.</span><span class="sxs-lookup"><span data-stu-id="0b306-510">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="0b306-511">Im Abschnitt **Kopfzeilenabschnitt** im Feld **Etikettenkopfzeile** geben Sie Code für die erforderliche Kopfzeile ein.</span><span class="sxs-lookup"><span data-stu-id="0b306-511">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="0b306-512">Wenn Sie beispielsweise Zebra-Drucker verwenden, können Sie den folgenden Code verwenden.</span><span class="sxs-lookup"><span data-stu-id="0b306-512">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="0b306-513">Im Abschnitt **Textabschnitt** im Feld **Etikettentext** geben Sie ZPL-Code für den erforderlichen Text ein.</span><span class="sxs-lookup"><span data-stu-id="0b306-513">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="0b306-514">Hier ist ein Beispiel.</span><span class="sxs-lookup"><span data-stu-id="0b306-514">Here is an example.</span></span>
...
1. <span data-ttu-id="0b306-515">Im Abschnitt **Textabschnitt** im Feld **Etikettenfußzeile** geben Sie ZPL-Code für die erforderlichen Fußzeile ein.</span><span class="sxs-lookup"><span data-stu-id="0b306-515">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="0b306-516">Hier ist ein Beispiel.</span><span class="sxs-lookup"><span data-stu-id="0b306-516">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="0b306-517">Durch dieses Setup wird eine Kopie jedes Etiketts gedruckt.</span><span class="sxs-lookup"><span data-stu-id="0b306-517">This setup will print one copy of each label.</span></span> <span data-ttu-id="0b306-518">Wenn Sie mehr Kopien benötigen (z. B. eine Kopie für jede Seite der Palette), legen Sie den **n**-Wert für den Abschnitt **\^PQn** in der Fußzeile auf die erforderliche Anzahl von Kopien fest.</span><span class="sxs-lookup"><span data-stu-id="0b306-518">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="0b306-519">Um vier Kopien jedes Etiketts zu drucken, geben Sie beispielsweise **\^PQ4** an.</span><span class="sxs-lookup"><span data-stu-id="0b306-519">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="0b306-520">Das zweite Etikett kann jetzt verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="0b306-520">The second label is now ready to use.</span></span>
1. <span data-ttu-id="0b306-521">Erstellen Sie einen dritten Layoutdatensatz mit den folgenden Einstellungen:</span><span class="sxs-lookup"><span data-stu-id="0b306-521">Create a third layout record that has the following settings:</span></span>

    - <span data-ttu-id="0b306-522">**Etikettenlayout-ID:** *Unterbrechung*</span><span class="sxs-lookup"><span data-stu-id="0b306-522">**Label layout ID:** *Break*</span></span>
    - <span data-ttu-id="0b306-523">**Beschreibung:** *Unterbrechungsetikett*</span><span class="sxs-lookup"><span data-stu-id="0b306-523">**Description:** *Break label*</span></span>

1. <span data-ttu-id="0b306-524">Wählen Sie im Aktionsbereich **Speichern** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-524">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="0b306-525">Das Inforegister **Druckertextlayout** besteht aus drei Abschnitten, in denen Sie Druckercode schreiben können: **Kopfzeilenabschnitt**, **Textabschnitt** und **Fußzeilenabschnitt**.</span><span class="sxs-lookup"><span data-stu-id="0b306-525">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="0b306-526">Im Abschnitt **Kopfzeilenabschnitt** im Feld **Etikettenkopfzeile** geben Sie den ZPL-Code für die erforderliche Kopfzeile ein.</span><span class="sxs-lookup"><span data-stu-id="0b306-526">In the **Header section** section, in the **Label header** field, enter ZPL code for the required header.</span></span> <span data-ttu-id="0b306-527">Hier ist ein Beispiel.</span><span class="sxs-lookup"><span data-stu-id="0b306-527">Here is an example.</span></span>
...
1. <span data-ttu-id="0b306-528">Diesmal ist kein Textabschnitt erforderlich.</span><span class="sxs-lookup"><span data-stu-id="0b306-528">This time, no body is required.</span></span> <span data-ttu-id="0b306-529">Geben Sie daher einfach den gewünschten Text in den Abschnitt **Fußzeilenabschnitt** ein.</span><span class="sxs-lookup"><span data-stu-id="0b306-529">Therefore, just enter the required text in the **Footer section** section.</span></span> <span data-ttu-id="0b306-530">Hier ist ein Beispiel.</span><span class="sxs-lookup"><span data-stu-id="0b306-530">Here is an example.</span></span>

    ```plaintext
    ^XZ
    ```

    <span data-ttu-id="0b306-531">Das dritte Etikett kann jetzt verwendet werden.</span><span class="sxs-lookup"><span data-stu-id="0b306-531">The third label is now ready to use.</span></span>

    > [!NOTE]
    > <span data-ttu-id="0b306-532">Dieses dritte Etikett ist ein Unterbrechungsetikett, das als Teiler zwischen Etikettenrollen verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="0b306-532">This third label is a break label that will be used as a divider between label rolls.</span></span>

### <a name="create-two-wave-label-types"></a><span data-ttu-id="0b306-533">Zwei Wellenetikettentypen erstellen</span><span class="sxs-lookup"><span data-stu-id="0b306-533">Create two wave label types</span></span>

1. <span data-ttu-id="0b306-534">Wechseln Sie zu **Lagerortverwaltung \> Setup \> Dokumentrouting \> Wellenetikettentypen**.</span><span class="sxs-lookup"><span data-stu-id="0b306-534">Go to **Warehouse management \> Setup \> Document routing \> Wave label types**.</span></span>
1. <span data-ttu-id="0b306-535">Erstellen Sie einen Datensatz mit den folgenden Einstellungen:</span><span class="sxs-lookup"><span data-stu-id="0b306-535">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="0b306-536">**Etikettentyp:** *Karton*</span><span class="sxs-lookup"><span data-stu-id="0b306-536">**Label type:** *Carton*</span></span>
    - <span data-ttu-id="0b306-537">**Beschreibung:** *Karton*</span><span class="sxs-lookup"><span data-stu-id="0b306-537">**Description:** *Carton*</span></span>

1. <span data-ttu-id="0b306-538">Erstellen Sie einen zweiten Datensatz mit den folgenden Einstellungen:</span><span class="sxs-lookup"><span data-stu-id="0b306-538">Create a second record that has the following settings:</span></span>

    - <span data-ttu-id="0b306-539">**Etikettentyp:** *Palette*</span><span class="sxs-lookup"><span data-stu-id="0b306-539">**Label type:** *Pallet*</span></span>
    - <span data-ttu-id="0b306-540">**Beschreibung:** *Palette*</span><span class="sxs-lookup"><span data-stu-id="0b306-540">**Description:** *Pallet*</span></span>

### <a name="set-up-unit-sequence-groups"></a><span data-ttu-id="0b306-541">Einheitensequenzgruppen einrichten</span><span class="sxs-lookup"><span data-stu-id="0b306-541">Set up unit sequence groups</span></span>

1. <span data-ttu-id="0b306-542">Wechseln Sie zu **Lagerortverwaltung \> Setup \> Lagerort \> Einheitsnummernkreisgruppe**.</span><span class="sxs-lookup"><span data-stu-id="0b306-542">Go to **Warehouse management \> Setup \> Warehouse \> Unit sequence groups**.</span></span>
1. <span data-ttu-id="0b306-543">Wählen oder erstellen Sie eine Gruppe **Ea Box PL** (Einzelstücke Kiste/Palette).</span><span class="sxs-lookup"><span data-stu-id="0b306-543">Select or create an **Ea Box PL** group.</span></span>
1. <span data-ttu-id="0b306-544">Für die Position **Kiste** legen Sie das Feld **Wellenetikettentyp** auf *Karton* fest.</span><span class="sxs-lookup"><span data-stu-id="0b306-544">For the **Box** line, set the **Wave level type** field to *Carton*.</span></span>
1. <span data-ttu-id="0b306-545">Für die Position **PL** (Palette) legen Sie das Feld **Wellenetikettentyp** auf *Palette* fest.</span><span class="sxs-lookup"><span data-stu-id="0b306-545">For the **PL** line, set the **Wave level type** field to *Pallet*.</span></span>

### <a name="create-wave-label-templates"></a><span data-ttu-id="0b306-546">Wellenetikettenvorlagen erstellen</span><span class="sxs-lookup"><span data-stu-id="0b306-546">Create wave label templates</span></span>

1. <span data-ttu-id="0b306-547">Wechseln Sie zu **Lagerortverwaltung \> Setup \> Dokumentrouting \> Wellenetikettenvorlagen**.</span><span class="sxs-lookup"><span data-stu-id="0b306-547">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
1. <span data-ttu-id="0b306-548">Erstellen Sie eine Etikettenvorlage mit den folgenden Einstellungen:</span><span class="sxs-lookup"><span data-stu-id="0b306-548">Create a label template that has the following settings:</span></span>

    - <span data-ttu-id="0b306-549">**Etikettenvorlagenname:** *Kartonetikette*</span><span class="sxs-lookup"><span data-stu-id="0b306-549">**Label template name:** *Carton labels*</span></span>
    - <span data-ttu-id="0b306-550">**Beschreibung:** *Kartonetikette*</span><span class="sxs-lookup"><span data-stu-id="0b306-550">**Description:** *Carton labels*</span></span>
    - <span data-ttu-id="0b306-551">**Wellenschrittcode:** *Karton*</span><span class="sxs-lookup"><span data-stu-id="0b306-551">**Wave step code:** *Carton*</span></span>
    - <span data-ttu-id="0b306-552">**Lagerort:** *62*</span><span class="sxs-lookup"><span data-stu-id="0b306-552">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="0b306-553">Wählen Sie im Inforegister **Allgemein** im Feld **Wellenetikettentyp** einen Wert aus, wie z. B. *Karton*.</span><span class="sxs-lookup"><span data-stu-id="0b306-553">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Carton*.</span></span>
1. <span data-ttu-id="0b306-554">Im Inforegister **Details zur Wellenetikettenvorlage** fügen Sie eine Zeile mit den folgenden Einstellungen hinzu:</span><span class="sxs-lookup"><span data-stu-id="0b306-554">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="0b306-555">**Etikettenlayout-ID:** *Karton*</span><span class="sxs-lookup"><span data-stu-id="0b306-555">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="0b306-556">**Druckername:** Wählen Sie einen geeigneten ZPL-Drucker aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-556">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="0b306-557">**Abfrage ausführen:** *Ja* (Diese Einstellung ist optional, wird jedoch für eine optimale Leistung empfohlen.)</span><span class="sxs-lookup"><span data-stu-id="0b306-557">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="0b306-558">Wählen Sie im Aktionsbereich **Speichern** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-558">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="0b306-559">Optional: Wenn Sie ein kundenspezifisches Etikettendesign einrichten, müssen Sie eine Abfrage erstellen, um das Kundenkonto zu finden.</span><span class="sxs-lookup"><span data-stu-id="0b306-559">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="0b306-560">Im Inforegister **Details zur Wellenetikettenvorlage** wählen Sie **Abfrage bearbeiten** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-560">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="0b306-561">Fügen Sie dann im Abfrage-Editor-Dialogfeld auf der Registerkarte **Bereich** eine Zeile mit den folgenden Einstellungen ein:</span><span class="sxs-lookup"><span data-stu-id="0b306-561">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="0b306-562">**Tabelle:** *Lieferungen*</span><span class="sxs-lookup"><span data-stu-id="0b306-562">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="0b306-563">**Abgeleitete Tabelle:** *Lieferungen*</span><span class="sxs-lookup"><span data-stu-id="0b306-563">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="0b306-564">**Feld:** *Kontonummer*</span><span class="sxs-lookup"><span data-stu-id="0b306-564">**Field:** *Account number*</span></span>
    - <span data-ttu-id="0b306-565">**Kriterien:** Geben Sie die relevante Kundenkontonummer ein.</span><span class="sxs-lookup"><span data-stu-id="0b306-565">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="0b306-566">Wenn Sie fertig sind, wählen Sie **OK** aus, um das Dialogfeld des Abfrage-Editors zu schließen.</span><span class="sxs-lookup"><span data-stu-id="0b306-566">When you've finished, select **OK** to close the query editor dialog box.</span></span>

1. <span data-ttu-id="0b306-567">Wählen Sie im Aktionsbereich **Abfrage bearbeiten** aus, um das Dialogfeld des Abfrage-Editors für die gesamte Etikettenvorlage zu öffnen.</span><span class="sxs-lookup"><span data-stu-id="0b306-567">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="0b306-568">Fügen Sie im Abfrage-Editor-Dialogfeld auf der Registerkarte **Sortieren** eine Zeile mit den folgenden Einstellungen ein:</span><span class="sxs-lookup"><span data-stu-id="0b306-568">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="0b306-569">**Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-569">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="0b306-570">**Abgeleitete Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-570">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="0b306-571">**Feld:** *Referenzladungspositions-ID (Datensatz-ID)*</span><span class="sxs-lookup"><span data-stu-id="0b306-571">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="0b306-572">**Suchrichtigung:** *Aufsteigend*</span><span class="sxs-lookup"><span data-stu-id="0b306-572">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="0b306-573">Fügen Sie eine zweite Zeile mit den folgenden Einstellungen hinzu:</span><span class="sxs-lookup"><span data-stu-id="0b306-573">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="0b306-574">**Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-574">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="0b306-575">**Abgeleitete Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-575">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="0b306-576">**Feld:** *Lieferungs-ID*</span><span class="sxs-lookup"><span data-stu-id="0b306-576">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="0b306-577">**Suchrichtigung:** *Aufsteigend*</span><span class="sxs-lookup"><span data-stu-id="0b306-577">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="0b306-578">Wählen Sie **OK** aus, um das Dialogfeld des Abfrage-Editors zu schließen.</span><span class="sxs-lookup"><span data-stu-id="0b306-578">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="0b306-579">In einem Meldungsfeld werden Sie aufgefordert, den Vorgang zum Zurücksetzen der Gruppierung zu bestätigen.</span><span class="sxs-lookup"><span data-stu-id="0b306-579">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="0b306-580">Wählen Sie **Ja** aus, um fortzufahren.</span><span class="sxs-lookup"><span data-stu-id="0b306-580">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="0b306-581">Wählen Sie im Aktionsbereich **Wellenetikettenvorlagen-Gruppe** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-581">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="0b306-582">Legen Sie im Dialogfeld **Wellenetiketten-Vorlagengruppe** für die Zeile, in der das Feld **Referenzfeldname** auf *Lieferungs-ID* festgelegt ist, die folgenden Werte fest:</span><span class="sxs-lookup"><span data-stu-id="0b306-582">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="0b306-583">**Unterbrechungsetikett drucken:** Aktivieren Sie dieses Kontrollkästchen.</span><span class="sxs-lookup"><span data-stu-id="0b306-583">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="0b306-584">**Etikettenlayout-ID:** Wählen Sie ein Unterbrechungsetikett aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-584">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="0b306-585">(Wählen Sie zum Beispiel das Etikettenlayout *Unterbrechung* aus, dass Sie zuvor in diesem Szenario erstellt haben.)</span><span class="sxs-lookup"><span data-stu-id="0b306-585">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="0b306-586">**Druckername:** Wählen Sie den Drucker für das Unterbrechungsetikett aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-586">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="0b306-587">(Normalerweise sollten Sie zum Teilen von Etikettenrollen denselben Drucker auswählen, der im Inforegister **Details zur Wellenetikettenvorlage** ausgewählt ist.</span><span class="sxs-lookup"><span data-stu-id="0b306-587">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="0b306-588">Es sind jedoch andere Szenarien möglich.)</span><span class="sxs-lookup"><span data-stu-id="0b306-588">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="0b306-589">Für die Zeile, in der das Feld **Referenzfeldname** auf *Referenzladungspositions-ID* festgelegt ist, aktivieren Sie das Kontrollkästchen **Etiketten-Build-ID**.</span><span class="sxs-lookup"><span data-stu-id="0b306-589">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="0b306-590">Dieses Setup erstellt eine Etikettensequenz („Karton 1 von X“) pro Ladeposition während der gesamten Welle, unabhängig vom Setup der Arbeitsgruppierung.</span><span class="sxs-lookup"><span data-stu-id="0b306-590">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="0b306-591">Diese Etikettensequenz kann auf ein Etikettenlayout gedruckt werden.</span><span class="sxs-lookup"><span data-stu-id="0b306-591">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="0b306-592">Außerdem werden Etiketten für verschiedene Lieferungen durch das ausgewählte Unterbrechungsetikett getrennt.</span><span class="sxs-lookup"><span data-stu-id="0b306-592">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

1. <span data-ttu-id="0b306-593">Wählen Sie **OK** aus, um das Dialogfeld **Wellenetiketten-Vorlagengruppe** zu schließen.</span><span class="sxs-lookup"><span data-stu-id="0b306-593">Select **OK** to close the **Wave label template group** dialog box.</span></span>
1. <span data-ttu-id="0b306-594">Erstellen Sie eine zweite Etikettenvorlage mit den folgenden Einstellungen:</span><span class="sxs-lookup"><span data-stu-id="0b306-594">Create a second label template that has the following settings:</span></span>

    - <span data-ttu-id="0b306-595">**Etikettenvorlagenname:** *Palettenetikette*</span><span class="sxs-lookup"><span data-stu-id="0b306-595">**Label template name:** *Pallet labels*</span></span>
    - <span data-ttu-id="0b306-596">**Beschreibung:** *Palettenetikette*</span><span class="sxs-lookup"><span data-stu-id="0b306-596">**Description:** *Pallet labels*</span></span>
    - <span data-ttu-id="0b306-597">**Wellenschrittcode:** *Palette*</span><span class="sxs-lookup"><span data-stu-id="0b306-597">**Wave step code:** *Pallet*</span></span>
    - <span data-ttu-id="0b306-598">**Lagerort:** *62*</span><span class="sxs-lookup"><span data-stu-id="0b306-598">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="0b306-599">Wählen Sie im Inforegister **Allgemein** im Feld **Wellenetikettentyp** einen Wert aus, wie z. B. *Palette*.</span><span class="sxs-lookup"><span data-stu-id="0b306-599">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Pallet*.</span></span>
1. <span data-ttu-id="0b306-600">Im Inforegister **Details zur Wellenetikettenvorlage** fügen Sie eine Zeile mit den folgenden Einstellungen hinzu:</span><span class="sxs-lookup"><span data-stu-id="0b306-600">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="0b306-601">**Etikettenlayout-ID:** *Palette*</span><span class="sxs-lookup"><span data-stu-id="0b306-601">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="0b306-602">**Druckername:** Wählen Sie einen geeigneten ZPL-Drucker aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-602">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="0b306-603">**Abfrage ausführen:** *Ja* (Diese Einstellung ist optional, wird jedoch für eine optimale Leistung empfohlen.)</span><span class="sxs-lookup"><span data-stu-id="0b306-603">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="0b306-604">Wählen Sie im Aktionsbereich **Speichern** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-604">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="0b306-605">Optional: Wenn Sie ein kundenspezifisches Etikettendesign einrichten, müssen Sie eine Abfrage erstellen, um das Kundenkonto zu finden.</span><span class="sxs-lookup"><span data-stu-id="0b306-605">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="0b306-606">Im Inforegister **Details zur Wellenetikettenvorlage** wählen Sie **Abfrage bearbeiten** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-606">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="0b306-607">Fügen Sie dann im Abfrage-Editor-Dialogfeld auf der Registerkarte **Bereich** eine Zeile mit den folgenden Einstellungen ein:</span><span class="sxs-lookup"><span data-stu-id="0b306-607">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="0b306-608">**Tabelle:** *Lieferungen*</span><span class="sxs-lookup"><span data-stu-id="0b306-608">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="0b306-609">**Abgeleitete Tabelle:** *Lieferungen*</span><span class="sxs-lookup"><span data-stu-id="0b306-609">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="0b306-610">**Feld:** *Kontonummer*</span><span class="sxs-lookup"><span data-stu-id="0b306-610">**Field:** *Account number*</span></span>
    - <span data-ttu-id="0b306-611">**Kriterien:** Geben Sie die relevante Kundenkontonummer ein.</span><span class="sxs-lookup"><span data-stu-id="0b306-611">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="0b306-612">Wenn Sie fertig sind, wählen Sie **OK** aus, um das Dialogfeld des Abfrage-Editors zu schließen.</span><span class="sxs-lookup"><span data-stu-id="0b306-612">When you've finished, select **OK** to close the query editor dialog box.</span></span> 

1. <span data-ttu-id="0b306-613">Wählen Sie im Aktionsbereich **Abfrage bearbeiten** aus, um das Dialogfeld des Abfrage-Editors für die gesamte Etikettenvorlage zu öffnen.</span><span class="sxs-lookup"><span data-stu-id="0b306-613">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="0b306-614">Fügen Sie im Abfrage-Editor-Dialogfeld auf der Registerkarte **Sortieren** eine Zeile mit den folgenden Einstellungen ein:</span><span class="sxs-lookup"><span data-stu-id="0b306-614">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="0b306-615">**Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-615">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="0b306-616">**Abgeleitete Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-616">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="0b306-617">**Feld:** *Referenzladungspositions-ID (Datensatz-ID)*</span><span class="sxs-lookup"><span data-stu-id="0b306-617">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="0b306-618">**Suchrichtigung:** *Aufsteigend*</span><span class="sxs-lookup"><span data-stu-id="0b306-618">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="0b306-619">Fügen Sie eine zweite Zeile mit den folgenden Einstellungen hinzu:</span><span class="sxs-lookup"><span data-stu-id="0b306-619">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="0b306-620">**Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-620">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="0b306-621">**Abgeleitete Tabelle:** *Arbeitspositionen*</span><span class="sxs-lookup"><span data-stu-id="0b306-621">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="0b306-622">**Feld:** *Lieferungs-ID*</span><span class="sxs-lookup"><span data-stu-id="0b306-622">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="0b306-623">**Suchrichtigung:** *Aufsteigend*</span><span class="sxs-lookup"><span data-stu-id="0b306-623">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="0b306-624">Wählen Sie **OK** aus, um das Dialogfeld des Abfrage-Editors zu schließen.</span><span class="sxs-lookup"><span data-stu-id="0b306-624">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="0b306-625">In einem Meldungsfeld werden Sie aufgefordert, den Vorgang zum Zurücksetzen der Gruppierung zu bestätigen.</span><span class="sxs-lookup"><span data-stu-id="0b306-625">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="0b306-626">Wählen Sie **Ja** aus, um fortzufahren.</span><span class="sxs-lookup"><span data-stu-id="0b306-626">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="0b306-627">Wählen Sie im Aktionsbereich **Wellenetikettenvorlagen-Gruppe** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-627">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="0b306-628">Legen Sie im Dialogfeld **Wellenetiketten-Vorlagengruppe** für die Zeile, in der das Feld **Referenzfeldname** auf *Lieferungs-ID* festgelegt ist, die folgenden Werte fest:</span><span class="sxs-lookup"><span data-stu-id="0b306-628">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="0b306-629">**Unterbrechungsetikett drucken:** Aktivieren Sie dieses Kontrollkästchen.</span><span class="sxs-lookup"><span data-stu-id="0b306-629">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="0b306-630">**Etikettenlayout-ID:** Wählen Sie ein Unterbrechungsetikett aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-630">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="0b306-631">(Wählen Sie zum Beispiel das Etikettenlayout *Unterbrechung* aus, dass Sie zuvor in diesem Szenario erstellt haben.)</span><span class="sxs-lookup"><span data-stu-id="0b306-631">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="0b306-632">**Druckername:** Wählen Sie den Drucker für das Unterbrechungsetikett aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-632">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="0b306-633">(Normalerweise sollten Sie zum Teilen von Etikettenrollen denselben Drucker auswählen, der im Inforegister **Details zur Wellenetikettenvorlage** ausgewählt ist.</span><span class="sxs-lookup"><span data-stu-id="0b306-633">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="0b306-634">Es sind jedoch andere Szenarien möglich.)</span><span class="sxs-lookup"><span data-stu-id="0b306-634">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="0b306-635">Für die Zeile, in der das Feld **Referenzfeldname** auf *Referenzladungspositions-ID* festgelegt ist, aktivieren Sie das Kontrollkästchen **Etiketten-Build-ID**.</span><span class="sxs-lookup"><span data-stu-id="0b306-635">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="0b306-636">Dieses Setup erstellt eine Etikettensequenz („Karton 1 von X“) pro Ladeposition während der gesamten Welle, unabhängig vom Setup der Arbeitsgruppierung.</span><span class="sxs-lookup"><span data-stu-id="0b306-636">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="0b306-637">Diese Etikettensequenz kann auf ein Etikettenlayout gedruckt werden.</span><span class="sxs-lookup"><span data-stu-id="0b306-637">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="0b306-638">Außerdem werden Etiketten für verschiedene Lieferungen durch das ausgewählte Unterbrechungsetikett getrennt.</span><span class="sxs-lookup"><span data-stu-id="0b306-638">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

### <a name="configure-number-sequence-extensions"></a><span data-ttu-id="0b306-639">Nummernkreiserweiterungen konfigurieren</span><span class="sxs-lookup"><span data-stu-id="0b306-639">Configure number sequence extensions</span></span>

<span data-ttu-id="0b306-640">Nummernkreiserweiterungen steuern die GS1-Konformität bestimmter Nummernkreise.</span><span class="sxs-lookup"><span data-stu-id="0b306-640">Number sequence extensions control the GS1 compliance of specific number sequences.</span></span> <span data-ttu-id="0b306-641">Diese Konfiguration ist für das aktuelle Szenario optional.</span><span class="sxs-lookup"><span data-stu-id="0b306-641">This configuration is optional for the current scenario.</span></span> <span data-ttu-id="0b306-642">Weitere Informationen und Konfigurationsanweisungen finden Sie unter [Nummernkreiserweiterungen konfigurieren](../warehousing/configure-number-sequence-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="0b306-642">For more information and configuration instructions, see [Configure number sequence extensions](../warehousing/configure-number-sequence-extensions.md).</span></span>

### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="0b306-643">Einen Auftrag erstellen und ihn für den Lagerort freigeben</span><span class="sxs-lookup"><span data-stu-id="0b306-643">Create a sales order and release it to the warehouse</span></span>

1. <span data-ttu-id="0b306-644">Gehen Sie zu **Vertrieb und Marketing \> Auftrag \> Alle Aufträge**.</span><span class="sxs-lookup"><span data-stu-id="0b306-644">Go to **Sales and marketing \> Sales order \> All sales orders**.</span></span>
1. <span data-ttu-id="0b306-645">Erstellen Sie einen Auftrag mit den folgenden Einstellungen:</span><span class="sxs-lookup"><span data-stu-id="0b306-645">Create a sales order that has the following settings:</span></span>

    - <span data-ttu-id="0b306-646">**Debitorenkonto:** *US-001*</span><span class="sxs-lookup"><span data-stu-id="0b306-646">**Customer account:** *US-001*</span></span>
    - <span data-ttu-id="0b306-647">**Lagerort:** *62*</span><span class="sxs-lookup"><span data-stu-id="0b306-647">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="0b306-648">Zwei Auftragspositionen hinzufügen:</span><span class="sxs-lookup"><span data-stu-id="0b306-648">Add two sales order lines:</span></span>

    - <span data-ttu-id="0b306-649">Auftragsposition 1:</span><span class="sxs-lookup"><span data-stu-id="0b306-649">Sales order line 1:</span></span>

        - <span data-ttu-id="0b306-650">**Artikelnummer** *A001*</span><span class="sxs-lookup"><span data-stu-id="0b306-650">**Item number:** *A0001*</span></span>
        - <span data-ttu-id="0b306-651">**Menge** *9024*</span><span class="sxs-lookup"><span data-stu-id="0b306-651">**Quantity:** *9024*</span></span>
        - <span data-ttu-id="0b306-652">**Einheit:** *ea* (9024 Einzelstücke = 376 Kisten = 47 Paletten)</span><span class="sxs-lookup"><span data-stu-id="0b306-652">**Unit:** *ea* (9024 ea = 376 Box = 47 PL)</span></span>

    - <span data-ttu-id="0b306-653">Auftragsposition 2:</span><span class="sxs-lookup"><span data-stu-id="0b306-653">Sales order line 2:</span></span>

        - <span data-ttu-id="0b306-654">**Artikelnummer:** *A0002*</span><span class="sxs-lookup"><span data-stu-id="0b306-654">**Item number:** *A0002*</span></span>
        - <span data-ttu-id="0b306-655">**Menge** *9016*</span><span class="sxs-lookup"><span data-stu-id="0b306-655">**Quantity:** *9016*</span></span>
        - <span data-ttu-id="0b306-656">**Einheit:** *ea* (9016 Einzelstücke = 322 Kisten = 46 Paletten)</span><span class="sxs-lookup"><span data-stu-id="0b306-656">**Unit:** *ea* (9016 ea = 322 Box = 46 PL)</span></span>

    > [!NOTE]
    > <span data-ttu-id="0b306-657">Die hier angegebenen Artikel und Mengen sind nur Beispiele.</span><span class="sxs-lookup"><span data-stu-id="0b306-657">The items and quantities that are provided here are only examples.</span></span> <span data-ttu-id="0b306-658">Sie müssen die zuvor definierte Einheitsnummernkreisgruppe verwenden, für sie müssen entsprechende Einheitsumrechnungen von *ea* (Einzelstück) zu *Box* (Kiste) zu *PL* (Palette) definiert sein, und sie müssen Bestand im Lager haben *62*.</span><span class="sxs-lookup"><span data-stu-id="0b306-658">They must use the unit sequence group that you defined earlier, appropriate unit conversions from *ea* to *Box* to *PL* must be defined for them, and they must have stock in warehouse *62*.</span></span> <span data-ttu-id="0b306-659">Weitere Informationen finden Sie unter [Maßeinheit und Lagerhaltungsrichtlinien](unit-measure-stocking-policies.md).</span><span class="sxs-lookup"><span data-stu-id="0b306-659">For more information, see [Unit of measure and stocking policies](unit-measure-stocking-policies.md).</span></span>

1. <span data-ttu-id="0b306-660">Wählen Sie Auftragsposition 1 aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-660">Select sales order line 1.</span></span> <span data-ttu-id="0b306-661">Wählen Sie dann im Abschnitt **Auftragsposition** im Menü **Bestand** die Option **Reservierungen** aus.</span><span class="sxs-lookup"><span data-stu-id="0b306-661">Then, in the **Sales order line** section, on the **Inventory** menu, select **Reservations**.</span></span>
1. <span data-ttu-id="0b306-662">Wählen Sie auf der Seite **Reservierung** im Aktionsbereich die Option **Los reservieren** aus, und schließen Sie dann die Seite.</span><span class="sxs-lookup"><span data-stu-id="0b306-662">On the **Reservation** page, on the Action Pane, select **Reserve lot**, and then close the page.</span></span>
1. <span data-ttu-id="0b306-663">Wiederholen Sie die Schritte 4 und 5 für Auftragsposition 2.</span><span class="sxs-lookup"><span data-stu-id="0b306-663">Repeat steps 4 and 5 for sales order line 2.</span></span>
1. <span data-ttu-id="0b306-664">Klicken Sie im Aktivitätsbereich auf der Registerkarte **Lagerort** auf **Lagerortfreigabe**.</span><span class="sxs-lookup"><span data-stu-id="0b306-664">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse**.</span></span>

    <span data-ttu-id="0b306-665">Folgende Ereignisse treten auf:</span><span class="sxs-lookup"><span data-stu-id="0b306-665">The following events occur:</span></span> 

    - <span data-ttu-id="0b306-666">Das System verarbeitet die erstellte Lieferung mithilfe der Vorlage, die den Etikettendruckschritt enthält.</span><span class="sxs-lookup"><span data-stu-id="0b306-666">The system processes the created shipment by using the template that includes the label printing step.</span></span> <span data-ttu-id="0b306-667">Das Etikettenlayout wird verwendet, um das Format des Etiketts zu definieren. Das Ergebnis ist ein Etikett, das auf dem in der Etikettenvorlage ausgewählten Drucker gedruckt wird.</span><span class="sxs-lookup"><span data-stu-id="0b306-667">The label layout will be used to define the format of the label, and the result will be a label that is printed on the printer that is selected in the label template.</span></span>
    - <span data-ttu-id="0b306-668">Wellenetiketten werden generiert und gedruckt.</span><span class="sxs-lookup"><span data-stu-id="0b306-668">Wave labels are generated and printed.</span></span> <span data-ttu-id="0b306-669">Die Anzahl der Etiketten entspricht der Anzahl der Kartons (in diesem Beispiel 376 Kistenetiketten für Position 1, 322 Kistenetiketten für Position 2, 47 PL-Etiketten für Position 1, 47 PL-Etiketten für Position 2 und zwei Unterbrechungsetiketten mit der Lieferungs-ID).</span><span class="sxs-lookup"><span data-stu-id="0b306-669">The number of labels will equal the number of cartons (in this example, 376 Box labels for line 1, 322 Box labels for line 2, 47 PL labels for line 1, 47 PL labels for line 2, and two break labels that have the shipment ID).</span></span>
    - <span data-ttu-id="0b306-670">Für die Lieferung wird eine neue Frachtbrief-ID generiert.</span><span class="sxs-lookup"><span data-stu-id="0b306-670">A new bill of lading ID is generated for the shipments.</span></span> <span data-ttu-id="0b306-671">Wenn Sie die Nummernkreiserweiterungen konfiguriert haben, folgen die Wellenetikett-IDs dem Zahlenformat **SSCC-18**.</span><span class="sxs-lookup"><span data-stu-id="0b306-671">If you configured the number sequence extensions, the wave label IDs will follow the **SSCC-18** number format.</span></span> 

<span data-ttu-id="0b306-672">Sie können Wellenetiketten von den folgenden Seiten anzeigen und erneut drucken:</span><span class="sxs-lookup"><span data-stu-id="0b306-672">You can view and reprint wave labels from the following pages:</span></span>

- <span data-ttu-id="0b306-673">Alle Lieferungen \> Lieferdetails</span><span class="sxs-lookup"><span data-stu-id="0b306-673">All shipments \> Shipment details</span></span>
- <span data-ttu-id="0b306-674">Alle Ladungen \> Ladungsdetails</span><span class="sxs-lookup"><span data-stu-id="0b306-674">All loads \> Load details</span></span>
- <span data-ttu-id="0b306-675">Alle Wellen</span><span class="sxs-lookup"><span data-stu-id="0b306-675">All waves</span></span>
- <span data-ttu-id="0b306-676">Serienetiketten</span><span class="sxs-lookup"><span data-stu-id="0b306-676">Wave labels</span></span>
- <span data-ttu-id="0b306-677">Wellenbeschriftungsverlauf</span><span class="sxs-lookup"><span data-stu-id="0b306-677">Wave label history</span></span>

<span data-ttu-id="0b306-678">Für die meisten dieser Seiten finden Sie die relevante Funktion durch Auswahl der **Wellenetiketten** in der Gruppe **Zugehörige Informationen** auf der Registerkarte **Lieferungen** des Aktionsbereichs.</span><span class="sxs-lookup"><span data-stu-id="0b306-678">For most of these pages, you can find the relevant function by selecting **Wave labels** in the **Related information** group on the **Shipments** tab of the Action Pane.</span></span>
