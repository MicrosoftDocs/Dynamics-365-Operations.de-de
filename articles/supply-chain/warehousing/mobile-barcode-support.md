...
description: In diesem Artikel wird beschrieben, wie die mobile Lagerort-Scanning-App auf Android-kompatiblen Geräten verwendet wird.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
...
Die Warehouse Management Mobile App wurde mit einer Auswahl von Android-aktivierten Geräten für das Scannen von Strichcodes getestet. Diese Tests decken nur eine Auswahl der Geräte ab, die auf dem Markt verfügbar sind.
