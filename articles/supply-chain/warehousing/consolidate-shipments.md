...
---
# <a name="consolidate-shipments-by-using-shipment-consolidation-policies"></a>Lieferungen mithilfe der Richtlinien zur Lieferungskonsolidierung konsolidieren

[!include [banner](../includes/banner.md)]

Die folgenden Szenarion führen Sie durch einen Lieferungskonsolidierungsprozess, der Lieferungskonsolidierungsrichtlinien bei automatisierter und manueller Freigabe an das Lager verwendet:
