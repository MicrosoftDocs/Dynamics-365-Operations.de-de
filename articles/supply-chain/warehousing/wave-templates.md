---
title: Zyklusvorlagen
description: In diesem Artikel wird beschrieben, wie die Kriterien eingerichtet werden, die bestimmen, ob Wellen manuell oder automatisch verarbeitet werden, und die Arbeit, die für einen Lagerort generiert wird, wenn eine Welle verarbeitet wird.
author: Mirzaab
ms.date: 03/08/2021
ms.topic: article
ms.prod: ''
