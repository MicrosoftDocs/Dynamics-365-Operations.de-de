...
### <a name="set-up-a-wave-template"></a><span data-ttu-id="e5445-123">Richten Sie eine Wellenvorlage ein</span><span class="sxs-lookup"><span data-stu-id="e5445-123">Set up a wave template</span></span>
...
1. <span data-ttu-id="e5445-139">Wählen Sie im Inforegister **Benutzer** **Neu** aus, um ein Konto für mobile Geräte zu erstellen und die folgenden Werte dafür festzulegen:</span><span class="sxs-lookup"><span data-stu-id="e5445-139">On the **Users** FastTab, select **New** to create a mobile device account, and set the following values for it:</span></span>
    ...
    - <span data-ttu-id="e5445-140">**Benutzer-ID:** Geben Sie eine eindeutige ID ein.</span><span class="sxs-lookup"><span data-stu-id="e5445-140">**User ID:** Enter a unique ID.</span></span>
...
### <a name="set-up-warehouse-management-parameters"></a><span data-ttu-id="e5445-157">Parameter für Lagerortverwaltung einrichten</span><span class="sxs-lookup"><span data-stu-id="e5445-157">Set up Warehouse management parameters</span></span>
...
### <a name="set-up-a-location"></a><span data-ttu-id="e5445-173">Lagerplatz einrichten</span><span class="sxs-lookup"><span data-stu-id="e5445-173">Set up a location</span></span>
...
1. <span data-ttu-id="e5445-192">Legen Sie im Inforegister **Allgemein** die folgenden Werte fest:</span><span class="sxs-lookup"><span data-stu-id="e5445-192">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="e5445-202">Fügen Sie im Abfrage-Editor auf der Registerkarte **Sortieren** eine Position mit den folgenden Werten ein:</span><span class="sxs-lookup"><span data-stu-id="e5445-202">In the query editor, on the **Sorting** tab, add a line that has the following values:</span></span>
    ...
    - <span data-ttu-id="e5445-209">**Suchrichtigung:** *Aufsteigend*</span><span class="sxs-lookup"><span data-stu-id="e5445-209">**Search direction:** *Ascending*</span></span>
...
1. <span data-ttu-id="e5445-226">Legen Sie im Inforegister **Übersicht** die folgenden Werte fest:</span><span class="sxs-lookup"><span data-stu-id="e5445-226">On the **Overview** FastTab, set the following values:</span></span>
    ...
    - <span data-ttu-id="e5445-227">**Lagerort:** *62*</span><span class="sxs-lookup"><span data-stu-id="e5445-227">**Warehouse:** *62*</span></span>
...
<span data-ttu-id="e5445-245">Richten Sie eine Arbeitsklasse ein, die zusammen mit dem Sortieren verwendet wird.</span><span class="sxs-lookup"><span data-stu-id="e5445-245">Set up a work class that will be used together with sorting.</span></span>
...
1. <span data-ttu-id="e5445-262">Legen Sie im Inforegister **Allgemein** die folgenden Werte fest:</span><span class="sxs-lookup"><span data-stu-id="e5445-262">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="e5445-279">Legen Sie im Inforegister **Arbeitsklassen** die Option **Neu** aus und stellen Sie dann die folgenden Werte ein:</span><span class="sxs-lookup"><span data-stu-id="e5445-279">On the **Work classes** FastTab, select **New** , and then set the following values:</span></span>
    ...
    - <span data-ttu-id="e5445-280">**Arbeitsklassenkennung:** *SORT*</span><span class="sxs-lookup"><span data-stu-id="e5445-280">**Work class ID:** *SORT*</span></span>
...
#### <a name="set-up-a-single-sku-directive"></a><span data-ttu-id="e5445-296">Einrichten einer Richtlinie für eine einzelne SKU</span><span class="sxs-lookup"><span data-stu-id="e5445-296">Set up a single-SKU directive</span></span>
...
1. <span data-ttu-id="e5445-315">Legen Sie im Inforegister **Lagerplatzrichtlinienaktivitäten** die Option **Neu** aus und stellen Sie dann die folgenden Werte auf die neue Position ein:</span><span class="sxs-lookup"><span data-stu-id="e5445-315">On the **Location Directive Actions** FastTab, select **New** , and then set the following values on the new line.</span></span> <span data-ttu-id="e5445-316">Übernehmen Sie für alle anderen Felder die Standardwerte.</span><span class="sxs-lookup"><span data-stu-id="e5445-316">Accept the default values for all the other fields.</span></span>
    ...
    - <span data-ttu-id="e5445-317">**Sequenz:** *1*</span><span class="sxs-lookup"><span data-stu-id="e5445-317">**Sequence:** *1*</span></span>
...
1. <span data-ttu-id="e5445-336">Wählen Sie **Speichern** aus, um die Symbolleiste im Inforegister **Positionen** verfügbar zu machen.</span><span class="sxs-lookup"><span data-stu-id="e5445-336">Select **Save** to make the toolbar on the **Lines** FastTab available.</span></span>
...
1. <span data-ttu-id="e5445-353">Gehen Sie zu **Lagerortverwaltung \> Einstellungen \> Arbeit \> Arbeitsvorlagen**.</span><span class="sxs-lookup"><span data-stu-id="e5445-353">Go to **Warehouse management \> Setup \> Work \> Work templates**.</span></span>
...
### <a name="create-sales-orders-and-picking-work"></a><span data-ttu-id="e5445-371">Aufträge und Kommissionierarbeit erstellen</span><span class="sxs-lookup"><span data-stu-id="e5445-371">Create sales orders and picking work</span></span>
...
1. <span data-ttu-id="e5445-407">Im Inforegister **Zeilendetails** auf der Registerkarte **Lieferung** legen Sie das Feld **Lieferart** auf *Flowe-STD* fest.</span><span class="sxs-lookup"><span data-stu-id="e5445-407">On the **Line details** FastTab, on the **Delivery** tab, set the **Mode of delivery** field to *Flowe-STD*.</span></span>
...
#### <a name="get-the-work-ids-from-the-work-details"></a><span data-ttu-id="e5445-423">Arbeits-IDs aus den Arbeitsdetails abrufen</span><span class="sxs-lookup"><span data-stu-id="e5445-423">Get the work IDs from the work details</span></span>
...
1. <span data-ttu-id="e5445-440">Prüfen Sie die Informationen auf der Seite **Aufträge – Einlagern**.</span><span class="sxs-lookup"><span data-stu-id="e5445-440">Review the information on the **Sales orders - Put** page.</span></span> <span data-ttu-id="e5445-441">Das Feld **Loc** sollte anzeigen, dass die ausgewählten Artikel an den Ort *Verpackung* gehen.</span><span class="sxs-lookup"><span data-stu-id="e5445-441">The **Loc** field should indicate that the picked items are going to the *Pack* location.</span></span>
...
1. <span data-ttu-id="e5445-476">Geben Sie auf der Seite **Verpackung** im Feld **Kennzeichen oder Lieferung** die Ziel-LP für Auftrag 1 ein.</span><span class="sxs-lookup"><span data-stu-id="e5445-476">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for sales order 1.</span></span> <span data-ttu-id="e5445-477">Drücken Sie dann die Taste **Tab** oder **Eingabe** auf Ihrer Tastatur, um das Feld zu verlassen.</span><span class="sxs-lookup"><span data-stu-id="e5445-477">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="e5445-478">Wählen Sie im Aktivitätsbereich **Neuer Container** aus.</span><span class="sxs-lookup"><span data-stu-id="e5445-478">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="e5445-479">Übernehmen Sie alle Standardeinstellungen und wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-479">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="e5445-480">Notieren Sie die Container-ID.</span><span class="sxs-lookup"><span data-stu-id="e5445-480">Make a note of the container ID.</span></span>
1. <span data-ttu-id="e5445-481">Legen Sie im Inforegister **Artikelverpackung** die folgenden Werte fest:</span><span class="sxs-lookup"><span data-stu-id="e5445-481">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="e5445-482">**Menge** *1*</span><span class="sxs-lookup"><span data-stu-id="e5445-482">**Quantity:** *1*</span></span>
    - <span data-ttu-id="e5445-483">**Bezeichner:** Artikel *A0001*</span><span class="sxs-lookup"><span data-stu-id="e5445-483">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="e5445-484">Wählen Sie im Aktivitätsbereich **Container schließen** aus.</span><span class="sxs-lookup"><span data-stu-id="e5445-484">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="e5445-485">Wählen Sie im Dialogfeld **Container schließen** die Option **Systemgewicht abrufen** , damit das System das Feld **Bruttogewicht** aktualisiert.</span><span class="sxs-lookup"><span data-stu-id="e5445-485">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="e5445-486">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-486">Select **OK**.</span></span> <span data-ttu-id="e5445-487">Der Container wird zum Lagerplatz *SORT* verschoben und ist bereit zum Sortieren.</span><span class="sxs-lookup"><span data-stu-id="e5445-487">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="e5445-488">Erstellen Sie einen zweiten Container, um den zweiten Artikel aus der LP für Auftrag 1 einem neuen Container hinzuzufügen.</span><span class="sxs-lookup"><span data-stu-id="e5445-488">Create a second container to add the second item from the LP for sales order 1 to a new container.</span></span>
1. <span data-ttu-id="e5445-489">Wählen Sie im Aktivitätsbereich **Neuer Container** aus.</span><span class="sxs-lookup"><span data-stu-id="e5445-489">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="e5445-490">Übernehmen Sie alle Standardeinstellungen und wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-490">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="e5445-491">Notieren Sie die Container-ID.</span><span class="sxs-lookup"><span data-stu-id="e5445-491">Make a note of the container ID.</span></span>
1. <span data-ttu-id="e5445-492">Legen Sie im Inforegister **Artikelverpackung** die folgenden Werte fest:</span><span class="sxs-lookup"><span data-stu-id="e5445-492">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="e5445-493">**Menge** *1*</span><span class="sxs-lookup"><span data-stu-id="e5445-493">**Quantity:** *1*</span></span>
    - <span data-ttu-id="e5445-494">**Bezeichner:** Artikel *A0001*</span><span class="sxs-lookup"><span data-stu-id="e5445-494">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="e5445-495">Wählen Sie im Aktivitätsbereich **Container schließen** aus.</span><span class="sxs-lookup"><span data-stu-id="e5445-495">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="e5445-496">Wählen Sie im Dialogfeld **Container schließen** die Option **Systemgewicht abrufen** , damit das System das Feld **Bruttogewicht** aktualisiert.</span><span class="sxs-lookup"><span data-stu-id="e5445-496">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="e5445-497">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-497">Select **OK**.</span></span> <span data-ttu-id="e5445-498">Der Container wird zum Lagerplatz *SORT* verschoben und ist bereit zum Sortieren.</span><span class="sxs-lookup"><span data-stu-id="e5445-498">The container is moved to the *SORT* location and is ready for sorting.</span></span>

#### <a name="pack-sales-order-2-into-containers"></a><span data-ttu-id="e5445-499">Auftrag 2 in Container verpacken</span><span class="sxs-lookup"><span data-stu-id="e5445-499">Pack sales order 2 into containers</span></span>

1. <span data-ttu-id="e5445-500">Geben Sie auf der Seite **Verpackung** im Feld **Kennzeichen oder Lieferung** die Ziel-LP für Position 1 von Auftrag 1 ein.</span><span class="sxs-lookup"><span data-stu-id="e5445-500">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for line 1 of sales order 2.</span></span> <span data-ttu-id="e5445-501">Drücken Sie dann die Taste **Tab** oder **Eingabe** auf Ihrer Tastatur, um das Feld zu verlassen.</span><span class="sxs-lookup"><span data-stu-id="e5445-501">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="e5445-502">Wählen Sie im Aktivitätsbereich **Neuer Container** aus.</span><span class="sxs-lookup"><span data-stu-id="e5445-502">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="e5445-503">Übernehmen Sie alle Standardeinstellungen und wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-503">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="e5445-504">Notieren Sie die Container-ID.</span><span class="sxs-lookup"><span data-stu-id="e5445-504">Make a note of the container ID.</span></span>
1. <span data-ttu-id="e5445-505">Legen Sie im Inforegister **Artikelverpackung** die folgenden Werte fest:</span><span class="sxs-lookup"><span data-stu-id="e5445-505">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="e5445-506">**Menge** *1*</span><span class="sxs-lookup"><span data-stu-id="e5445-506">**Quantity:** *1*</span></span>
    - <span data-ttu-id="e5445-507">**Bezeichner:** Artikel *A0001*</span><span class="sxs-lookup"><span data-stu-id="e5445-507">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="e5445-508">Wählen Sie im Aktivitätsbereich **Container schließen** aus.</span><span class="sxs-lookup"><span data-stu-id="e5445-508">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="e5445-509">Wählen Sie im Dialogfeld **Container schließen** die Option **Systemgewicht abrufen** , damit das System das Feld **Bruttogewicht** aktualisiert.</span><span class="sxs-lookup"><span data-stu-id="e5445-509">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="e5445-510">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-510">Select **OK**.</span></span> <span data-ttu-id="e5445-511">Der Container wird zum Lagerplatz *SORT* verschoben und ist bereit zum Sortieren.</span><span class="sxs-lookup"><span data-stu-id="e5445-511">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="e5445-512">Geben Sie im Feld **Kennzeichen oder Lieferung** die Ziel-LP für Position 2 von Auftrag 2 ein.</span><span class="sxs-lookup"><span data-stu-id="e5445-512">In the **License plate or shipment** field, enter the target LP for line 2 of the sales order 2.</span></span> <span data-ttu-id="e5445-513">Drücken Sie dann die Taste **Tab** oder **Eingabe** auf Ihrer Tastatur, um das Feld zu verlassen.</span><span class="sxs-lookup"><span data-stu-id="e5445-513">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="e5445-514">Wählen Sie im Aktivitätsbereich **Neuer Container** aus.</span><span class="sxs-lookup"><span data-stu-id="e5445-514">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="e5445-515">Übernehmen Sie alle Standardeinstellungen und wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-515">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="e5445-516">Notieren Sie die Container-ID.</span><span class="sxs-lookup"><span data-stu-id="e5445-516">Make a note of the container ID.</span></span>
1. <span data-ttu-id="e5445-517">Legen Sie im Inforegister **Artikelverpackung** die folgenden Werte fest:</span><span class="sxs-lookup"><span data-stu-id="e5445-517">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="e5445-518">**Menge** *1*</span><span class="sxs-lookup"><span data-stu-id="e5445-518">**Quantity:** *1*</span></span>
    - <span data-ttu-id="e5445-519">**Bezeichnerfeld:** Artikel *A0002*</span><span class="sxs-lookup"><span data-stu-id="e5445-519">**Identifier field:** Item *A0002*</span></span>

1. <span data-ttu-id="e5445-520">Wählen Sie im Aktivitätsbereich **Container schließen** aus.</span><span class="sxs-lookup"><span data-stu-id="e5445-520">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="e5445-521">Wählen Sie im Dialogfeld **Container schließen** die Option **Systemgewicht abrufen** , damit das System das Feld **Bruttogewicht** aktualisiert.</span><span class="sxs-lookup"><span data-stu-id="e5445-521">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="e5445-522">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-522">Select **OK**.</span></span> <span data-ttu-id="e5445-523">Der Container wird zum Lagerplatz *SORT* verschoben und ist bereit zum Sortieren.</span><span class="sxs-lookup"><span data-stu-id="e5445-523">The container is moved to the *SORT* location and is ready for sorting.</span></span>

<span data-ttu-id="e5445-524">Um die Containerdetails anzuzeigen, gehen Sie zu **Lagerortverwaltung \> Verpackung und Containerisierung \> Container** und suchen Sie nach den Container-IDs, die beim Packen erstellt wurden.</span><span class="sxs-lookup"><span data-stu-id="e5445-524">To view the container details, go to **Warehouse management \> Packing and containerization \> Containers** , and search for the container IDs that were created during packing.</span></span>

### <a name="sort-the-containers"></a><span data-ttu-id="e5445-525">Container sortieren</span><span class="sxs-lookup"><span data-stu-id="e5445-525">Sort the containers</span></span>

> [!IMPORTANT]
> <span data-ttu-id="e5445-526">Wenn Sie auf der mobilen App auf die Menüoption **Palettenerstellung** für die Ausgangssortierung zugreifen, wird eine Schaltfläche mit der Bezeichnung **Voll** angezeigt.</span><span class="sxs-lookup"><span data-stu-id="e5445-526">When you access the **Pallet build** menu item on the mobile app to do outbound sorting, you will see a button that is labeled **Full**.</span></span> <span data-ttu-id="e5445-527">*Verwenden Sie die Schaltfläche **Voll** nicht zum Sortieren oder Schließen der Position.*</span><span class="sxs-lookup"><span data-stu-id="e5445-527">*Don't use the **Full** button to sort or close the position.*</span></span>
>
> <span data-ttu-id="e5445-528">Die Schaltfläche **Voll** ist standardmäßig verfügbar und kann nicht deaktiviert oder von der Seite entfernt werden.</span><span class="sxs-lookup"><span data-stu-id="e5445-528">The **Full** button is provided by default and can't be disabled or removed from the page.</span></span> <span data-ttu-id="e5445-529">Sie wird nicht für die Funktion *Ausgangssortierung* verwendet.</span><span class="sxs-lookup"><span data-stu-id="e5445-529">It isn't used for the *Outbound sorting* feature.</span></span>

#### <a name="sort-the-first-container"></a><span data-ttu-id="e5445-530">Sortieren des ersten Containers</span><span class="sxs-lookup"><span data-stu-id="e5445-530">Sort the first container</span></span>

1. <span data-ttu-id="e5445-531">Melden Sie sich auf dem mobilen Gerät im Lagerort *62* an, indem Sie die Benutzer-ID verwenden, die Sie für dieses Szenario erstellt haben (oder die Benutzer-ID eines vorhandenen Demodatenbenutzers).</span><span class="sxs-lookup"><span data-stu-id="e5445-531">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="e5445-532">Auf dem Hauptmenü wählen Sie **Ausgehend**.</span><span class="sxs-lookup"><span data-stu-id="e5445-532">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="e5445-533">Auf dem Menü **Ausgehend** wählen Sie **Palettenerstellung**.</span><span class="sxs-lookup"><span data-stu-id="e5445-533">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="e5445-534">Geben Sie im Feld **LP/Con** die erste Container-ID ein, die dem Auftrag 1 zugeordnet ist.</span><span class="sxs-lookup"><span data-stu-id="e5445-534">In the **LP/Con** field, enter the first container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="e5445-535">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-535">Select **OK**.</span></span>
1. <span data-ttu-id="e5445-536">Da derzeit keine Sortierpositionen vorhanden sind, müssen Sie eine angeben.</span><span class="sxs-lookup"><span data-stu-id="e5445-536">Because no sort positions currently exist, you must specify one.</span></span> <span data-ttu-id="e5445-537">Geben Sie im Feld **Sortierposition-ID** *SP01* ein.</span><span class="sxs-lookup"><span data-stu-id="e5445-537">In the **Sort position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="e5445-538">Weil derzeit keine LP mit der Sortierposition *SP01* verknüpft ist, müssen Sie eine angeben.</span><span class="sxs-lookup"><span data-stu-id="e5445-538">Because no LP is currently associated with sort position *SP01* , you must specify one.</span></span> <span data-ttu-id="e5445-539">Im Feld **LP** geben Sie *PLP01* ein.</span><span class="sxs-lookup"><span data-stu-id="e5445-539">In the **LP** field, enter *PLP01*.</span></span>
1. <span data-ttu-id="e5445-540">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-540">Select **OK**.</span></span>
1. <span data-ttu-id="e5445-541">Da die Überprüfung der Sortierposition aktiviert ist, müssen Sie die ID der Sortierposition erneut eingeben.</span><span class="sxs-lookup"><span data-stu-id="e5445-541">Because sort position validation is turned on, you must enter the sort position ID again.</span></span> <span data-ttu-id="e5445-542">Geben Sie im Feld **Sortierposition-ID** *SP01* ein.</span><span class="sxs-lookup"><span data-stu-id="e5445-542">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="e5445-543">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-543">Select **OK**.</span></span>

    <span data-ttu-id="e5445-544">Sie erhalten die Nachricht „Arbeit abgeschlossen“.</span><span class="sxs-lookup"><span data-stu-id="e5445-544">You receive a "Work completed" message.</span></span>

> [!TIP]
> <span data-ttu-id="e5445-545">Um die Sortierposition und die darin enthaltene LP anzuzeigen, gehen Sie zu **Lagerortverwaltung \> Verpackung und Containerisierung \> Zuweisungen von Ausgangssortierpositionen**.</span><span class="sxs-lookup"><span data-stu-id="e5445-545">To view the sort position and the LP in it, go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
>
> <span data-ttu-id="e5445-546">Die Seite **Zuweisungen von Ausgangssortierpositionen** zeigt alle aktuell aktiven Sortierpositionen an.</span><span class="sxs-lookup"><span data-stu-id="e5445-546">The **Outbound sorting position assignments** page shows all the sort positions that are currently active.</span></span> <span data-ttu-id="e5445-547">Das Feld **Sortierpositionstransaktionen** zeigt die LP, die jeder Sortierposition zugeordnet ist, und die Container, die sich an der Sortierposition befinden.</span><span class="sxs-lookup"><span data-stu-id="e5445-547">The **Sort position transactions** field shows the LP that is associated with each sort position, and the containers that are in the sort position.</span></span> <span data-ttu-id="e5445-548">Beachten Sie, dass derzeit eine Sortierposition vorhanden ist und dass das Inforegister **Sortierpositionskriterien** ein Kriterium von **Lieferung – Spedition – Luft**.</span><span class="sxs-lookup"><span data-stu-id="e5445-548">Notice that one sort position currently exists, and that the **Sort position criteria** FastTab shows a criterion of **Shipment – Carrier service - Air**.</span></span>

#### <a name="sort-the-remaining-containers"></a><span data-ttu-id="e5445-549">Übrige Container sortieren</span><span class="sxs-lookup"><span data-stu-id="e5445-549">Sort the remaining containers</span></span>

1. <span data-ttu-id="e5445-550">Melden Sie sich auf dem mobilen Gerät im Lagerort *62* an, indem Sie die Benutzer-ID verwenden, die Sie für dieses Szenario erstellt haben (oder die Benutzer-ID eines vorhandenen Demodatenbenutzers).</span><span class="sxs-lookup"><span data-stu-id="e5445-550">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="e5445-551">Auf dem Hauptmenü wählen Sie **Ausgehend**.</span><span class="sxs-lookup"><span data-stu-id="e5445-551">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="e5445-552">Auf dem Menü **Ausgehend** wählen Sie **Palettenerstellung**.</span><span class="sxs-lookup"><span data-stu-id="e5445-552">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="e5445-553">Geben Sie im Feld **LP/Con** die zweite Container-ID ein, die dem Auftrag 1 zugeordnet ist.</span><span class="sxs-lookup"><span data-stu-id="e5445-553">In the **LP/Con** field, enter the second container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="e5445-554">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-554">Select **OK**.</span></span> <span data-ttu-id="e5445-555">Da die Sortiervorlage so eingerichtet ist, dass sie automatisch sortiert wird und bereits eine Sortierposition mit übereinstimmenden Kriterien vorhanden ist, werden Sie automatisch zur richtigen Sortierposition weitergeleitet.</span><span class="sxs-lookup"><span data-stu-id="e5445-555">Because the sorting template is set up to sort automatically, and a sort position that has matching criteria already exists, you're automatically directed to the correct sort position.</span></span>
1. <span data-ttu-id="e5445-556">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-556">Select **OK**.</span></span>
1. <span data-ttu-id="e5445-557">Bestätigen Sie die ID der Sortierposition, um anzuzeigen, dass sich der Bestand an der richtigen Stelle befindet.</span><span class="sxs-lookup"><span data-stu-id="e5445-557">Confirm the sort position ID to indicate that the inventory is in the correct place.</span></span> <span data-ttu-id="e5445-558">Geben Sie im Feld **Sortierposition-ID** *SP01* ein.</span><span class="sxs-lookup"><span data-stu-id="e5445-558">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="e5445-559">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-559">Select **OK**.</span></span>

    <span data-ttu-id="e5445-560">Die Arbeiten am zweiten Container aus Auftrag 1 sind abgeschlossen.</span><span class="sxs-lookup"><span data-stu-id="e5445-560">Work is completed on the second container from sales order 1.</span></span> <span data-ttu-id="e5445-561">Sie sortieren nun die verbleibenden Container aus Auftrag 2.</span><span class="sxs-lookup"><span data-stu-id="e5445-561">You will now sort the remaining containers from sales order 2.</span></span>

1. <span data-ttu-id="e5445-562">Geben Sie im Feld **LP/Con** die Container-ID des Containers aus Auftrag 2 ein, der den Artikel *A0001* enthält.</span><span class="sxs-lookup"><span data-stu-id="e5445-562">In the **LP/Con** field, enter the container ID of the container from sales order 2 that holds item *A0001*.</span></span> <span data-ttu-id="e5445-563">Da sich die Spedition unterscheidet, werden Sie aufgefordert, eine neue Sortierposition einzugeben und dieser Position eine LP zuzuweisen.</span><span class="sxs-lookup"><span data-stu-id="e5445-563">Because the carrier service differs, you're prompted to enter a new sort position and assign an LP to that position.</span></span> <span data-ttu-id="e5445-564">Verwenden Sie Sortierposition *SP02* und LP *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="e5445-564">Use sort position *SP02* and LP *PLP02*.</span></span>
1. <span data-ttu-id="e5445-565">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-565">Select **OK**.</span></span>
1. <span data-ttu-id="e5445-566">Bestätigen Sie die Sortierposition durch Eingabe von *SP02* im Feld **Sortierposition-ID**.</span><span class="sxs-lookup"><span data-stu-id="e5445-566">Confirm the sort position by entering *SP02* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="e5445-567">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-567">Select **OK**.</span></span>

    <span data-ttu-id="e5445-568">Die Arbeiten am Container sind abgeschlossen.</span><span class="sxs-lookup"><span data-stu-id="e5445-568">Work is completed on the container.</span></span>

1. <span data-ttu-id="e5445-569">Geben Sie im Feld **LP/Con** die Container-ID für die übrigen Container aus Auftrag 2 ein, der den Artikel *A0002* enthält.</span><span class="sxs-lookup"><span data-stu-id="e5445-569">In the **LP/Con** field, enter the container ID for the remaining container from sales order 2 that holds item *A0002*.</span></span> <span data-ttu-id="e5445-570">Da der Spediteurservice mit dem Spediteurservice für Auftrag 1 identisch ist, zeigt das System die vorhandene Sortierposition mit Übereinstimmungskriterien an.</span><span class="sxs-lookup"><span data-stu-id="e5445-570">Because the carrier service is the same as the carrier service for sales order 1, the system shows the existing sort position that has matching criteria.</span></span>
1. <span data-ttu-id="e5445-571">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-571">Select **OK**.</span></span>
1. <span data-ttu-id="e5445-572">Bestätigen Sie die Sortierposition durch Eingabe von *SP01* im Feld **Sortierposition-ID**.</span><span class="sxs-lookup"><span data-stu-id="e5445-572">Confirm the sort position by entering *SP01* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="e5445-573">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-573">Select **OK**.</span></span>

    <span data-ttu-id="e5445-574">Die Arbeiten am Container sind abgeschlossen.</span><span class="sxs-lookup"><span data-stu-id="e5445-574">Work is completed on the container.</span></span>

### <a name="close-the-outbound-sorting-positions"></a><span data-ttu-id="e5445-575">Schließen Sie die ausgehenden Sortierpositionen</span><span class="sxs-lookup"><span data-stu-id="e5445-575">Close the outbound sorting positions</span></span>

<span data-ttu-id="e5445-576">Wenn der gesamte Bestand sortiert wurde, muss die Position geschlossen werden, bevor Arbeiten erstellt werden können.</span><span class="sxs-lookup"><span data-stu-id="e5445-576">When all inventory has been sorted, the position must be closed before work can be created.</span></span> <span data-ttu-id="e5445-577">Es werden sortierte Bestandsentnahmen erstellt, um den Bestand zur Frachttür zu bringen.</span><span class="sxs-lookup"><span data-stu-id="e5445-577">Sorted inventory picking work will be created to take the inventory to the bay door.</span></span>

#### <a name="close-a-position-from-the-mobile-device"></a><span data-ttu-id="e5445-578">Eine Position vom Mobilgerät aus schließen</span><span class="sxs-lookup"><span data-stu-id="e5445-578">Close a position from the mobile device</span></span>

1. <span data-ttu-id="e5445-579">Melden Sie sich auf dem mobilen Gerät im Lagerort *62* an, indem Sie die Benutzer-ID verwenden, die Sie für dieses Szenario erstellt haben (oder die Benutzer-ID eines vorhandenen Demodatenbenutzers).</span><span class="sxs-lookup"><span data-stu-id="e5445-579">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="e5445-580">Auf dem Hauptmenü wählen Sie **Ausgehend**.</span><span class="sxs-lookup"><span data-stu-id="e5445-580">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="e5445-581">Auf dem Menü **Ausgehend** wählen Sie **Palettenerstellung**.</span><span class="sxs-lookup"><span data-stu-id="e5445-581">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="e5445-582">Geben Sie im Feld **LP/Con** eine Container-ID ein, die nach Sortierposition *SP01* sortiert wurde.</span><span class="sxs-lookup"><span data-stu-id="e5445-582">In the **LP/Con** field, enter a container ID that was sorted to sort position *SP01*.</span></span>
1. <span data-ttu-id="e5445-583">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-583">Select **OK**.</span></span>
1. <span data-ttu-id="e5445-584">Sie erhalten folgende Meldung: „Der Container ist bereits auf Position SP01 sortiert.</span><span class="sxs-lookup"><span data-stu-id="e5445-584">You receive the following message: "The container is already sorted to position SP01.</span></span> <span data-ttu-id="e5445-585">Diese Position schließen?“</span><span class="sxs-lookup"><span data-stu-id="e5445-585">Close the position?"</span></span> <span data-ttu-id="e5445-586">Wählen Sie **Schließen** aus.</span><span class="sxs-lookup"><span data-stu-id="e5445-586">Select **Close**.</span></span>

    <span data-ttu-id="e5445-587">Die Arbeit ist abgeschlossen.</span><span class="sxs-lookup"><span data-stu-id="e5445-587">Work is completed.</span></span>

#### <a name="close-a-position-from-outbound-sorting-position-assignments"></a><span data-ttu-id="e5445-588">Eine Position aus ausgehenden Sortierpositionszuweisungen schließen</span><span class="sxs-lookup"><span data-stu-id="e5445-588">Close a position from outbound sorting position assignments</span></span>

1. <span data-ttu-id="e5445-589">Gehen Sie zu **Lagerortverwaltung \> Verpackung und Containerisierung \> Zuweisungen von Ausgangssortierpositionen**.</span><span class="sxs-lookup"><span data-stu-id="e5445-589">Go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
1. <span data-ttu-id="e5445-590">Wählen Sie in der linken Spalte **SP02**.</span><span class="sxs-lookup"><span data-stu-id="e5445-590">In the left column, select **SP02**.</span></span> <span data-ttu-id="e5445-591">Diese Zeile für die ausgehende Sortierposition wird geschlossen.</span><span class="sxs-lookup"><span data-stu-id="e5445-591">This outbound sorting position row is the one that you will close.</span></span>
1. <span data-ttu-id="e5445-592">Wählen Sie im Aktivitätsbereich **Position schließen** aus.</span><span class="sxs-lookup"><span data-stu-id="e5445-592">On the Action Pane, select **Close position**.</span></span> <span data-ttu-id="e5445-593">Der Sortierpositionsdatensatz ist geschlossen und wird nicht mehr angezeigt.</span><span class="sxs-lookup"><span data-stu-id="e5445-593">The sorting position record is closed and is no longer shown.</span></span>

    > [!TIP]
    > <span data-ttu-id="e5445-594">Um alle geschlossenen Positionsdatensätze anzuzeigen, wählen Sie das Kontrollkästchen **Geschlossene anzeigen**.</span><span class="sxs-lookup"><span data-stu-id="e5445-594">To show all closed position records, select the **Show closed** check box.</span></span>

### <a name="sorted-inventory-picking"></a><span data-ttu-id="e5445-595">Sortierte Bestandsentnahme</span><span class="sxs-lookup"><span data-stu-id="e5445-595">Sorted inventory picking</span></span>

<span data-ttu-id="e5445-596">Sie müssen die sortierte Bestandsauswahl durchführen.</span><span class="sxs-lookup"><span data-stu-id="e5445-596">You must complete the sorted inventory picking work.</span></span> <span data-ttu-id="e5445-597">Wenn es fertig ist, wird der Bestand in den Kundenauftrag aufgenommen.</span><span class="sxs-lookup"><span data-stu-id="e5445-597">When it's completed, the inventory will be picked to the sales order.</span></span> <span data-ttu-id="e5445-598">Zu diesem Zeitpunkt gelten alle anderen Lagerprozesse.</span><span class="sxs-lookup"><span data-stu-id="e5445-598">At that point, all other warehouse processes apply.</span></span>

1. <span data-ttu-id="e5445-599">Melden Sie sich auf dem mobilen Gerät im Lagerort *62* an, indem Sie die Benutzer-ID verwenden, die Sie für dieses Szenario erstellt haben (oder die Benutzer-ID eines vorhandenen Demodatenbenutzers).</span><span class="sxs-lookup"><span data-stu-id="e5445-599">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="e5445-600">Auf dem Hauptmenü wählen Sie **Ausgehend**.</span><span class="sxs-lookup"><span data-stu-id="e5445-600">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="e5445-601">Wählen Sie im Menü **Ausgehend** **Aus Sortierung laden**.</span><span class="sxs-lookup"><span data-stu-id="e5445-601">On the **Outbound** menu, select **Load from Sorting**.</span></span>
1. <span data-ttu-id="e5445-602">Geben Sie die Ziel-LP-ID von der ersten Sortierposition *SP01* aus ein.</span><span class="sxs-lookup"><span data-stu-id="e5445-602">Enter the target LP ID from the first sort position, *SP01*.</span></span> <span data-ttu-id="e5445-603">Legen Sie das Feld **ID** auf *PLP01* fest.</span><span class="sxs-lookup"><span data-stu-id="e5445-603">Set the **ID** field to *PLP01*.</span></span>
1. <span data-ttu-id="e5445-604">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-604">Select **OK**.</span></span>
1. <span data-ttu-id="e5445-605">Die Seite **Sortierte Bestandentnahme: Entnehmen** zeigt die Entnahmearbeit, die ausgeführt werden müssen.</span><span class="sxs-lookup"><span data-stu-id="e5445-605">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="e5445-606">Wählen Sie aus dem Lagerplatz *SORT* und Ziel-LP *PLP01* , die mehrere Artikel und eine Menge von *3* hat.</span><span class="sxs-lookup"><span data-stu-id="e5445-606">Pick from the *SORT* location and target LP *PLP01* , which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="e5445-607">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-607">Select **OK**.</span></span>
1. <span data-ttu-id="e5445-608">Die Seite **Sortierte Bestandentnahme: Einlagern** zeigt die Einlagerunsarbeit, die ausgeführt werden müssen.</span><span class="sxs-lookup"><span data-stu-id="e5445-608">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="e5445-609">Lagern Sie im Lagerplatz *Frachttür* und Ziel-LP *PLP01* , die mehrere Artikel und eine Menge von *3* hat.</span><span class="sxs-lookup"><span data-stu-id="e5445-609">Put to the *Baydoor* location and target LP *PLP01* , which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="e5445-610">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-610">Select **OK**.</span></span>

    <span data-ttu-id="e5445-611">Die Arbeit ist abgeschlossen.</span><span class="sxs-lookup"><span data-stu-id="e5445-611">Work is completed.</span></span>

1. <span data-ttu-id="e5445-612">Geben Sie das Zielkennzeichen von der zweiten Sortierposition *SP02* aus ein.</span><span class="sxs-lookup"><span data-stu-id="e5445-612">Enter the target license plate ID from the second sort position, *SP02*.</span></span> <span data-ttu-id="e5445-613">Legen Sie das Feld **ID** auf *PLP02* fest.</span><span class="sxs-lookup"><span data-stu-id="e5445-613">Set the **ID** field to *PLP02*.</span></span>
1. <span data-ttu-id="e5445-614">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-614">Select **OK**.</span></span>
1. <span data-ttu-id="e5445-615">Die Seite **Sortierte Bestandentnahme: Entnehmen** zeigt die Entnahmearbeit, die ausgeführt werden müssen.</span><span class="sxs-lookup"><span data-stu-id="e5445-615">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="e5445-616">Wählen Sie aus dem Lagerplatz *SORT* und Ziel-LP *PLP02* , die mehrere Artikel und eine Menge von *1* hat.</span><span class="sxs-lookup"><span data-stu-id="e5445-616">Pick from the *SORT* location and target LP *PLP02* , which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="e5445-617">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-617">Select **OK**.</span></span>
1. <span data-ttu-id="e5445-618">Die Seite **Sortierte Bestandentnahme: Einlagern** zeigt die Einlagerunsarbeit, die ausgeführt werden müssen.</span><span class="sxs-lookup"><span data-stu-id="e5445-618">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="e5445-619">Lagern Sie im Lagerplatz *Frachttür* und Ziel-LP *PLP02* , die mehrere Artikel und eine Menge von *1* hat.</span><span class="sxs-lookup"><span data-stu-id="e5445-619">Put to the *Baydoor* location and target LP *PLP02* , which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="e5445-620">Wählen Sie **OK**.</span><span class="sxs-lookup"><span data-stu-id="e5445-620">Select **OK**.</span></span>

    <span data-ttu-id="e5445-621">Die Arbeit ist abgeschlossen.</span><span class="sxs-lookup"><span data-stu-id="e5445-621">Work is completed.</span></span>

<span data-ttu-id="e5445-622">Ab diesem Zeitpunkt gelten alle anderen Lagerprozesse.</span><span class="sxs-lookup"><span data-stu-id="e5445-622">From this point forward, all other warehouse processes apply.</span></span>
