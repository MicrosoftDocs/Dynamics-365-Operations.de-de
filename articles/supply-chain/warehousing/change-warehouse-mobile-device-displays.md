...
ms.locfileid: "859758"
---
# <a name="warehouse-mobile-device-display-settings"></a>Anzeigeeinstellungen für mobile Geräte für das Lager

[!include [banner](../includes/banner.md)]

> [!NOTE]
> Diese Funktion ist veraltet. Weitere Informationen finden Sie unter [Entfernte oder veraltete Funktionen](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).
