...
Informationen zum Erstellen und Bereitstellen funktionsfähiger Tarifmodule, die in einer Produktions- oder Testumgebung verwendet werden können, finden Sie in den folgenden Artikeln:
...
Dieses Beispielszenario zeigt, wie Sie die Kleinpaketlieferung einrichten und verwenden, nachdem Sie Ihr System wie zuvor in diesem Artikel beschrieben vorbereitet haben. In diesem Szenario wird das zuvor erwähnte Demotarifmodul verwendet.
...
1. Wenn Sie noch keine ZPL-Druckerdefinition eingerichtet haben, richten Sie sie mit der Anwendung Document Routing Agent ein. Weitere Informationen finden Sie unter [Übersicht zum Dokumentendruck](../../fin-ops-core/dev-itpro/analytics/print-documents.md) und verwandten Artikeln.
