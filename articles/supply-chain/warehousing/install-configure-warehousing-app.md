---
title: Einrichten und Konfigurieren von Microsoft Dynamics 365 for Finance and Operations &#8211; – Lagerorte
...
ms.locfileid: "1559185"
---
# <a name="install-and-configure-microsoft-dynamics-365-for-finance-and-operations-8211-warehousing"></a>Einrichten und Konfigurieren von Microsoft Dynamics 365 for Finance and Operations &#8211; – Lagerorte
...
In diesem Thema wird erläutert, wie Microsoft Dynamics 365 for Finance and Operations – Lagerorte eingerichtet und konfiguriert werden.
...
> [!NOTE]
> Die Zebra AppGallery wurde zurückgezogen, was bedeutet, dass die Finance and Operations – Lagerorte-App an diesem Speicherort nicht mehr zum Download verfügbar ist.
...
Um der App die Interaktion mit einem bestimmten Finance and Operations-Server zu ermöglichen, müssen Sie eine Webdienstanwendung in einem Azure Active Directory für den Finance and Operations-Mandanten erfassen. Aus Sicherheitsgründen wird empfohlen, dass Sie eine Webdienstanwendung für jedes Gerät erstellt werden, das Sie verwenden. Um eine Webdienstbewerbung in Azure Active Directory (Azure AD) zu erstellen, führen Sie die folgenden Schritte aus:
...
Um Finance and Operations für Ihre Azure AD-Anwendung zu aktivieren, müssen folgende Konfigurationsschritte abgeschlossen werden:

1.  Erstellen Sie einen Finance and Operations-Benutzer der den Warehousing-App-Benutzeranmeldeinformationen entspricht.
...
2.  Ordnen Sie die Azure Active Directory-Anwendung dem Lagerorte-App-Benutzer zu.
    1.  In Finance and Operations wechseln Sie zu **Systemverwaltung** &gt; **Einstellungen** &gt; **Azure Active Directory-Anwendungen**.
...
Sie müssen die App auf dem Gerät so konfigurieren, dass eine Verbindung zum Finance and Operations-Server über die Azure AD-Anwendung hergestellt wird. Führen Sie dazu die folgenden Schritte aus.
...
3.  Geben Sie die folgenden Informationen ein: 
    ...
    + **Azure Active Directory-Mandant** – Der Azure AD-Mandant, der mit dem Finance and Operations-Server verwendet wird: `https://login.windows.net/your-AD-tenant-ID`. Beispiel: `https://login.windows.net/contosooperations.onmicrosoft.com.` 
...
Informationen zum Einrichten von Dynamics 365 for Finance and Operations – Lagerorte zum Scannen von Strichcodes mithilfe einer Kamera auf einem mobilen Gerät finden Sie unter [Strichcodes mithilfe einer Kamera in Dynamics 365 for Finance and Operations – Lagerorte scannen](scan-bar-codes-using-a-camera.md)
