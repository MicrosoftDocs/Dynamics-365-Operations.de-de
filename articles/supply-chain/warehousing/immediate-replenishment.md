...
description: In diesem Artikel wird beschrieben, wie Sie die sofortige Wiederbeschaffung verwenden können, um den Lagerbestand wieder zu ergänzen, wenn eine Lagerplatzdirektive keinen Bestand zuordnen kann.
author: Mirzaab
ms.date: 03/15/2017
ms.topic: article
ms.prod: ''
