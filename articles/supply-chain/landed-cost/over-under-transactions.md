...
description: Dieser Artikel enthält Informationen, die Ihnen dabei helfen, die Details der Richtlinien für Über-/Unter-Transaktionen festzulegen, damit das System bestimmen kann, wie die Über- und Unterbearbeitung von Waren zum Zeitpunkt des Eingangs gehandhabt werden soll.
author: Weijiesa
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
