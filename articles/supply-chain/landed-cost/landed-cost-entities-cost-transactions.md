---
title: Kostenbuchungsentitäten
description: Dieses Thema enthält Informationen zu Kostenbuchungsentitäten, die es ermöglichen, den Wert von Kosten durch die Auswahl einer Aufteilungsmethode auf die Inhalte eines Kostenbereichs aufzuteilen.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
