...
Die Inforegister-Registerkarte **Versandcontainer** in der Ansicht **Zeilen** zeigt Informationen über die Palette an. Die meisten dieser Informationen erscheinen auch in der Ansicht **Kopfzeile**, wie weiter oben in diesem Artikel beschrieben.
