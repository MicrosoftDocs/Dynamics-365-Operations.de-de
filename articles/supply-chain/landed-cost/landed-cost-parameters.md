...
description: In diesem Artikel wird beschrieben, wie Sie allgemeine Informationen und Konfigurationseinstellungen festlegen, die im gesamten Modul für kalkulierte Transportkosten für Buchungen, Statusaktualisierungen, Sequenzen und Verhalten verwendet werden.
author: Weijiesa
ms.date: 12/07/2020
ms.topic: article
ms.prod: ''
