...
4.  Geben Sie im Feld **Beschreibung** einen kurzen Begriff ein, um die Verwendung dieser Gruppe zu erklären.
...
3.  Geben Sie im Feld **Ursachencode für Rückgabe** einen beschreibenden Text für den Code ein.

4.  Geben Sie im Feld **Beschreibung** einen beschreibenden Text für den Rückgabeursachencode ein.

5.  Fügen Sie diesen Code mithilfe der Dropdown-Liste **Ursachencodegruppe für Rückgabe** einer Ursachencodegruppe für die Rückgabe hinzu.

## <a name="see-also"></a>Siehe auch

[Formular "Ursachencodegruppen für Rückgaben"](https://technet.microsoft.com/library/hh209604\(v=ax.60\))

[Ursachencodes für Rückgaben (Formular)](https://technet.microsoft.com/library/hh227372\(v=ax.60\))
