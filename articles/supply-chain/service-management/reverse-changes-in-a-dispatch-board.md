...
2.  Geben Sie im Formular **Einsatzplanung** die relevanten Informationen in die Felder ein, und klicken Sie dann auf **OK**. 

3.  Um die letzte Änderung, die nicht gespeichert wurde, zurückzusetzen, klicken Sie auf **Rückgängig**.

4.  Klicken Sie zum Rückgängigmachen mehrerer noch nicht gespeicherter Änderungen weiter auf **Rückgängig**, bis alle zu ignorierenden Änderungen rückgängig gemacht wurden.
