...
- Abruf der Online-Retail-Transaktionsdaten in der Zentrale.
- Synchronisieren von Aufträgen, um Kundenaufträge in der Zentrale anzulegen.

Das Abrufen der Online-Retail-Transaktionsdaten kann entweder durch manuelles Ausführen des P-Jobs oder durch Erstellen eines wiederkehrenden Batch-Jobs erfolgen.

### <a name="manually-running-the-p-job"></a>Manuelles Ausführen des P-Jobs

1. Gehen Sie zu Alle Arbeitsbereiche > Retail IT.
