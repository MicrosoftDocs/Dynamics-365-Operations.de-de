...
> [!NOTE]
> Wenn die IIS-Hardwarestation "dediziert" ist, gibt es eine Eins-zu-Eins-Beziehung zwischen dem POS-Client und der Hardwarestation.
...
3. Erstellen Sie eine Hardwarestation vom Typ **Dediziert** für den Shop, in dem die Register verwendet wird. Die Beschreibung ist optional.
...
- Nur Transport Layer Security (TLS)- Version 1.2 (oder die höchste aktuelle Version) sollte aktiviert und verwendet werden.
    ...
    > [!NOTE]
    > Standardmäßig ist SSL und alle TLS-Version außer der Version 1.2 TLS deaktiviert.

    Um diese Werte zu bearbeiten oder zu aktivieren, gehen Sie folgendermaßen vor:
