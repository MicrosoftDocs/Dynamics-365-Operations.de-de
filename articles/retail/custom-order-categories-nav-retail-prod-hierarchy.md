...
Einzelhändler erachten die Produkterfassung als ein primäres Tool für Debitoreninteraktionen über alle Einzelhandelskanäle hinweg. Verschiedene Funktionen können Debitoren helfen, Produkte einfacher zu ermitteln. So können sie Kategorien, Suchen und Filter durchsuchen.
...
## <a name="configure-the-display-order-for-categories-in-the-retail-product-hierarchy"></a>Konfigurieren der Anzeigereihenfolge für Kategorien in der Produkthierarchie (Einzelhandel)

Bevor Sie dieses Verfahren ausführen können, müssen Demodaten in Ihrer Umgebung installiert werden.

1. Gehen Sie zu **Einzelhandel \> Produkte und Kategorien \> Produkthierarchie (Einzelhandel)**.
...
Der Anzeigereihenfolge für die Kanalnavigationshierarchie wird in HQ für die Produkthierarchie (Einzelhandel) und freigegebene Produkte nach Kategorie angezeigt.
...
1. Gehen Sie zu **Einzelhandel \> Produkte und Kategorien \> Kanalnavigationskategorien**.
...
Der Anzeigereihenfolge für die Kanalnavigationshierarchie wird in HQ, im Katalog und in Einzelhandelskanälen angezeigt.
