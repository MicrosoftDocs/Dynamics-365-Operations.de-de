...
Gehen Sie zu **Retail**\> **Kataloge und Sortimente** \> **Alle Kataloge**, um Ihren Katalog zu konfigurieren.

Wenn Sie einen neuen Katalog anlegen, müssen Sie diesen zunächst mit einem oder mehreren Retail Channels verknüpfen. Dies geschieht im **Retail channels** Inforegister auf dem **Katalogeinrichtung**-Formular. Klicken Sie auf **Hinzufügen** und wählen Sie einen oder mehrere Retail Channels aus. Nur Artikel, die mit dem ausgewählten Kanal [Sortimente](https://docs.microsoft.com/dynamics365/unified-operations/retail/assortments) verknüpft sind, können bei der Erstellung des Katalogs verwendet werden.

Um Produkte in einen Katalog aufzunehmen, muss eine Navigationshierarchie gewählt werden. Die Navigationshierarchie unterstützt die Kategoriestruktur für den Katalog. Sie müssen aus einer der Navigationshierarchien wählen, die mit den ausgewählten Retail Channels auf dem **Retail Channels** Inforegister der Seite **Katalog** verknüpft sind. Wenn ein Navigationskanal vorher nicht mit einem Kanal verknüpft war, gehen Sie zu **Retail** \>**Kanaleinrichtung**\>**Kanalkategorien und Produktattribute**, um eine Navigationshierarchievorgabe mit jedem Ihrer Einzelhandelskanäle zu verknüpfen.
