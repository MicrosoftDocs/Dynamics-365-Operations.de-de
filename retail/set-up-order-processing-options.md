...
description: "Dieses Thema enthält Informationen dazu, wie Aufträge für Callcenter mithilfe von Microsoft Dynamics 365 für Einzelhandel - Arbeitsgänge verarbeitet."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Dieses Thema enthält Informationen dazu, wie Aufträge für Callcenter mithilfe von Microsoft Dynamics 365 für Einzelhandel - Arbeitsgänge verarbeitet. 

Einzelhandel und Handel in Dynamics 365 für Arbeitsgänge unterstützt mehrere Einzelhandelskanäle, wie, physische Filiale und Onlineshops Callcenter. In Callcentern nehmen Arbeitskräfte Aufträge von Kunden per Telefon entgegen und erstellen Aufträge. In diesem Thema wird beschrieben, wie ein Callcenter erstellt wird und Callcenteroptionen konfiguriert werden. Jedes Callcenter kann eigene Benutzer, Zahlungsmethoden, Preisgruppen, Finanzdimensionen und Lieferarten haben. Sie können diese Optionen konfigurieren, wenn Sie das Callcenter erstellen. **Wichtig:** Bevor die Callcenterworkflows verwendet werden können, wenn der aktuelle Dynamics AX-Benutzer Aufträge erstellt, muss der Benutzer dem Callcenter als Callcenterbenutzer zugewiesen werden. Darüber hinaus können Sie die Seite **Callcenter** verwenden, um Gruppen von Funktionen zu aktivieren oder zu deaktivieren, die für Callcenter eindeutig sind. Die folgenden Gruppen von Funktionen können aktiviert werden:
