...
In diesem Thema wird erläutert ein Konzept, das Werbeoffiziere verwenden können, um die Schritte im Personalbeschaffungsprozess, einschließlich Aufwände nachzuverfolgen, offene Stellen anzukündigen und Bewerber die Mitarbeiter, Bewerber und Anwendungsinformations-, Interviewenbewerber nachverfolgen, und eine oder mehrere Arbeitsblattdateien Kandidaten auswählen, um die offenen Stellen in der Organisation ein.

<a name="overview"></a>Überblick
--------

Personalbeschaffungsprojekte können helfen, die Schritte zu organisieren, die Sie abschließen, wenn Sie offene Positionen in einer juristischen Person besetzen. Ein Bewerber ist eine Person, die für eine Anstellung auf Ihr Unternehmen gilt.  Eine Bewerbung ist der Seite auf die Teilnahme eines Bewerbers gebunden werden, der in einem Unternehmen verwendet werden und ist mit einem Personalbeschaffungsprojekt, Zinsen in einer bestimmten Anzahl auszudrücken.  Einzelner Bewerber verfügt mehrere Bewerbungen in derselben juristischen Person oder für mehrere Unternehmen in der Organisation.

<a name="recruitment-projects"></a>Personalbeschaffungsprojekte
--------------------

Personalbeschaffungsprojekte können Werbeoffiziere zur Nachverfolgung fortschritt für das Ausfüllen einer oder mehreren offenen Stellen.  Das Personalbeschaffungsprojekt identifiziert die Abteilung und die Stelle, für welches oder mehr Positionen geprüft wird geöffnet. Personalbeschaffungsprojekte verfolgen auch die folgenden Informationen für offene Positionen nach:
...
Die Korrespondenzaktivität einer **Bewerbung** bestimmt das Dokument oder die E-Mail-Vorlage, die Sie verwenden, um mit dem Bewerber zu kommunizieren, der die Bewerbung eingereicht hat. ** Können Sie Lesezeichen ** mit Korrespondenzaktivitäten zuordnen, Sie zu den Verwendungswerten von den - Anwendungen, Gesprächs- Bewerber-, und Personalbeschaffungsprojektseiten in Ihrer Kommunikation mit Bewerbern zu ermöglichen.  ** Bewerbungs-E-Mails ** können erstellt werden, sodass die Korrespondenzaktivitäten schnell E-Mails an Bewerber gesendet, die eine Anwendung mit einem bestimmten Status und Korrespondenzaktivitätskombination haben. Beispielsweise senden kann eine Bestätigungs-E-Mail allen Bewerbungen mit einem Status ** ** von Received und A ** Korrespondenzaktivität ** von Received.  Nachdem Sie die E-Mail gesendet wurde, besitzen Sie die Möglichkeit, den Status der Bewerbungen automatisch zu aktualisieren.
...
** Bewerbergespräche ** kann geplant werden ** Bewerbungen ** Seite.  Verwenden Sie die Besprechungsinformationen ** Übermitteln ** Schaltfläche, um eine Kalenderdatei mit den Gesprächszeitplaninformationen dem Bewerber und zur Befragungsperson zu senden.
...
Verwenden Sie die Seite **Bewerbungen**, um einen Bewerber einzustellen. Wird ein Bewerber eingestellt, erhält der Bewerbungsdatensatz den Status **Eingestellt**, und der Personendatensatz des globalen Adressbuchs des Bewerbers wird dem neuen Arbeitskraftdatensatz zugeordnet. Die Änderungen an den Informationen des globalen Adressbuchs für den neuen Arbeitskraftdatensatz werden auch im Bewerberdatensatz angezeigt. Dies kann dazu beitragen, Menge zu reduzieren, wenn die neue Arbeitskraft sich um einen vorhanden anderen Stelle im Unternehmen bewirbt.  Um eine vorhandene Arbeitskraft in eine neue Position einstellen, klicken Sie in Änderungsposition ** ** ** Bewerbungsstatus ** ablegen unten um den Übergangsprozess zu initiieren.
