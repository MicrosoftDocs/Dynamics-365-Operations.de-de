# [Human resources home pageTESTING IN DE-DE](index.md)
# Develop Human resources strategyTESTING IN DE-DE
## [Organize your workforce using departments, jobs, and positionsTESTING IN DE-DE](departments-jobs-positions.md)
## [Set up job componentTESTING IN DE-DEs](create-job.md)
## [Create a department and associate it with the department hierarchyTESTING IN DE-DE](create-department-add-department-hierarchy.md)
## [Set up company-specific HR parameters](set-up-company-specific-hr-parameters.md)
## [Set up HR parameters across legal entities](set-up-hr-parameters-across-legal-entities.md)
## [Use workflow to manage employee information](workflow-manage-employee-information.md)
# Recruit, hire, and motivate employees TESTING IN DE-DE
## [Manage a recruiting processTESTING IN DE-DE](manage-recruiting-process.md)
...
# Develop and train employeesTESTING IN DE-DE
## [Performance management overviewTESTING IN DE-DE](performance-management-overview.md)
## [Align workforce skills with business needs](skills.md)
## [Set up training courses](courses.md)
# Create and maintain benefitsTESTING IN DE-DE
## [Manage a benefits programTESTING IN DE-DE](manage-benefit-program.md)
## [Benefit eligibility policies](benefit-eligibility-policies.md)
## [Manage items lent to workers](loan-items.md)
# Gather information using questionnairesTESTING IN DE-DE
## [QuestionnairesTESTING IN DE-DE](questionnaires.md)
## [Design a questionnaire](design-questionnaires.md)
## [Distribute and complete a questionnaire](distribute-questionnaires.md)
## [Evaluate the results of a questionnaire](evaluate-questionnaire-results.md)
# United States featuresTESTING IN DE-DE
## Workplace safety and complianceTESTING IN DE-DE
### [Form I-9 employment verificationTESTING IN DE-DE](localizations/noam-usa-form-i-9-verification.md)
### [Comply with the ADA](localizations/noam-usa-comply-ada.md)
## [PayrollTESTING IN DE-DE](localizations/noam-usa-payroll.md)
### Payroll setupTESTING IN DE-DE
...
### Frequencies and cyclesTESTING IN DE-DE
...
### Codes and taxesTESTING IN DE-DE
...
### Garnishments, tax levies, and premium payTESTING IN DE-DE
...
#### [Set up premium earningsTESTING IN DE-DE ](localizations/noam-usa-premium-earning-setup-tasks.md)
#### [Garnishments, tax levies, and administrative fees FAQ](localizations/noam-usa-garnishment-tax-levy-administrative-fees.md)
### Payroll processing tasksTESTING IN DE-DE
#### [Generate earningsTESTING IN DE-DE](localizations/noam-usa-earnings-generation-process.md)
#### [Issue worker paymentsTESTING IN DE-DE](localizations/noam-usa-issue-worker-payments.md)
...
### Complete the payment processTESTING IN DE-DE
#### [Process existing payroll paymentsTESTING IN DE-DE](localizations/noam-usa-existing-payroll-payments.md)
...
### Maintenance and reportingTESTING IN DE-DE
