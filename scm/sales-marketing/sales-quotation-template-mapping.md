...
- Produkte
- Konten (sofern verwendet)
- Kontakte (sofern verwendet)
...
- Bevor Sie Verkaufsangebote in Sales synchronisieren, wechseln Sie zu **Einstellungen** &gt; **Verwaltung** &gt; **Systemeinstellungen** &gt; **Vertrieb**, und stellen Sie sicher, dass das Feld **Rabattberechnungsmethode** auf **Pro Einheit** festgelegt ist. Diese Einstellung stellt sicher, dass der Positionsartikelrabatt von Sales mit der Einstellung in Finance and Operations übereinstimmt. Andernfalls ist der Rabatt in Finance and Operations nicht korrekt, da Finance and Operations den Rabatt als Rabatt pro Einheit liest, selbst wenn es ein Rabatt pro Position in Sales war.
- In Finance and Operations wechseln Sie zu **Debitoren** &gt; **Einstellungen** &gt; **Debitorenparameter**. Auf der Registerkarte **Nummernkreis** wählen Sie den Nummernkreis für Verkaufsangebote aus, und klicken Sie dann auf **Details anzeigen**. Legen Sie dann unter **Allgemeine Einstellungen** das Feld **Manuell** auf **Ja** fest.
- In Finance and Operations wechseln Sie zu **Debitoren** &gt; **Einstellungen** &gt; **Debitorenparameter**. Legen Sie anschließend auf der Registerkarte **Lieferungen** das Feld **Lieferdatumskontrolle** auf **Keine** fest. Diese Einstellung trägt dazu bei zu verhindern, dass die Synchronisierung für Verkaufsangebote fehlschlägt.
