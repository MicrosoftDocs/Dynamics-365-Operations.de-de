...
15. Klicken Sie auf die Registerkarte "Bestätigung".
    * Nachdem Sie einen Direktlieferungsauftrag erstellt haben, wird er automatisch auf die Registerkarte "Bestätigung" verschoben. Sie können den Auftrag direkt von dieser Seite aus bestätigen. Wenn der Einkauf bestätigt ist, wird er automatisch auf die Registerkarte "Lieferung" verschoben, von der aus Sie seinen Zugang erfassen können.  
