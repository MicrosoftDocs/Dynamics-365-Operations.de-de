...
Das System kalkuliert diesen laufenden Durchschnittseinstandspreis für einen Artikel mithilfe der folgenden Formel: Vorkalkulierter Preis = (physischer Betrag + wertmäßiger Betrag) ÷ (physikalische Größe + wertmäßige Menge)
...
\* Zähler = (physischer Betrag + wertmäßiger Betrag) \*\* Nenner = (Physische Menge + wertmäßige Menge) **Hinweis:** Wenn die Option **Physischen Wert** einbeziehen nicht für einen Artikel aktiviert ist, verwendet das System sowohl für den physischen Betrag als auch die physische Menge 0 (null). Informationen zu dieser Option, finden Sie unter [Physischen Wert einbeziehen](include-physical-value.md).
