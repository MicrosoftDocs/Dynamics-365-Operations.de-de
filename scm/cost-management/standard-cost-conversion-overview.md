...
## <a name="2-review-and-change-the-new-costing-version-for-the-conversion-record"></a>2. Prüfen und ändern Sie die neue Nachkalkulationsversion für den Umrechnungsdatensatz
...
## <a name="3-identify-the-items-to-convert-to-standard-cost"></a>3. Bestimmen der Artikel, die in Standardkosten umgerechnet
...
## <a name="4-enter-or-calculate-the-pending-standard-cost-for-each-item-that-is-being-converted"></a>4. Eingeben oder Berechnen der ausstehenden Standardkosten für jeden Artikel, der konvertiert wird
...
## <a name="5-check-and-resolve-any-issues-for-the-items-that-are-being-converted"></a>5. Prüfen und beheben Sie Probleme für die Artikel, die umgerechnet werden
...
## <a name="6-change-the-status-of-the-conversion-record-to-ready"></a>6. Ändern des Status des Umrechnungsdatensatzes in, erstellen
...
## <a name="7-back-up-the-database-before-conversion"></a>7. Sichern Sie die Datenbank vor der Umrechnung
Die Datensicherung ermöglicht das Wiederherstellen der Datenbank, wenn während der Umrechnung Fehler auftreten.

## <a name="8-perform-the-conversion-when-the-conversion-record-has-a-ready-status"></a>8. Ausführen der Umrechnung, wenn der Umrechnungsdatensatz den READY-Status hat
...
## <a name="9-validate-and-reconcile-the-inventory-values-for-the-converted-items"></a>9. Prüfen und Abstimmen der Lagerwerte für die umgerechneten Artikel ab
