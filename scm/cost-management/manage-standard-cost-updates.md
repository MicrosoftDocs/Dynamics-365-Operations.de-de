---
title: Verwalten Sie zur Aktualisierung
description: "Die Aktualisierung von Standardkostendaten können verwaltet werden, indem zwei unterschiedliche Herangehensweisen - und der durch den Zwei-Versionen-Ansatz."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="manage-standard-cost-updates"></a>Verwalten Sie zur Aktualisierung

Die Aktualisierung von Standardkostendaten können verwaltet werden, indem zwei unterschiedliche Herangehensweisen - und der durch den Zwei-Versionen-Ansatz. 
...
-   **Einzelversionsansatz für die Aktualisierung von Kostendaten** − Beim Einzelversionsansatz enthält die ursprüngliche Nachkalkulationsversion "2016-STD" sämtliche Kostendatensätze. Kostenaktualisierungen werden im Jahre 2016 "2012-STD" erfasst und auf gesetzt den Status "Ausstehend "." Die ausstehenden Kosten können manuell für neue eingekaufte Artikel eingegeben werden, oder sie können berechnet werden, für einen produzierten Artikel wider. Beim Einzelversionsansatz wird, ist für die Herstellkostenkalkulation keine Fallback-Datenquelle benötigt, da in der Nachkalkulationsversion alle aktiven Kosten enthalten sind. Nach Aktivierung der ausstehenden Kosten enthält die ursprüngliche Nachkalkulationsversion "2016-STD" auch wieder alle derzeit aktiven Kosten.
...
In diesem Beispiel wurde eine zusätzliche Nachkalkulationsversion für Aktualisierungen im Laufe des Jahres 2016 verwendet verwalten. Es können auch mehrere zusätzliche Nachkalkulationsversionen verwendet werden, beispielsweise getrennte Versionen für jede einzelne Änderung. Falls mehrere zusätzliche Nachkalkulationen verwendet werden, muss das Fallback als aktive Kosten ausgedrückt werden, da sie sich über mehrere Nachkalkulationsversionen erstrecken würden.
