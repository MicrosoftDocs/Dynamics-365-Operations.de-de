...
[Einrichtung eines Menüeintrags für mobile Geräte, um Bestellungen bearbeiten zu können (Aufgabenleitfaden) ](/dynamics365/unified-operations/supply-chain/warehousing/tasks/set-up-mobile-device-menu)

[Einrichtung eines Menüeintrags für mobile Geräte, um eingegangene Waren zu registrieren (Aufgabenleitfaden)](/dynamics365/unified-operations/supply-chain/warehousing/tasks/set-up-mobile-device-menu-item-register-received-items)
