---
title: "Produktionsprozessüberblick"
description: "Dieser Artikel enthält eine Übersicht der Produktionsprozesse bilden. Er beschreibt die verschiedenen Produktionsstufeaufträge, Chargenaufträgen und Kanbans, von der Auftragserstellung zum Schließen der Geschäftsperioden."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="production-process-overview"></a>Produktionsprozessüberblick

Dieser Artikel enthält eine Übersicht der Produktionsprozesse bilden. Er beschreibt die verschiedenen Produktionsstufeaufträge, Chargenaufträgen und Kanbans, von der Auftragserstellung zum Schließen der Geschäftsperioden. 
...
** Produktionssteuerung ** Das Modul ist in neben anderen Modulen, z ** Produktinformationsverwaltung **, Lagerverwaltung ** **, ** Hauptbuch ** **, Lagerortverwaltung **, ** Projektverrechnung **, verknüpft und ** Organisationsverwaltung **. Diese Integration ermöglicht die reibungslose Weiterleitung von Informationen, die zum Fertigstellen der Artikelfertigung erforderlich sind.  

Der Produktionsprozess wird in der Regel von den Kostenrechnungs- und Lagerbewertungsmethoden beeinflusst, die für einen bestimmten Produktionsprozess ausgewählt werden. Dynamics 365 für Arbeitsgänge werden die Istkosten (First expired, First out \[FIFO\]; Lagerbewertung nach der LIFO-Methode (Last in, First out \[LIFO\]; Durchschnitt flexibler; und regelmäßiger gewichteter Durchschnitt) und Standardkostenmethoden. Lean Manufacturing wird auf der Grundlage des Prinzips der Nachkalkulation für Produktionskosten implementiert.  
...
Verschiedene Produkte und Produktionstopologien erfordern die Anwendung von unterschiedlichen Auftragstypen. Dynamics 365 für Arbeitsgänge können unterschiedliche Auftragstypen einem in gemischten Modus übernehmen. In anderen Worten können alle anderen Auftragstypen während des Ende-zu-Ende-Prozesses der Herstellung eines fertigen Produkts auftreten.
...
5.  ** Vorbereitetes **/** entnommen ** – wenn alle Materialien und Ressourcen am Produktionslagerplatz bereitgestellt wurden, die oder Produktionsstücklistenpositionen die Kanban Positionen werden zu aktualisiert ** ** entnommen. Aufträge mit Lieferung mit Bedarfsverursachung und zugehörige Lagerortarbeit werden normalerweise in dieser Phase abgeschlossen. Die Kanban-Karten oder Einzelvorgangslisten, die erforderlich sind, um den Produktionsfortschritt zu melden, sollten zugewiesen und gedruckt werden.
