...
Die Fertigungssteuerung ist zur Verwendung primär durch Fertigungsunternehmen bestimmt. Arbeitskräfte können die Zeit und den Artikelverbrauch für Produktions-Einzelvorgänge erfassen, indem sie die Seite **Einzelvorgangserfassung** verwenden. Alle Erfassungen werden genehmigt und werden später auf den entsprechenden Modulen übertragen. Die kontinuierliche Genehmigung und Übertragung von Erfassungen ermöglicht Managern die einfache Nachverfolgung der tatsächlichen Kosten von Produktionsaufträgen.
...
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Fertigungssteuerung       | Eine Funktion, die verwendet wird, mit der Sie Zeit, Materialverbrauch, Kosten für Produktions-Einzelvorgänge, Projekte und indirekte Projektvorgänge registrieren. Die Erfassung wird mithilfe eines Clients für die Erfassung der Fertigungssteuerung durchgeführt.                                                                                                                                                                                                                                                                                                                                                                                                   |
...
-   ** Registerprojektgebühren und -Projektelemente ** (verfügbar unter "Zeit und Anwesenheit " - Arbeitskräfte können Gebühren (Ausgaben) erfassen ein Projekt in einer Projektgebührenerfassung, beispielsweise Kilometerleistung und Brückenmaut zugeordnet werden. Arbeitskräfte können auch den Artikelverbrauch für Projekte erfassen. Dies wird in einer Projektartikelerfassung durchgeführt.
