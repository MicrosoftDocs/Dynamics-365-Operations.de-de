...
![Qualitätsmanagementprozess( [] . /media/quality-management-process-diagram.png)]". /media/quality-management-process-diagram.png)  
...
Qualitätsmängel werden mit einem Problemtyp zugeordnet. Problemtypen werden auf der Seite **Problemtypen** definiert, in der Sie angeben, welche Problemtypen mit jedem Nichtübereinstimmungstyp zugeordnet werden können. Beispielsweise beinhalteten möglicherweise die Problemtypen für Qualitätsmängel des ** Serviceanforderung ** Typs eine Klassifizierung von Debitorenbeschwerden, wohingegen die Problemtypen möglicherweise für Qualitätsmängel des ** Intern ** Typs eine Klassifizierung von Fehlercodes Codes darstellt. 
