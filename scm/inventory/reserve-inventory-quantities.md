...
| Artikelverkaufsreservierung  | Bestimmt, ob die Artikelreservierung manuell oder automatisch erfolgt. Wenn eine Reservierung automatisch erfolgt, wird der Bestand reserviert, wenn Auftragspositionen erstellt werden. Es ist möglich, Reservierungen auf der Artikelnummerenebene für Stücklisten **Automatisch** oder für die einzelnen Elemente einer Stückliste**Auflösung** zu machen. Der Standardwert für Artikelvertriebsreservierung ** ** ** kann von den Debitorparametern übernommen werden. ** Auf dieser Seite wird der Wert im Feld im Vertriebsstandardwerte ** ** ** Bereich festgelegt ** ** Allgemein ** auf der Registerkarte. |
