# [Overview of Lifecycle ServicesTESTING DE-DE CHECK WHATS DISPLAYED WITH AX 2012 topic](lcs.md)
## [LCS for customersTESTING DE-DE](lcs-works-lcs.md)
## [LCS for partnersTESTING DE-DE](getting-started-lcs.md)
## [What's newTESTING DE-DE](whats-new-lcs.md)
## [Known issuesTESTING DE-DE](known-issues.md)
# [Configure securityTESTING DE-DE](configure-lcs-security.md)
# [Issue searchTESTING DE-DE](issue-search-lcs.md)

# [Configuration managerTESTING DE-DE](configuration-manager-lcs.md)
## [Set up Configuration managerTESTING DE-DE ](set-up-configuration-manager-lcs.md)

# [Configure the code upgrade serviceTESTING DE-DE](configure-execute-code-upgrade.md)
# [Create a methodology TESTING DE-DE](create-methodology.md)
# [Business process modeler flowcharts](flowcharts-business-process-modeler.md)
# [Upload custom business processesTESTING DE-DE](upload-business-processes-bpm-task-recorder.md)

# [Monitoring and diagnostics TESTING DE-DE](monitoring-diagnostics.md)

# Dynamics AX 2012TESTING DE-DE
## DeploymentTESTING DE-DE
### [Cloud-hosted environments (AX 2012)TESTING DE-DE](ax-2012/cloud-hosted-environments-lcs.md)
### [Copy a configurationTESTING DE-DE](copy-configuration-lcs.md)
...
## [Data import/export framework user guideTESTING DE-DE](ax-2012/user-guide-dixf.md)
### [InstallTESTING DE-DE](ax-2012/install-dixf.md)
...
## Tables TESTING DE-DE
### [Create tablesTESTING DE-DE](ax-2012/create-tables.md)
### [Table properties](ax-2012/table-properties.md)
## Dynamics AX 2012 LCS toolsTESTING DE-DE
### [ProjectsTESTING DE-DE](ax-2012/projects-lcs.md)
### [MethodologiesTESTING DE-DE](ax-2012/methodologies-lcs.md)
### [Customization analysisTESTING DE-DE ](ax-2012/customization-analysis-lcs.md)
...
## Dynamics AX 2012 downloadable toolsTESTING DE-DE
### [Code Upgrade Tool User Guide (deprecated)TESTING DE-DE](ax-2012/code-upgrade-tool-user-guide.md)
...
### [Security Development ToolTESTING DE-DE](ax-2012/overview-security-development-tool-user-interface.md)
...
### [Performance Benchmark Software Development ToolkitTESTING DE-DE](ax-2012/performance-benchmark-software-development-toolkit-sdk-2012.md)
### [Security Upgrade Advisor ToolTESTING DE-DE](ax-2012/security-upgrade-advisor-tool-user-guide.md)
### [Intelligent Data Management Framework (IDMF)TESTING DE-DE](ax-2012/microsoft-idmf.md)
#### [OverviewTESTING DE-DE](ax-2012/overview-idmf.md)
