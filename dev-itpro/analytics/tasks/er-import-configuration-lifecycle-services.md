...
---
# <a name="import-a-configuration-from-lifecycle-services-for-electronic-reporting-er"></a>Importieren einer Konfiguration von Lifecycle Services für elektronische Berichterstellung (ER)
