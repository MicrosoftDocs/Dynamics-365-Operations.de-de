# [Overview of information access and reporting TESTING DE-DE](information-access-reporting.md)

# [Access Power BI contentTESTING DE-DE](power-bi-content-microsoft-partners.md)
## [Compensation and benefitsTESTING DE-DE](compensation-and-benefits-analysis-power-bi-content-pack.md)
## [Cost accounting analysiTESTING DE-DEs](cost-accounting-analysis-content-pack.md)
### [Security for the Cost accounting analysisTESTING DE-DE](setup-security-cost-accounting-content-pack.md)
## [Cost managementTESTING DE-DE](cost-management-content-pack.md)
...
# Document reporting and printingTESTING DE-DE
## [Document Reporting Services overviewTESTING DE-DE](document-reporting-services.md)
## [PrintingTESTING DE-DE](print-documents.md)
### [Enable network printer devicesTESTING DE-DE](install-document-routing-agent.md)
### [Run the Document Routing Agent as a Windows service](run-document-routing-agent-as-windows-service.md)
## [Help prevent long-running reports from timing outTESTING DE-DE](prevent-long-running-reports-timing-out.md)
...
# [Financial reportingTESTING DE-DE](financial-reporting-intro.md)
## [Generate a financial reportTESTING DE-DE](generate-financial-report.md)
...
# Electronic reportingTESTING DE-DE
## [OverviewTESTING DE-DE](general-electronic-reporting.md)
...
# Analytical tools and visualizationsTESTING DE-DE
## [Analytics, aggregate measurements, and KPI modelingTESTING DE-DE](analytics.md)
...
## [Embedded Power BI in workspacesTESTING DE-DE](embed-power-bi-workspaces.md)
## [Add Power BI to workspacesTESTING DE-DE](add-bi-workspaces.md)
## [Pin Power BI reports to workspacesTESTING DE-DE](pin-power-bi-reports.md)
...
## UpgradeTESTING DE-DE
### [Why we moved from SSAS cubes to aggregate modelsTESTING DE-DE](../migration-upgrade/in-memory-real-time-aggregate-models.md)
### [Migrate a sales cube to the entity store](../migration-upgrade/migrate-upgraded-cube-entity-store.md)

# App suitesTESTING DE-DE
## [ Customize app suite reports with extensions TESTING DE-DE](customize-app-suite-reports-with-extensions.md)
## [ Expand app suite report data setsTESTING DE-DE](expand-app-suite-report-data-sets.md)
