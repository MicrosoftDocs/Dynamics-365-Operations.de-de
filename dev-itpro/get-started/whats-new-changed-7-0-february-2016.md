---
title: "Neuheiten neu oder in Dynamics AX 7,0 geändert wurde (Februar 2016)"
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>Neuheiten neu oder in Dynamics AX 7,0 geändert wurde (Februar 2016)
...
| Nutzen Sie den Business Connector, um Geschäftslogiken zu erstellen und Integrationsszenarien zu unterstützen.         | Der Business verfügbar ist, in X++-Code vom verwalteten Code aufzurufen. Es wird empfohlen, den Business Geschäftslogik verwenden, um in \#C erstellen, nicht für Integrationsszenarien. | Der Business Connector wird nicht mehr unterstützt. Die Erstellungsanforderung gelten, weil X++ in verwalteten Code kompiliert wird. Daher ist die Interoperabilität einfacher. Die Integrationsszenarien werden über OData unterstützt.       | Sie können den Business Connector nicht weiter verwenden.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
<td>Berichtsoptionen wurden hinzugefügt, damit unterschiedliche Filter angewendet werden können, wenn ein Benutzer einen Bericht angezeigt werden. Ein neuer Bericht wird anschließend auf Basis dieser Filter generiert.</td>
...
<td>Analysieren von Finanzdaten, indem Sie den Bildschirmfinanzleistung "Leistung " BIinhalt verwenden.</td>
<td>Nicht verfügbar</td>
...
<td>Das Hilfesystem in der aktuellen Version von Dynamics AX zeigt Aufgabenleitfäden an, die in Microsoft Dynamics Lifecycle Services (LCS) BPM gespeichert sind. Das Hilfesystem enthält auch Themen aus dem Microsoft-Wiki. Weitere Informationen finden Sie [Dynamics AX-Hilfe - Erste Schritte (help-overview.md)] und [die neuen Aufgabenleitfäden verfügbar (Februar 2016)](new-task-guides-available-february-2016.md).</td>
<td>Ein Aufgabenleitfaden ist eine kontrollierte, geführte, interaktive Erfahrung, die Sie durch die Schritte einer Aufgabe oder eines Geschäftsprozesses führt. Sie können die von Microsoft bereitgestellten Aufgabenleitfäden herunterladen und anpassen. Das Wiki ermöglicht schnellere und flexiblere Möglichkeiten zur Erstellung, Bereitstellung und Aktualisierung der Produktdokumentation. So können wir besser sicherstellen, dass Zugriff auf den neuesten technischen Informationen enthalten.</td>
</tr>
</tbody>
</table>
...
<td>Saldenliste mit Zwischensummekontoenbericht wird als SSRS-Bericht (LedgerAccountSum \_FROM).</td>
...
<td>Separate Liste von Intrastat-Warencodes werden mit Produkthierarchie von Warencode zusammengeführt.</td>
...
<td>Intrastat-Warencode hat ein Textfeld, um zusätzliche Einheiten zu ermitteln, ob die Karte ** ** Produkt ist ein Feld, um die Menge der zusätzlichen Einheiten in Kilogramm ein.</td>
...
<li>Bausätze</li>
<li>Von &amp; Rabatten zur Auswahl</li>
</ul></td>
...
<tr class="odd">
<td>Analysieren Sie Einzelhandelskanalumsatzdaten, indem Sie den Bildschirm-Einzelhandelskanalleistung "Leistung" BIinhalt verwenden.</td>
<td>Nicht verfügbar</td>
...
<li>Er bildet "bereit" alternative Lieferungspakete, wie ein Kombinationsstandort/ein Warehousing/eine Variante-/Verkehrsart, das auf Grundlage schnellste Kriterium die Lieferung (frühestes verfügbares Datum), an dem der Benutzer auswählen kann aus.</li>
