...
| Verwenden Sie Berichtszeiträumen, um den Zeitrahmen für die Prüfung zu definieren.                                    | Sie können eine Zeitperiode für eine Leistungsbeurteilung definieren, und Start- und Enddatum der Prüfung werden automatisch eingegeben. Sie können diese Standarddaten nach Bedarf ändern.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Dient zum Zugreifen auf fünf Inhaltstext Packs neuen Leistungsfähigkeit zu BI für Personalverwaltung                                     | Die neuen Personalverwaltungsorganisations- das Content Packs aktivieren und -Personalverwaltungsmanager, um Folgendes zu analysieren: Belegschaftsmetrik einer Demographische Aufschlüsselungen nach Alter und Geschlecht, Familienstand einer Vergleichen Sie Verschleißmaßjahr in Jahr und finden Sie eine Liste der Grundmitarbeitern erstattet wurde zum Treffen der Organisation einer Hier wird eine Liste der offenen Stellen sowie einen Vergleich der Positionskompensation der offenen und geschlossenen -Vorteilen an einer Vergleichen Sie Verwaltungsangestellter stündlich und einer Hier wird die Anzahl der Mitarbeiter, die in verfügbaren den Vorteil registriert sind einer Hiermit werden Mitarbeiter angezeigt, indem Sie Beschäftigungstyp einziehen einer Über analysieren Sie Bewerber auf Basis der Anzahl von Bewerbern, auf die sie verwendet, und welche Positionen für diese organisatorisches Schulung übernehmen einer Kurserfassung nach Lagerplatz einer Couse-Anwesenheit nach Status einer Liste von Mitarbeitern erfasst hat für Kurse und -entwicklung Mitarbeiterkompetenzen einer Angehalten Liste der Fähigkeiten von Mitarbeitern einer Aufschlüsselung von Fähigkeitstypen nach Teammitglied |
...
<td>Kreditbrief Bank an. Zuschlags-Zuweisungsformat für Saudi-Arabien</td>
</tr>
<tr class="odd">
...
| Wie Sie vorgehen können                                                                                                                                                                                                      | Warum dies wichtig ist                                                                                                                                                                                                                                                                                                                                                                                                                 |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Legen Sie Standardauftragseinstellungen für Verkäufe und Käufe basierend auf beliebigen aktiven Produktdimensionen im Produktmaster fest. Sie können deshalb Standardauftragseinstellungen für die Lagermengeneinheit (SKU) oder eine teilweise SKU definieren. | Sie können Standard-Auftragseinstellungsregeln für eine Produktdimension oder eine Kombination aus Produktdimensionen definieren. ** B ** Sie verkaufen ein Produkt, das Polo T-shirt " erläutert. Das Produkt ist in zwei Farben verfügbar: "Grün" und "Blau". Es ist auch in zwei Größen verfügbar: "Small" und "Medium". Farbe und Größe sind aktive Produktdimensionen für "Polo-T-Shirt". Sie können Einkäufe aller grünen Polo-T-Shirts unabhängig von deren Größe blockieren. |
...
<td>Diese Funktion ist eine Produktivitätserweiterung. <strong>Example</strong> You sell a product that is named Polo T-shirt. Das Produkt ist in zwei Farben verfügbar: "Grün" und "Blau". Es ist auch in zwei Größen verfügbar: "Small" und "Medium". Farbe und Größe sind aktive Produktdimensionen für "Polo-T-Shirt". Wenn Sie eine Auftragsposition für "Polo-T-Shirt" mit der Farbe "Grün" und der Größe "Small" eingeben, müssen Sie keine Daten in den Feldern <strong>Artikelnummer</strong>, <strong>Farbe</strong> und <strong>Größe</strong> eingeben. Sie können die Position erstellen, indem Sie einen der folgenden Schritte verwenden:
<ul>
...
| Wie Sie vorgehen können                                                                                                                                                                                                                                                                        | Warum dies wichtig ist                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Hier werden personalisierte Produktempfehlungen an mehreren Berührungspunkten auf Point-of-Sale (POS) an, die bestimmen, was ein Debitor möglicherweise unter auf der Grundlage ihrer Einkaufshistorie, Artikel an seinem Wunschzettel und Artikel interessiert ist, dass weitere online in Debitoren und der physische Filiale "Eingekauft" | Für Einzelhändler mit großen Katalogen, von personalisierte Empfehlungen den Debitor mit Produkterfassung und bevollmächtigen Shopmitarbeitern intelligenten mit dem Clienteling. Indem die Produkte an Schau stellen, die Zinsen eines Debitors und die Kaufgewohnheiten Zielgruppe werden, können Produktempfehlungen Einzelhändlern mit upsell helfen und können einbehaltenen erhöhen. In Dynamics 365 für Einzelhandel - Arbeitsgänge, Produktempfehlungen werden durch kognitive Dienst- und Microsoft Azure-Lernfähigkeiteiner Maschine betrieben. |
...
| Erfahren Sie mehr über die Unterlieferungsunterstützung in Dynamics 365 for Operations                                                                                                         | Weitere Informationen zum Lieferungsprozesse, Support für finden Sie unter /dynamics365/operations/scm/inventory/consignment] [Lieferung"), Aufstellungslieferung [] (/dynamics365/operations/scm/inventory/setup-consignment ), erstellen Sie einen Lieferungswiederbeschaffungsauftrag[ (Aufgabenleitfaden)][(http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) und ändern Sie den Besitz des Lieferungsbestandes Produktionsbedarf (auf Grundlage Aufgabenleitfaden )](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| Erfahren Sie mehr über die Kreditorenzusammenarbeit in Dynamics 365 for Operations. | Weitere Informationen zu Kreditorenzusammenarbeit finden Sie unter [Kreditorenzusammenarbeit mit externen Kreditoren](/dynamics365/operations/scm/procurement/vendor-collaboration-work-external-vendors), [Kreditorenzusammenarbeit mit Debitoren](/dynamics365/operations/scm/procurement/vendor-collaboration-work-customers-dynamics-365-operations), [Benutzer für Kreditor-Kooperationen verwalten](/dynamics365/operations/scm/procurement/manage-vendor-collaboration-users), [Einrichten und Verwalten von Kreditorenzusammenarbeit](/dynamics365/operations/scm/procurement/set-up-maintain-vendor-collaboration) und [Arbeitsbereich für Kreditor-Kooperationsrechnungen](/dynamics365/operations/financials/accounts-payable/vendor-portal-invoicing-workspace).                                                         |
...
<tbody>
<tr class="odd">
<td>Definieren Sie direkt auf Auftragspositionen, wo der Bedarfsursprung liegt und wie er genutzt wird. <strong>Beispiel</strong> Erstellen Sie eine Auftragsposition und geben Sie als Direktlieferung der Lieferart anzeigen. Der primäre Kreditor wird der Auftragsposition als Beschaffungspunkt hinzugefügt.</td>
...
<tr class="even">
<td>Erstellen Sie eine Lieferterminzusagen direkt aus den Auftragspositionen. <strong>Beispiel</strong> Erstellen Sie eine Auftragsposition, die von einem Intercompany-Kreditor Ursprungs ist. Verlassen Sie die Position. Die Lieferdaten werden entsprechend der Verfügbarkeit im Beschaffungsunternehmen berechnet.</td>
