...
| Erfahren Sie mehr über die Unterlieferungsunterstützung in Dynamics 365 for Operations                                                                                                         | Weitere Informationen zur Unterstützung von Lieferungsprozessen erhalten Sie unter [Lieferung](/dynamics365/unified-operations/supply-chain/inventory/consignment), [Lieferung einrichten](/dynamics365/unified-operations/supply-chain/inventory/set-up-consignment), [Erstellen eines neuen Unterlieferungs-Wiederbeschaffungsauftrags (Aufgabenleitfaden)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) und [Ändern des Besitzes des Lieferungsbestandes auf Grundlage des Produktionsbedarfs (Aufgabenleitfaden)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
