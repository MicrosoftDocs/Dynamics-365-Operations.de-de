...
-   Fotografieren Sie einen Beleg und laden Sie ihn zu Microsoft Dynamics 365 for Finance and Operations hoch. Ein Benutzer kann dieses Foto einer Spesenabrechnung später zuordnen.
...
<td>Wenn Sie nicht bereits Finance and Operations in Ihrer Organisation bereitgestellt haben, sollte Ihr Systemadministrator die <a href="/dynamics365/unified-operations/dev-itpro/deployment/deploy-demo-environment">Microsoft Dynamics 365 for Finance and Operations-Testumgebung</a> bereitstellen.</td>
</tr>
<tr class="even">
...
<li><a href="/dynamics365/unified-operations/dev-itpro/deployment/create-apply-deployable-package">Erstellen eines zur Bereitstellung geeigneten Paket</a>, das die <strong>ApplicationSuite</strong> und <strong>ExpenseMobile</strong> Modelle enthält und laden Sie dann das zur Bereitstellung geeignete Paket in LCS hoch.</li>
<li><a href="/dynamics365/unified-operations/dev-itpro/deployment/apply-deployable-package-system">Anwenden eines Bereitstellungspaket</a> auf einem Finance and Operations-System</li>
</ol></td>
</tr>
<tr class="odd">
<td>Der mobile Arbeitsbereich <strong>Spesenverwaltung</strong> muss in der mobilen Finance and Operations-App veröffentlicht sein.</td>
<td>Systemadministrator</td>
<td><ol>
<li>Finance and Oerations in Ihrem Browser starten.</li>
...
## <a name="download-and-install-the-finance-and-operations-mobile-app"></a>Laden Sie die mobile Finance and Operations-App herunter und installieren Sie diese.
Laden Sie die App im App Store herunter und installieren Sie die Finance and Operations-App.

-   Für Android: [Finance and Operations - Warehousing im Google Play Store](https://play.google.com/store/apps/details?id=com.microsoft.dynamics365.operations.mobile)
-   Für iPhone: [Finance and Operations im iTunes-App-Store](https://itunes.apple.com/us/app/dynamics-365-for-operations/id1180836730?mt=8)

## <a name="sign-in-to-the-finance-and-operations-mobile-app"></a>Melden Sie sich an und nutzen Sie die mobile Finance and Operations-App.
1.  Starten Sie die App auf Ihrem mobilen Gerät.
2.  Geben Sie Ihre Finance and Operations-URL ein.
3.  Geben Sie das Unternehmen ein. Geben Sie beispielsweise **USMF** ein.
4.  Wenn Sie sich zum ersten Mal anmelden, werden Sie nach einem Benutzernamen und einem Kennwort für Ihr Finance and Operations-Konto gefragt. Geben Sie Ihre Anmeldeinformationen ein.
...
3.  Wählen Sie die Kategorie für die Ausgabe aus. Sie sehe eine Liste der Ausgabenkategorien, die in der App zur Offline-Nutzung geladen werden. Standardmäßig sind bis zu 50 Artikel geladen, aber ein Entwickler kann diese Nummer ändern. Weitere Informationen, die Entwickler sehen sollten : [Mobile Finance and Operations-Plattform](/dynamics365/unified-operations/dev-itpro/mobile-apps/mobile-platform). Wenn Ihre Kategorie nicht in der Liste ist, wählen Sie **Suchen** aus, um eine Suche in Finance and Operations auszuführen. Suche nach Spesenkategorie oder nach Spesentyp.
