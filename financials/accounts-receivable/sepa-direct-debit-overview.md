...
Die International Bank Account Number (IBAN) und Bank Identifier Code (BIC) werden verwendet, um den entsprechenden Konto in den 32 SEPA-Ländern/Regionen zu identifizieren. Geben Sie den " im Feld und SWIFT-Codegebiet der IBAN im Feld IBAN-Gebiet ein. Beide Felder befinden sich im Inforegister Zusätzliche Kennung auf der Registerkarte Bankkonto in der Seite Bankkonten. Dies gilt für das Bankkonto des Kreditors und das Bankkonto des Debitors.
...
Die SEPA-Datenformate basieren auf den Standards der Nachricht ISO 20022. Sie prüfen das generische elektronische Berichterstellungskontrollkästchen und wählen Sie das SEPA-Direktbelastungsformat als Exportformatkonfiguration aus, wenn Sie Debitorzahlungsmethoden konfigurieren. Sie verwenden diese Zahlungsmethode, wenn Sie eine Zahlungsdatei in einer Debitoren-Zahlungserfassung generieren.
