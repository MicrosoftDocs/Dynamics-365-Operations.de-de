...
Ein Projekt besteht aus einer Gruppe, die für Aktivitäten ist, um einen Service durchführender, ein Produkt zu erzeugen oder ein Ergebnis zu erreichen. Projekte nach Ressourcen und generieren finanziellen Ergebnisse in Form von Umsatzerlösen oder "Anlagen".

## <a name="projects-across-industries"></a>Projekte in Branchen
Die Projektverwaltungs- und Buchhaltungsfunktionen kann in mehreren Branchen, wie in der folgenden Abbildung dargestellt, verwendet werden. [![Projekte zu Branchen] ". /media/projects-accross-industries.jpg)]". /media/projects-accross-industries.jpg) 

In einem Callcenter kann ein Ticket verwendet werden, um die Gruppe von Aktivitäten zu beschreiben, die erforderlich sind, um einen Anruf aufzulösen. Beratungsfirmen, z Wartung oder technische Beratungsunternehmen oder Werbeagenturen, finden ihre Aktivitäten als Projekte anzeigen. Im Marketing stellt eine Kampagne einen Satz Arbeit dar, der geliefert werden muss. In der projektbasierten Fertigung besteht ein Produktionsauftrag aus verschiedene Arbeit zu, die ausgeführt werden muss, um mehrere fertige Artikel zu erzeugen. Neuheiten Name für sie verwendet wird, erfordern diese Projekte Ressourcen, Zeitpläne und Kosten mit ein, und die im Projektverwaltungs- und Buchhaltungsfunktionen Microsoft Dynamics 365 für Arbeitsgänge können in der Planung, während die Erzwingung und bei der Analyse dieser Projekte analysieren können.
...
Sie können Projekte in sechs Arten Microsoft Dynamics 365 für Arbeitsgänge erstellen. Jeder Typ wird unterschiedlich für Umsatzerkennung Kosten und eingerichtet. Der gewählte Projekttyp hängt vom Zweck des Projekts ab. Die folgende Tabelle beschreibt die typische Verwendung eines Projekttyps.
...
| Festpreis       | In Festpreisprojekten bestehen die Rechnungen aus Akontobuchungen. Ein Festpreisprojekt wird gemäß einem Fakturierungsplan fakturiert, der auf einem Projektvertrag ist. Der Umsatzerlös für ein Festpreisprojekt kann während des Projekts berechnet und gebucht werden, indem die Methode "Prozentsatz der Fertigstellung" angewendet werden. Alternativ kann der Umsatzerlös berechnet und gebuth werden, wenn das Projekt abgeschlossen ist, indem die Methode "Vollendeter Auftrag" angewendet wird. Bei Unternehmen ist es häufig sinnvoll, den Wert der Ressource in Fertigung (RIF) zu verwenden, um den Grad der Fertigstellung eines Projekts oder einer Gruppe von Projekten zu berechnen.                                                                                                                                     |
...
> [!NOTE] 
> Buchungen für Investitionsprojekte werden nicht auf ** ** ** Buchen von Kosten, Umsatzerlös antizipieren ** oder ** Erstellen von Rechnungsvorschlägen ** Seite angezeigt.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 _=_ _=_ Kostenprojekt      _=_ Wie Investitionsprojekte werden in der Regel von Kostenprojekten, interne Projekte zu verfolgen verwendet, und nur Stunden, Ausgaben und Artikel können für ein. Kostenprojekte haben jedoch in der Regel eine kürzere Dauer als Investitionsprojekte. Des Weiteren können Kostenprojekte im Unterschied zu Investitionsprojekten nicht auf Bilanzkonten aktiviert werden. Stattdessen werden ihre Projektbuchungen nur auf Gewinn- und Verlustkonten gebucht. 
[!NOTE] 
> Buchungen für Kostenprojekte werden nicht über ** ** ** Buchen von Kosten, Umsatzerlös antizipieren ** oder ** Erstellen von Rechnungsvorschlägen ** Seite angezeigt. Da von Kostenprojekten normalerweise, interne Projekte zu verfolgen verwendet werden, müssen Sie in der Regel nicht mit dem Debitorenkonto zugeordnet sind. Wenn die Einstellung jedoch erfordert, dass Artikelbedarf für Bestellungen erstellt werden, müssen Sie das Kostenprojekt einem Debitor zuordnen. Diese Zuordnung ist erforderlich, da der Artikelbedarf als Auftragspositionen verwaltet wird, und das System erfordert, dass ein Debitor angegeben ist. Allerdings ergibt diese Einstellung keinen Artikelbedarf, der automatisch aus einer Bestellung erstellt wird. Für Kostenprojekte wird die  **Artikelbedarf erstellen**-Einstellung ignoriert. Wenn Sie einen Artikelbedarf in einem Kostenprojekt benötigen, können Sie einen manuell erstellen, solange ein Debitor dem Projekt zugeordnet ist. _=_ _=_ Intern          _=_ Interne Projekte werden in den hier für ein Projekt verwendet, das Ihrer Organisation Intern lautet. Interne Projekte können ein Planungstool angeben, um Ressourcenverbrauch verwalten. ** Hinweis: ** Buchungen für interne Projekte werden nicht über ** Umsatzerlös antizipieren ** oder ** Erstellen von Rechnungsvorschlägen ** Seite angezeigt.                                                                                                                                                                                                                                                                       _=_ _=_ Zeit              _=_ Zeitprojekte werden, Uhrzeit, die den nicht fakturierbaren und unproduktive Aktivitäten zugeordnet ist, z einem Projekt zu verfolgen, kranke Arbeitszeit von Arbeitskräften zu verfolgen verwendet. Buchungen in Zeitprojekten werden nicht im Sachkonto gebucht. Sie werden vielmehr in Arbeitskraftauslastungsberichte eingegliedert. In Zeitprojekten können nur Stundenbuchungen erfasst werden. Sie verwenden eine Stundenerfassung oder einen Arbeitszeitnachweis, um diese Stunden im Projekt zu erfassen. Nachdem sich die Stunden werden, sie werden auch als Projektbuchungen können jedoch nicht übereinstimmende Belegbuchungen erfasst.

> [!NOTE] 
> Buchungen für Zeitprojekte werden nicht über ** ** ** Buchen von Kosten, Umsatzerlös antizipieren ** oder ** Erstellen von Rechnungsvorschlägen ** Seite angezeigt.                                                                                                                                                                                       |
...
Nachfolgend sind einige der Methoden, denen Sie die Einsatzplanungsfunktionen verwenden können:
...
Es gibt zwei Möglichkeiten, die zum Verwalten und Steuern Ihrer Projekte: Projektplanungen und Projektbudgets. Sie können die Planung verwenden, wenn die Organisation operativ ausgerichtet ist und der Schwerpunkt auf Umsatzerlösen und Kosten liegt, die aus speziellen Buchungen stammen. Wenn sich die Organisation eher auf Finanzbeträge konzentriert, verwenden Sie die Budgetierung.
...
-   Verbrauchter ****, aus der/**** bestellen - Verknüpfen Sie das Projekt einem Artikelbedarf. Mithilfe dieser Methode lassen sich tatsächliche Projektkosten anzeigen, wenn die Produktion den Status **Gestartet** besitzt oder als fertig gemeldet wird. Die Kosten werden in Form von mehreren Projektartikelbuchungen für Rohmaterialen und Stunden gebucht, die für die Produktion verbraucht wurden. Sie können auch die Ebene der Stücklistenhierarchie definieren, auf der die Projekte in der Produktion nachverfolgt werden.
...
-   Zum Bestellen von Artikeln aus dem Lagerbestand des Unternehmens muss die Bestellung als Artikelbedarf eingegeben werden. Wenn Sie die Artikelbedarfe ** ** Seite verwenden, können Sie diese so einrichten, dass Artikel als Teillieferungen eingehen. Daher können Sie den Verbrauch einer Menge der Artikel verschieben, bis die Artikel benötigt werden.
...
> [!NOTE] 
> Der Lieferschein für projektbezogene einen Auftrag kann nicht storniert werden, wenn die Artikel markiert für bereits lieferscheinaktualisiert wurden. 
...
Microsoft Dynamics 365 für Arbeitsgänge nicht automatisch verringert die geplanten Vorkalkulationen. Daher wird empfohlen, dass Sie ein ursprüngliches Planzahlenmodell im Festpreisprojekt aufbewahren, um eine Basislinie einzurichten, mit der das Projekt verglichen wird, wenn es abgeschlossen ist. 
> [!NOTE], wenn Sie diese Methode auswählen, verwendet mindestens zwei Planzahlenmodellen. Ein Modell sollte die ursprüngliche Planung enthalten. Für das andere Modell sollten Sie Planungsbuchungen eines anderen Modells kopieren. Diese Methode prüft nur Festpreis- und Investitionsprojekte.</td>
> </tr>
<tr class="odd">
<td>Restbudget</td>
...
-   ** Rechnungsdatum: ** Am 31. März 2012. Dieses Datum wird basierend Rechnungshäufigkeit bestimmt. In diesem Beispiel legen die Rechnungshäufigkeit auf den aktuellen Monat fest. Dies bedeutet, dass alle Buchungen, die im März gebucht werden, am letzten Tag des Monats fakturiert werden.
-   ** Fälligkeitsdatum: ** Am 14. April 2012. Dieses Datum wird basierend auf den Zahlungsbedingungen bestimmt, die für das Projekt zugesagt wurden. Sie haben z. B. eine Zahlungsfrist von 14 Tagen ausgewählt. Daher werden 14 Tage zum Rechnungsdatum hinzugefügt, um zu einem Fälligkeitsdatum vom 14. April 2012 zu kommen.
-   ** Erwartetes Datum für Verkaufszahlung: ** Am 27. April 2012. Dieses Datum wird berechnet, indem die Anzahl von Tagen im ** allgemeine Puffertage ** Feld auf ** der Projektverwaltungs- und Berechnenparameter ** Seite der Anzahl von Tagen in der die einzelnen Puffertage ** ** des Felds Seite an ** Projektverträge ** hinzufügt, und dann die Summe der Anzahl von Tagen im ** Fälligkeitsdatum addiert ** Feld. In vorliegenden Beispiel haben Sie **3** im Feld **Allgemeine Puffertage** und **10** im Feld **Individuelle Karenztage** eingegeben. Daher werden 13 Tage zum Fälligkeitsdatum hinzugefügt, um zu einem erwarteten Datum für die Verkaufszahlung am 27. April 2012 zu kommen.
...
-   ** Fälligkeitsdatum: ** Am 16. März 2012. Die Zahlungsbedingungen werden auf 14 Tage festgelegt.
-   ** Erwartetes Datum für Verkaufszahlung: ** Am 29. März 2012. Die Berechnung beinhaltet drei allgemeine Puffertage und 10 die einzelnen Puffertage.
...
> [!NOTE] 
> Das Fälligkeitsdatum für die Bestellung ist auf den Kreditorenbuchungen, beim Erstellen der Projektbestellung. Das Fälligkeitsdatum wird von keinen Standardeinstellungen bestimmt. 
...
> [!NOTE] 
> Wenn Sie die verwenden ** Kostenkontrolle ** Seite, um den aktuellen Status anzuzeigen Projektkosten, verwenden Sie die Planzahlenmodelle, die für ursprüngliche und das Restbudget ausgewählt wurden. Wenn Sie bei der Berechnung der Kosten andere Planzahlenmodelle auswählen, sind die Berechnungsergebnisse ungenau.
