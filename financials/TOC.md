# [General ledgerTESTING IN DE-DE](general-ledger/general-ledger.md)
## AccountsTESTING IN DE-DE
### [Accruals overviewTESTING IN DE-DE](general-ledger/accruals-overview.md)
### [Elimination rulesTESTING IN DE-DE](general-ledger/elimination-rules.md)
### [Account and dimension combinations (segmented entry controlTESTING IN DE-DE)](general-ledger/enter-account-dimension-combinations-segmented-entry-control.md)
### [Balanced journals for interunit accountingTESTING IN DE-DE](general-ledger/example-balanced-journals-interunit-accounting.md)
### [Posting definitionsv](general-ledger/posting-definitions.md)
#### [Posting definition examples TESTING IN DE-DE](general-ledger/example-posting-definitions.md)
### [General ledger account balancesTESTING IN DE-DE](general-ledger/general-ledger-account-balances.md)
### [Main account typesTESTING IN DE-DE](general-ledger/main-account-types.md)
### [Plan your chart of accountsTESTING IN DE-DE](general-ledger/plan-chart-of-accounts.md)
### [Accounting source explorerv](accounts-payable/accounting-source-explorer.md)
### [Accounting distributionsTESTING IN DE-DE](accounts-payable/accounting-distributions.md)
### [Process allocationsTESTING IN DE-DE](general-ledger/process-allocations.md)
### [Financial dimensionsTESTING IN DE-DE](general-ledger/financial-dimensions.md)
### [Convert accounting or reporting currenciesTESTING IN DE-DE](general-ledger/convert-accounting-reporting-currencies.md)
### [Consolidation account groups and accountsTESTING IN DE-DE](budgeting/consolidation-account-groups-consolidation-accounts.md)
### [Consolidation and elimination overviewTESTING IN DE-DE](budgeting/consolidation-elimination-overview.md)
### [Fiscal calendars, fiscal years, and periodsTESTING IN DE-DE](budgeting/fiscal-calendars-fiscal-years-periods.md)
## Journals and ledgersTESTING IN DE-DE
### [TESTING IN DE-DEGeneral journal processing](general-ledger/general-journal-processing.md)
...
## Period end closeTESTING IN DE-DE
### [TESTING IN DE-DEClose the general ledger at period end](general-ledger/close-general-ledger-at-period-end.md)
...
## Sales taxTESTING IN DE-DE
### [TESTING IN DE-DESales tax overview](general-ledger/indirect-taxes-overview.md)
...
## ComplianceTESTING IN DE-DE
### [Audit policy rulesTESTING IN DE-DE](general-ledger/audit-policy-rules.md)
### [Audit policy violations and cases](general-ledger/audit-policy-violations-cases.md)
# [Accounts payableTESTING IN DE-DE](accounts-payable/accounts-payable.md)
## [Vendor invoices overviewTESTING IN DE-DE](accounts-payable/vendor-invoices-overview.md)
## [Configure Accounts payableTESTING IN DE-DE](accounts-payable/accounts-payable-overview.md)
## [Three-way matching policiesTESTING IN DE-DE](accounts-payable/three-way-matching-policies.md)
...
## [Default offset accounts for vendor invoice journals and invoice approval journalsTESTING IN DE-DE](accounts-payable/default-offset-accounts-vendor-invoice-journals.md)
...
## Payments and settlementsTESTING IN DE-DE
### [Centralized payments for Accounts payableTESTING IN DE-DE](accounts-payable/centralized-payments-accounts-payable.md)
### [Configure settlementTESTING IN DE-DE](cash-bank-management/configure-settlement.md)
### [Create vendor payments by using a payment proposalTESTING IN DE-DE](accounts-payable/create-vendor-payments-payment-proposal.md)
...
### [Settle a partial vendor payment that has multiple discount periodsTESTING IN DE-DE](accounts-payable/settle-partial-vendor-payment-multiple-discount-periods.md)
...
### [Take a cash discount outside the cash discount periodTESTING IN DE-DE](accounts-payable/take-cash-discount-outside-cash-discount-timeframe.md)
...
# [Accounts receivableTESTING IN DE-DE](accounts-receivable/accounts-receivable.md)
## [Credit and collections in Accounts receivableTESTING IN DE-DE](accounts-receivable/collections-credit-accounts-receivable.md)
...
## Payments and settlements TESTING IN DE-DE
...
### [Customer payments for a partial amountTESTING IN DE-DE](accounts-receivable/customer-payments-partial-amount.md)
# [Cash and bank managementTESTING IN DE-DE](cash-bank-management/cash-bank-management.md)
## [Cash discountsTESTING IN DE-DE](cash-bank-management/cash-discount-handling-overpayments.md)
...
## [Letters of guaranteeTESTING IN DE-DE](cash-bank-management/letters-of-guarantee.md)
## [Postdated checksTESTING IN DE-DE](cash-bank-management/postdated-checks.md)
## [Prepayment invoices vs. prepaymentsTESTING IN DE-DE](accounts-payable/prepayments-invoices-vs-prepayments.md)
...
## [Automatic settlement and prioritizationTESTING IN DE-DE](accounts-receivable/automatic-settlement-prioritization.md)
## Advanced bank reconciliationTESTING IN DE-DE
### [Advanced bank reconciliation overviewTESTING IN DE-DE](cash-bank-management/configure-advanced-bank-reconciliation.md)
...
### [Set up bank reconciliation matching rulesTESTING IN DE-DE](cash-bank-management/set-up-bank-reconciliation-matching-rules.md)
...
### [Advanced bank reconciliation overviewTESTING IN DE-DE](cash-bank-management/advanced-bank-reconciliation-overview.md)
### [Bank statement file import troubleshooting](cash-bank-management/import-bank-statement-file-failed-incorrect-results.md)
### [Update the bank journal composite entityTESTING IN DE-DE](cash-bank-management/upgrade-bank-journal-composite-entity.md)
# [Fixed assetsTESTING IN DE-DE](fixed-assets/fixed-assets.md)
## [Depreciation book upgrade overviewTESTING IN DE-DE](fixed-assets/depreciation-book-upgrade-considerations.md)
## [Derived booksTESTING IN DE-DE](fixed-assets/derived-books.md)
## [Fixed asset value model and depreciation book merge](fixed-assets/fixed-asset-value-model-depreciation-book-merge.md)
## [Post with derived booksTESTING IN DE-DE](fixed-assets/post-derived-value-models.md)
...
## [Fixed asset mass updateTESTING IN DE-DE](fixed-assets/fixed-asset-mass-update.md)
## [Acquire assets through procurement](fixed-assets/acquire-assets-procurement.md)
## Set up and integrationTESTING IN DE-DE
### [Set up fixed assetsTESTING IN DE-DE](fixed-assets/set-up-fixed-assets.md)
### [Fixed assets integration](fixed-assets/fixed-asset-integration.md)
## Depreciation methodsTESTING IN DE-DE
...
# [BudgetingTESTING IN DE-DE](budgeting/budgeting-overview.md)
## [Budget planning overview ](budgeting/budget-planning-overview-configuration.md)
## [Budget control overview TESTING IN DE-DE](budgeting/budget-control-overview-configuration.md)
## [Budgeting overview TESTING IN DE-DE](budgeting/basic-budgeting-overview-configuration.md)
## [Position forecastingTESTING IN DE-DE](budgeting/position-forecasting.md)
...
## [Budget planningTESTING IN DE-DE](budgeting/budget-plan.md)
...
# [ReportingTESTING IN DE-DE](general-ledger/financial-reporting-getting-started.md)
## [Balance sheet financial reportsTESTING IN DE-DE](general-ledger/balance-sheet-financial-reports.md)
...
## [Trial balance financial reportsTESTING IN DE-DE](general-ledger/trial-balance-financial-reports.md)
...
# [Cost accountingTESTING IN DE-DE](cost-accounting/cost-accounting-home-page.md)
## [TermsTESTING IN DE-DE](cost-accounting/terms-cost-accounting.md)
...
## [Cost object dimensionsTESTING IN DE-DE](cost-accounting/cost-objects.md)
...
# [Public sectorTESTING IN DE-DE](public-sector/public-sector-functionality.md)
## [Plan for public sector functionalityTESTING IN DE-DE](public-sector/plan-public-sector-functionality.md)
...
## [Accounts receivable in the public sectorTESTING IN DE-DE](public-sector/accounts-receivable-public-sector.md)
...
## [Fixed assets in the public sectorTESTING IN DE-DE](public-sector/fixed-asset-public-sector.md)
...
## [Project invoicingTESTING IN DE-DE](accounts-payable/project-invoicing.md)
## [Project contractsTESTING IN DE-DE](project-management/project-contracts.md)
## [Project forecasts and budgetsTESTING IN DE-DE](project-management/project-forecasts-budgets.md)
## [Purchase orders for a projectTESTING IN DE-DE](project-management/project-purchase-orders.md)
## [Project quotationsTESTING IN DE-DE](project-management/project-quotations.md)
## [Project resourcingTESTING IN DE-DE](project-management/project-resourcing.md)
## [Work breakdown structures TESTING IN DE-DE](project-management/work-breakdown-structures.md)
# [LocalizationsTESTING IN DE-DE](localizations/TOC.md)
