# [TEST DE_DEGeneral ledger](general-ledger/general-ledger.md)
## TEST DE_DEAccounts
### [TEST DE_DEAccruals overview](general-ledger/accruals-overview.md)
...
### [TEST DE_DEBalanced journals for interunit accounting](general-ledger/example-balanced-journals-interunit-accounting.md)
### [TEST DE_DEPosting definitions](general-ledger/posting-definitions.md)
#### [TEST DE_DEPosting definition examples ](general-ledger/example-posting-definitions.md)
### [TEST DE_DEGeneral ledger account balances](general-ledger/general-ledger-account-balances.md)
...
## TEST DE_DEJournals and ledgers
### [TEST DE_DEGeneral journal processing](general-ledger/general-journal-processing.md)
...
## TEST DE_DEPeriod end close
### [TEST DE_DEClose the general ledger at period end](general-ledger/close-general-ledger-at-period-end.md)
...
## TEST DE_DESales tax
### [TEST DE_DESales tax overview](general-ledger/indirect-taxes-overview.md)
...
## TEST DE_DECompliance
### [TEST DE_DEAudit policy rules](general-ledger/audit-policy-rules.md)
### [Audit policy violations and cases](general-ledger/audit-policy-violations-cases.md)
# [TEST DE_DEAccounts payable](accounts-payable/accounts-payable.md)
## [TEST DE_DEVendor invoices overview](accounts-payable/vendor-invoices-overview.md)
